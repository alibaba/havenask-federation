...
public class RemovePluginCommandTests extends HavenaskTestCase {
    ...
    public void testBin() throws Exception {
        ...
        removePlugin("fake", home, randomBoolean());
        assertFalse(Files.exists(env.pluginsFile().resolve("fake")));
        assertTrue(Files.exists(env.binFile().resolve("havenask")));
    ...
    public void testRemoveUninstalledPluginErrors() throws Exception {
        ...
        assertEquals("plugin [fake] not found; run 'havenask-plugin list' to get list of installed plugins", e.getMessage());
        ...
        try (
            ...
            assertEquals(
                "ERROR: plugin [fake] not found; run 'havenask-plugin list' to get list of installed plugins",
