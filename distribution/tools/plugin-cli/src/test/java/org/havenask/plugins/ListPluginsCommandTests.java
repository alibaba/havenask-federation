...
public class ListPluginsCommandTests extends HavenaskTestCase {
    ...
    public void testPluginWithoutDescriptorFile() throws Exception {
        ...
        assertEquals(pluginDir.resolve(PluginInfo.HAVENASK_PLUGIN_PROPERTIES).toString(), e.getFile());
    }
    ...
    public void testPluginWithWrongDescriptorFile() throws Exception {
        ...
        final Path descriptorPath = pluginDir.resolve(PluginInfo.HAVENASK_PLUGIN_PROPERTIES);
    ...
    public void testExistingIncompatiblePlugin() throws Exception {
        ...
        MockTerminal terminal = listPlugins(home);
        String message = "plugin [fake_plugin1] was built for Havenask version 1.0 but version " + Version.CURRENT + " is required";
