...
import static org.havenask.cluster.metadata.IndexGraveyard.SETTING_MAX_TOMBSTONES;
import static org.havenask.gateway.DanglingIndicesState.AUTO_IMPORT_DANGLING_INDICES_SETTING;
import static org.havenask.indices.IndicesService.WRITE_DANGLING_INDICES_INFO_SETTING;
import static org.havenask.rest.RestStatus.ACCEPTED;
import static org.havenask.rest.RestStatus.OK;
import static org.havenask.test.XContentTestUtils.createJsonMapView;
 ...
 */
@ClusterScope(numDataNodes = 0, scope = HavenaskIntegTestCase.Scope.TEST, autoManageMasterNodes = false)
