 ...
 *
 * Extends LuceneTestCase rather than HavenaskTestCase as HavenaskTestCase installs a system call filter, and
 * that prevents the Spawner class from doing its job. Also needs to run in a separate JVM to other
 * tests that extend HavenaskTestCase for the same reason.
 */
