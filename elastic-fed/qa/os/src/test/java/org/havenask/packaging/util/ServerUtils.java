...
public class ServerUtils {
    ...
    public static void waitForHavenask(Installation installation) throws Exception {
        waitForHavenask("green", null, installation, null, null);
    }
    ...
    public static void waitForHavenask(String status, String index, Installation installation, String username, String password)
            ...
            if (System.currentTimeMillis() - lastRequest > requestInterval) {
                try {
                    ...
                    if (response.getStatusLine().getStatusCode() >= 300) {
                        ...
                        throw new RuntimeException("Connecting to havenask cluster health API failed:\n" + statusLine + "\n" + body);
                    }
        ...
        if (started == false) {
            ...
            throw new RuntimeException("Havenask did not start", thrownException);
        }
    ...
    public static void runHavenaskTests() throws Exception {
        makeRequest(
