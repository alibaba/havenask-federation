...
public class EvilThreadPoolTests extends HavenaskTestCase {
    ...
    public void testExecutionErrorOnDirectExecutorService() throws InterruptedException {
        final ExecutorService directExecutorService = HavenaskExecutors.newDirectExecutorService();
    ...
    public void testExecutionErrorOnFixedESThreadPoolExecutor() throws InterruptedException {
        final HavenaskThreadPoolExecutor fixedExecutor = HavenaskExecutors.newFixed("test", 1, 1,
            HavenaskExecutors.daemonThreadFactory("test"), threadPool.getThreadContext());
        try {
    ...
    public void testExecutionErrorOnScalingESThreadPoolExecutor() throws InterruptedException {
        final HavenaskThreadPoolExecutor scalingExecutor = HavenaskExecutors.newScaling("test", 1, 1,
            10, TimeUnit.SECONDS, HavenaskExecutors.daemonThreadFactory("test"), threadPool.getThreadContext());
        try {
    ...
    public void testExecutionErrorOnAutoQueueFixedESThreadPoolExecutor() throws InterruptedException {
        final HavenaskThreadPoolExecutor autoQueueFixedExecutor = HavenaskExecutors.newAutoQueueFixed("test", 1, 1,
            1, 1, 1, TimeValue.timeValueSeconds(10), HavenaskExecutors.daemonThreadFactory("test"), threadPool.getThreadContext());
        try {
    ...
    public void testExecutionErrorOnSinglePrioritizingThreadPoolExecutor() throws InterruptedException {
        final PrioritizedHavenaskThreadPoolExecutor prioritizedExecutor = HavenaskExecutors.newSinglePrioritizing("test",
            HavenaskExecutors.daemonThreadFactory("test"), threadPool.getThreadContext(), threadPool.scheduler());
        try {
