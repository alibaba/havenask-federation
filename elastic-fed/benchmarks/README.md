# Havenask Microbenchmark Suite

This directory contains the microbenchmark suite of Havenask. It relies on [JMH](http://openjdk.java.net/projects/code-tools/jmh/).
