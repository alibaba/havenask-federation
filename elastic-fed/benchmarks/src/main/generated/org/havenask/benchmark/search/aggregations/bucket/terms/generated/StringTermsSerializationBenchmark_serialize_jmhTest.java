...
import org.havenask.benchmark.search.aggregations.bucket.terms.generated.StringTermsSerializationBenchmark_jmhType;
public final class StringTermsSerializationBenchmark_serialize_jmhTest {
                ...
                if (StringTermsSerializationBenchmark_jmhType.tearTrialMutexUpdater.compareAndSet(l_stringtermsserializationbenchmark0_G, 0, 1)) {
                    try {
                        ...
                        if (l_stringtermsserializationbenchmark0_G.readyTrial) {
                            l_stringtermsserializationbenchmark0_G.readyTrial = false;
                        }
                    } catch (Throwable t) {
                        control.isFailing = true;
                        throw t;
                    } finally {
                        StringTermsSerializationBenchmark_jmhType.tearTrialMutexUpdater.set(l_stringtermsserializationbenchmark0_G, 0);
                    }
                } else {
    ...
    StringTermsSerializationBenchmark_jmhType _jmh_tryInit_f_stringtermsserializationbenchmark0_G(InfraControl control) throws Throwable {
        ...
        synchronized(this.getClass()) {
            ...
            Field f;
            f = org.havenask.benchmark.search.aggregations.bucket.terms.StringTermsSerializationBenchmark.class.getDeclaredField("buckets");
