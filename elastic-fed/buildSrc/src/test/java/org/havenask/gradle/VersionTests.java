...
public class VersionTests extends GradleUnitTestCase {
    ...
    public void testCompareWithStringVersions() {
        // 1.10.2 is now rebased to Havenask version; so this needs to report
        assertTrue("Havenask 1.10.20 is not interpreted as after Legacy 2.0.0", Version.fromString("1.10.20").after("2.0.0"));
        assertTrue(
