 ...
 * under the License.
 */
package org.havenask.gradle.plugin

import com.github.jengelman.gradle.plugins.shadow.ShadowPlugin
import org.havenask.gradle.BuildPlugin
import org.havenask.gradle.NoticeTask
import org.havenask.gradle.Version
import org.havenask.gradle.VersionProperties
import org.havenask.gradle.dependencies.CompileOnlyResolvePlugin
...
import org.havenask.gradle.testclusters.RunTask
...
/**
 * Encapsulates build configuration for an Havenask plugin.
 */
class PluginBuildPlugin implements Plugin<Project> {

    public static final String PLUGIN_EXTENSION_NAME = 'havenaskplugin'
    ...
    void apply(Project project) {
        ...
        project.afterEvaluate {
            ...
            if (extension1.name == null) {
                throw new InvalidUserDataException('name is a required setting for havenaskplugin')
            }
            if (extension1.description == null) {
                throw new InvalidUserDataException('description is a required setting for havenaskplugin')
            }
            if (extension1.classname == null) {
                throw new InvalidUserDataException('classname is a required setting for havenaskplugin')
            }
            ...
            Map<String, String> properties = [
                    ...
                    'havenaskVersion'   : Version.fromString(VersionProperties.getHavenask()).toString(),
        ...
        project.tasks.named('testingConventions').configure {
            ...
            naming {
                ...
                IT {
                    ...
                    baseClass 'org.havenask.test.rest.HavenaskRestTestCase'
    ...
    private void configurePublishing(Project project, PluginPropertiesExtension extension) {
        ...
        if (extension.hasClientJar) {
            ...
            project.tasks.withType(GenerateMavenPom.class).configureEach { GenerateMavenPom generatePOMTask ->
                generatePOMTask.destination = "${project.buildDir}/distributions/${project.archivesBaseName}-client-${project.versions.havenask}.pom"
            }
        } else {
    ...
    private static void configureDependencies(Project project) {
        project.dependencies {
            if (BuildParams.internal) {
                ...
                compileOnly "org.havenask:havenask:${project.versions.havenask}"
                testImplementation "org.havenask.test:framework:${project.versions.havenask}"
            }
            // we "upgrade" these optional deps to provided for plugins, since they will run
            // with a full havenask server that includes optional deps
