...
import org.havenask.gradle.precommit.DependencyLicensesTask
import org.havenask.gradle.precommit.LicenseAnalyzer
...
class DependenciesInfoTask extends ConventionTask {
     ...
     *          URL is the Github URL to the LICENSE file in havenask repository.</li>
     * </ul>
     *
