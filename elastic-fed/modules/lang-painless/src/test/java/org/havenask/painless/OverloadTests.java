...
public class OverloadTests extends ScriptTestCase {
    ...
    public void testConstructor() {
        assertEquals(true, exec("org.havenask.painless.FeatureTestObject f = new org.havenask.painless.FeatureTestObject();" +
                                "return f.x == 0 && f.y == 0;"));
        assertEquals(true, exec("org.havenask.painless.FeatureTestObject f = new org.havenask.painless.FeatureTestObject(1, 2);" +
                                "return f.x == 1 && f.y == 2;"));
    }

    public void testStatic() {
        assertEquals(true, exec("return org.havenask.painless.FeatureTestObject.overloadedStatic();"));
        assertEquals(false, exec("return org.havenask.painless.FeatureTestObject.overloadedStatic(false);"));
    }
}
