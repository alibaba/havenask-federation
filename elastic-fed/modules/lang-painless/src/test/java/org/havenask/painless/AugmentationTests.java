...
public class AugmentationTests extends ScriptTestCase {
    ...
    public static void beforeClass() {
        ...
        digestWhitelist.add(WhitelistLoader.loadFromResourceFiles(Whitelist.class, "org.havenask.ingest.txt"));
    ...
    public void testFeatureTest() {
        assertEquals(5, exec("org.havenask.painless.FeatureTestObject ft = new org.havenask.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.getTotal()"));
        assertEquals(5, exec("def ft = new org.havenask.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.getTotal()"));
        assertEquals(8, exec("org.havenask.painless.FeatureTestObject ft = new org.havenask.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.addToTotal(3)"));
        assertEquals(8, exec("def ft = new org.havenask.painless.FeatureTestObject();" +
            " ft.setX(3); ft.setY(2); return ft.addToTotal(3)"));
    }
