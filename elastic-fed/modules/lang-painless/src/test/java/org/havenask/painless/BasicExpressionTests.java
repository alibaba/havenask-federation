...
public class BasicExpressionTests extends ScriptTestCase {
    ...
    public void testNullSafeDeref() {
        ...
        //   Read shortcut
        assertMustBeNullable(    "org.havenask.painless.FeatureTestObject a = null; return a?.x");
        assertMustBeNullable(
                "org.havenask.painless.FeatureTestObject a = new org.havenask.painless.FeatureTestObject(); return a?.x");
        assertNull(         exec("def    a = null;  return a?.x"));
        assertEquals(0,     exec("def    a = new org.havenask.painless.FeatureTestObject(); return a?.x"));
...
//        assertEquals(null, exec("org.havenask.painless.FeatureTestObject a = null; return a?.x"));            // Read field
//        assertEquals(null, exec("org.havenask.painless.FeatureTestObject a = null; a?.x = 7; return a?.x"));  // Write field
