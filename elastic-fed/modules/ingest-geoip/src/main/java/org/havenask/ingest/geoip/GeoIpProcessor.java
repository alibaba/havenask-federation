...
import static org.havenask.ingest.ConfigurationUtils.readOptionalList;
...
public final class GeoIpProcessor extends AbstractProcessor {
    ...
    private Map<String, Object> getGeoData(String ip) throws IOException {
        ...
        if (databaseType.endsWith(CITY_DB_SUFFIX)) {
            ...
            throw new HavenaskParseException("Unsupported database type [" + lazyLoader.getDatabaseType()
