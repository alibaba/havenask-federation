...
public class CompoundAnalysisTests extends HavenaskTestCase {
    ...
    private Settings getJsonSettings() throws IOException {
        String json = "/org/havenask/analysis/common/test1.json";
    ...
    private Settings getYamlSettings() throws IOException {
        String yaml = "/org/havenask/analysis/common/test1.yml";
        return Settings.builder()
