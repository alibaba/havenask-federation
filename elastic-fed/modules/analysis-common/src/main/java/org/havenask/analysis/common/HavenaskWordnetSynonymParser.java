...
public class HavenaskWordnetSynonymParser extends WordnetSynonymParser {
    private static final Logger logger = LogManager.getLogger(HavenaskWordnetSynonymParser.class);

    private final boolean lenient;

    public HavenaskWordnetSynonymParser(boolean dedup, boolean expand, boolean lenient, Analyzer analyzer) {
