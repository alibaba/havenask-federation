...
import static org.havenask.plugins.AnalysisPlugin.requiresAnalysisSettings;
...
public class CommonAnalysisPlugin extends Plugin implements AnalysisPlugin, ScriptPlugin {
    ...
    public List<PreBuiltAnalyzerProviderFactory> getPreBuiltAnalyzerProviderFactories() {
        ...
        // TODO remove in 8.0
        analyzers.add(new PreBuiltAnalyzerProviderFactory("standard_html_strip", CachingStrategy.HAVENASK,
            () -> new StandardHtmlStripAnalyzer(CharArraySet.EMPTY_SET)));
        analyzers.add(new PreBuiltAnalyzerProviderFactory("pattern", CachingStrategy.HAVENASK,
    ...
    public List<PreConfiguredCharFilter> getPreConfiguredCharFilters() {
        ...
        filters.add(PreConfiguredCharFilter.havenaskVersion("htmlStrip", false, (reader, version) -> {
    ...
    public List<PreConfiguredTokenFilter> getPreConfiguredTokenFilters() {
        ...
        filters.add(PreConfiguredTokenFilter.havenaskVersion("delimited_payload_filter", false, (input, version) -> {
        ...
        filters.add(PreConfiguredTokenFilter.havenaskVersion("edgeNGram", false, false, (reader, version) -> {
            if (version.onOrAfter(LegacyESVersion.V_7_0_0)) {
                throw new IllegalArgumentException(
        ...
        filters.add(PreConfiguredTokenFilter.havenaskVersion("nGram", false, false, (reader, version) -> {
            if (version.onOrAfter(LegacyESVersion.V_7_0_0)) {
        ...
        filters.add(PreConfiguredTokenFilter.havenaskVersion("word_delimiter_graph", false, false, (input, version) -> {
    ...
    public List<PreConfiguredTokenizer> getPreConfiguredTokenizers() {
        ...
        tokenizers.add(PreConfiguredTokenizer.havenaskVersion("edge_ngram", (version) -> {
        ...
        tokenizers.add(PreConfiguredTokenizer.havenaskVersion("nGram", (version) -> {
        ...
        tokenizers.add(PreConfiguredTokenizer.havenaskVersion("edgeNGram", (version) -> {
            if (version.onOrAfter(LegacyESVersion.V_7_6_0)) {
                deprecationLogger.deprecate("edgeNGram_tokenizer_deprecation",
                        "The [edgeNGram] tokenizer name is deprecated and will be removed in a future version. "
                                + "Please change the tokenizer name to [edge_ngram] instead.");
