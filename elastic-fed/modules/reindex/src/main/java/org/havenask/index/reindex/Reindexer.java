...
import org.havenask.index.reindex.remote.RemoteScrollableHitSource;
...
import static org.havenask.index.VersionType.INTERNAL;
...
public class Reindexer {
    ...
    static class AsyncIndexBySearchAction extends AbstractAsyncBulkByScrollAction<ReindexRequest, TransportReindexAction> {
        ...
        /**
         * List of threads created by this process. Usually actions don't create threads in Havenask. Instead they use the builtin
         * {@link ThreadPool}s. But reindex-from-remote uses Havenask's {@link RestClient} which doesn't use the
