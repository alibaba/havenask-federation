...
/**
 * Builds requests for remote version of Havenask. Note that unlike most of the
 * rest of Havenask this file needs to be compatible with very old versions of
 * Havenask. Thus it often uses identifiers for versions like {@code 2000099}
...
final class RemoteRequestBuilders {
    ...
    static Request initialSearch(SearchRequest searchRequest, BytesReference query, Version remoteVersion) {
        ...
        try (XContentBuilder entity = JsonXContent.contentBuilder();
            ...
            throw new HavenaskException("unexpected error building entity", e);
        }
        return request;
    }
    ...
    static Request scroll(String scroll, TimeValue keepAlive, Version remoteVersion) {
        ...
        try (XContentBuilder entity = JsonXContent.contentBuilder()) {
            ...
            throw new HavenaskException("failed to build scroll entity", e);
        }
        return request;
    }
    ...
    static Request clearScroll(String scroll, Version remoteVersion) {
        ...
        try (XContentBuilder entity = JsonXContent.contentBuilder()) {
            ...
            throw new HavenaskException("failed to build clear scroll entity", e);
        }
        return request;
    }
}
