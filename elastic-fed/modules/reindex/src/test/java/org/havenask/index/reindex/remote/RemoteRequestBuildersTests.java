...
import static org.havenask.index.reindex.remote.RemoteRequestBuilders.DEPRECATED_URL_ENCODED_INDEX_WARNING;
import static org.havenask.index.reindex.remote.RemoteRequestBuilders.clearScroll;
import static org.havenask.index.reindex.remote.RemoteRequestBuilders.initialSearch;
import static org.havenask.index.reindex.remote.RemoteRequestBuilders.scroll;
 ...
 * Havenask. Note that unlike most of the rest of Havenask this file needs to
 * be compatible with very old versions of Havenask. Thus is often uses identifiers
 ...
 */
public class RemoteRequestBuildersTests extends HavenaskTestCase {
