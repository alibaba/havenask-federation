...
public class HavenaskLoggingHandlerIT extends HavenaskNetty4IntegTestCase {
    ...
    public void setUp() throws Exception {
        ...
        Loggers.addAppender(LogManager.getLogger(HavenaskLoggingHandler.class), appender);
    ...
    public void tearDown() throws Exception {
        Loggers.removeAppender(LogManager.getLogger(HavenaskLoggingHandler.class), appender);
    ...
    @TestLogging(
            value = "org.havenask.transport.netty4.HavenaskLoggingHandler:trace,org.havenask.transport.TransportLogger:trace",
    ...
    public void testLoggingHandler() {
        ...
        final MockLogAppender.LoggingExpectation flushExpectation =
                new MockLogAppender.SeenEventExpectation(
                    "flush", HavenaskLoggingHandler.class.getCanonicalName(), Level.TRACE, "*FLUSH*");
