...
import org.havenask.core.internal.net.NetUtils;
import org.havenask.http.AbstractHttpServerTransport;
import org.havenask.http.HttpChannel;
import org.havenask.http.HttpHandlingSettings;
import org.havenask.http.HttpReadTimeoutException;
import org.havenask.http.HttpServerChannel;
import org.havenask.threadpool.ThreadPool;
import org.havenask.transport.NettyAllocator;
import org.havenask.transport.NettyByteBufSizer;
import org.havenask.transport.SharedGroupFactory;
import org.havenask.transport.netty4.Netty4Utils;
...
import static org.havenask.http.HttpTransportSettings.SETTING_HTTP_MAX_CONTENT_LENGTH;
...
import static org.havenask.http.HttpTransportSettings.SETTING_HTTP_READ_TIMEOUT;
...
public class Netty4HttpServerTransport extends AbstractHttpServerTransport {
     ...
     */
    private static final ByteSizeValue MTU = new ByteSizeValue(Long.parseLong(System.getProperty("havenask.net.mtu", "1500")));
    ...
    public static Setting<Integer> SETTING_HTTP_NETTY_MAX_COMPOSITE_BUFFER_COMPONENTS =
        new Setting<>(SETTING_KEY_HTTP_NETTY_MAX_COMPOSITE_BUFFER_COMPONENTS, (s) -> {
             ...
             * We assume here that Havenask receives HTTP requests via an Ethernet connection which has a MTU of 1500 bytes.
             *
    ...
    public Netty4HttpServerTransport(Settings settings, NetworkService networkService, BigArrays bigArrays, ThreadPool threadPool,
        ...
        Netty4Utils.setAvailableProcessors(HavenaskExecutors.NODE_PROCESSORS_SETTING.get(settings));
