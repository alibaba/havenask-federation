...
public class PrecisionAtKTests extends HavenaskTestCase {
    ...
    public void testSerialization() throws IOException {
        ...
        PrecisionAtK deserialized = HavenaskTestCase.copyWriteable(original, new NamedWriteableRegistry(Collections.emptyList()),
                PrecisionAtK::new);
