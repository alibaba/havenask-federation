...
public class MeanReciprocalRankTests extends HavenaskTestCase {
    ...
    public void testSerialization() throws IOException {
        ...
        MeanReciprocalRank deserialized = HavenaskTestCase.copyWriteable(original, new NamedWriteableRegistry(Collections.emptyList()),
