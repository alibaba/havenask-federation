...
public class HavenaskStopActionTests extends HavenaskITTestCase {
    ...
    private String startScript = HavenaskStopActionTests.class.getResource("/fake_sap.sh").getPath();
