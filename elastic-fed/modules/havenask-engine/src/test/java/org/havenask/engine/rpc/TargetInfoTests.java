...
public class TargetInfoTests extends HavenaskTestCase {
    public void testParse() {
        String targetStr = "{\n"
            ...
            + "\t\"service_info\":{\n"
            + "\t\t\"cm2\":{\n"
            + "\t\t\t\"topo_info\":\"general.default:1:0:1371640948:100:2400309353:-1:true|general"
            + ".default_agg:1:0:1371640948:100:2400309353:-1:true|general"
            + ".default_sql:1:0:1371640948:100:2400309353:-1:true|general"
            + ".para_search_2:1:0:1371640948:100:2400309353:-1:true|general"
            + ".para_search_4:1:0:1371640948:100:2400309353:-1:true|\"\n"
            + "\t\t}\n"
            + "\t},\n"
            + "\t\"table_info\":{\n"
            + "\t\t\"test3\":{\n"
            ...
            + "/general_0/zone_config/table/test3/0/\",\n"
            + "\t\t\t\t\t\t\t\t\t\"deploy_status\":2\n"
            + "\t\t\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t\t\t]\n"
            + "\t\t\t\t\t\t],\n"
            ...
            + "\t\t\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\t\t\"local_config_path\":\"/usr/share/havenask/data_havenask/local_search_12000"
            + "/general_0/zone_config/table/test/0/\",\n"
            + "\t\t\t\t\t\t\t\t\t\"deploy_status\":2\n"
            + "\t\t\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t\t\t]\n"
            + "\t\t\t\t\t\t],\n"
            ...
            + "\t\t\t\t\t\t\t\t{\n"
            + "\t\t\t\t\t\t\t\t\t\"local_config_path\":\"/usr/share/havenask/data_havenask/local_search_12000"
            + "/general_0/zone_config/table/test9/0/\",\n"
            + "\t\t\t\t\t\t\t\t\t\"deploy_status\":2\n"
            + "\t\t\t\t\t\t\t\t}\n"
            + "\t\t\t\t\t\t\t]\n"
            + "\t\t\t\t\t\t],\n"
