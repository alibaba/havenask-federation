...
public class ConvertProcessorFactoryTests extends HavenaskTestCase {
    ...
    public void testCreateUnsupportedType() throws Exception {
        ...
        try {
            ...
            assertThat(e.getMetadata("havenask.processor_type").get(0), equalTo(ConvertProcessor.TYPE));
            assertThat(e.getMetadata("havenask.property_name").get(0), equalTo("type"));
            assertThat(e.getMetadata("havenask.processor_tag"), nullValue());
        }
    }
