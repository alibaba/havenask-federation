 ...
 * (for example, @see org.havenask.discovery.HandshakingTransportAddressConnector, which constructs
...
public final class MockTransportService extends TransportService {
    ...
    public static MockNioTransport newMockTransport(Settings settings, Version version, ThreadPool threadPool) {
        settings = Settings.builder().put(TransportSettings.PORT.getKey(), HavenaskTestCase.getPortRange()).put(settings).build();
