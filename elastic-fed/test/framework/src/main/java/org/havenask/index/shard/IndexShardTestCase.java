...
import org.havenask.indices.recovery.RecoveryResponse;
 ...
 */
public abstract class IndexShardTestCase extends HavenaskTestCase {
    ...
    protected String snapshotShard(final IndexShard shard,
        ...
        final IndexShardSnapshotStatus snapshotStatus = IndexShardSnapshotStatus.newInitializing(
            HavenaskBlobStoreRepositoryIntegTestCase.getRepositoryData(repository).shardGenerations().getShardGen(
