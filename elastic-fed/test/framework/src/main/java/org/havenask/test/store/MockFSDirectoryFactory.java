...
public class MockFSDirectoryFactory implements IndexStorePlugin.DirectoryFactory {
    ...
    public Directory newDirectory(IndexSettings idxSettings, ShardPath path) throws IOException {
        ...
        Random random = new Random(idxSettings.getValue(HavenaskIntegTestCase.INDEX_TEST_SEED_SETTING));
            ...
            try {
                ...
                try {
                    ...
                    if (!status.clean) {
                        ...
                        HavenaskTestCase.checkIndexFailures.add(failure);
                        throw failure;
                    } else {
    ...
    private Directory wrap(Directory dir, Random random, Settings indexSettings, ShardId shardId) {
        ...
        final HavenaskMockDirectoryWrapper w = new HavenaskMockDirectoryWrapper(random, dir, crashIndex);
    ...
    public static final class HavenaskMockDirectoryWrapper extends MockDirectoryWrapper {

        private final boolean crash;

        public HavenaskMockDirectoryWrapper(Random random, Directory delegate, boolean crash) {
    ...
    static final class CloseableDirectory implements Closeable {
        ...
        CloseableDirectory(BaseDirectoryWrapper dir) {
            this.dir = dir;
            this.failureMarker = HavenaskTestCase.getSuiteFailureMarker();
        }
