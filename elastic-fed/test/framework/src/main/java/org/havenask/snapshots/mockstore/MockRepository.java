...
import org.havenask.common.blobstore.support.FilterBlobContainer;
...
public class MockRepository extends FsRepository {
    ...
    public static class Plugin extends org.havenask.plugins.Plugin implements RepositoryPlugin {
        ...
        private class MockBlobContainer extends FilterBlobContainer {
            ...
            private int hashCode(String path) {
                try {
                    ...
                    throw new HavenaskException("cannot calculate hashcode", ex);
                }
            }
