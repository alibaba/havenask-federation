...
import org.havenask.cluster.routing.RoutingTable.Builder;
...
public class ClusterStateCreationUtils {
    ...
    public static ClusterState stateWithAssignedPrimariesAndReplicas(String[] indices, int numberOfShards, int numberOfReplicas) {
        ...
        org.havenask.cluster.metadata.Metadata.Builder metadataBuilder = Metadata.builder();
    ...
    private static DiscoveryNode newNode(int nodeId) {
        return new DiscoveryNode("node_" + nodeId, HavenaskTestCase.buildNewFakeTransportAddress(), Collections.emptyMap(),
