 ...
 *
 * Note that this won't pass for nodes in clusters that don't have the node name defined in havenask.yml <strong>and</strong> start
 ...
 */
public abstract class JsonLogsIntegTestCase extends HavenaskRestTestCase {
    /**
