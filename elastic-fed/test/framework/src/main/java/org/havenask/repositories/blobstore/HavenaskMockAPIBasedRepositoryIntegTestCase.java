...
public abstract class HavenaskMockAPIBasedRepositoryIntegTestCase extends HavenaskBlobStoreRepositoryIntegTestCase {
    ...
    public abstract static class HttpStatsCollectorHandler implements DelegatingHttpHandler {
        ...
        synchronized Map<String, Long> getOperationsCount() {
            return org.havenask.common.collect.Map.copyOf(operationCount);
        }
