...
import org.havenask.common.util.concurrent.PrioritizedRunnable;
import org.havenask.test.HavenaskTestCase;

import java.util.concurrent.atomic.AtomicBoolean;

public class MockSinglePrioritizingExecutorTests extends HavenaskTestCase {
    ...
    public void testPrioritizedEsThreadPoolExecutor() {
        ...
        final PrioritizedHavenaskThreadPoolExecutor executor =
