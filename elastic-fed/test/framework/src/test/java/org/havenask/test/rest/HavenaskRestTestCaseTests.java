...
public class HavenaskRestTestCaseTests extends HavenaskTestCase {
    ...
    public void testIgnoreMatchMultipleTemplatesPattern() {
        ...
        Matcher matcher = HavenaskRestTestCase.CREATE_INDEX_MULTIPLE_MATCHING_TEMPLATES.matcher(input);
        ...
        matcher = HavenaskRestTestCase.PUT_TEMPLATE_MULTIPLE_MATCHING_TEMPLATES.matcher(input);
        assertThat(matcher.matches(), is(true));
