...
public class PluginsServiceTests extends HavenaskTestCase {
    ...
    public void testStartupWithRemovingMarker() throws IOException {
        ...
        PluginTestUtil.writePluginProperties(
                ...
                "name", "fake",
                "version", "1.0.0",
                "havenask.version", Version.CURRENT.toString(),
        ...
        final String expected = String.format(
                Locale.ROOT,
                "found file [%s] from a failed attempt to remove the plugin [fake]; execute [havenask-plugin remove fake]",
                removing);
        assertThat(e, hasToString(containsString(expected)));
    }
    ...
    public void testIncompatibleHavenaskVersion() throws Exception {
        ...
        assertThat(e.getMessage(), containsString("was built for Havenask version 6.0.0"));
    }
    ...
    public void testExistingMandatoryClasspathPlugin() {
        final Settings settings =
                Settings.builder()
                        ...
                        .put("plugin.mandatory", "org.havenask.plugins.PluginsServiceTests$FakePlugin")
                        .build();
