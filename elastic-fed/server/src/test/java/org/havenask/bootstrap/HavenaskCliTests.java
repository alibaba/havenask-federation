...
public class HavenaskCliTests extends HavenaskCliTestCase {
    ...
    public void testHavenaskSettings() throws Exception {
        runTest(
                ExitCodes.OK,
                true,
                (output, error) -> {},
    ...
    public void testHavenaskSettingCanNotBeEmpty() throws Exception {
        runTest(
                ExitCodes.USAGE,
                false,
