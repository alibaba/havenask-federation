...
public class MetadataIndexUpgradeServiceTests extends HavenaskTestCase {
    ...
    public void testFailUpgrade() {
        ...
        assertEquals(message, "The index [[foo/BOOM]] was created with version [" + indexCreated + "] " +
            ...
            " It should be re-indexed in Havenask " + minCompat.major + ".x before upgrading to " + Version.CURRENT.toString() + ".");
