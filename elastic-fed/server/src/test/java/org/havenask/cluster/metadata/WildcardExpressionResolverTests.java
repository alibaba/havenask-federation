...
public class WildcardExpressionResolverTests extends HavenaskTestCase {
    ...
    public void testResolveDataStreams() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.havenask.common.collect.List.of(firstBackingIndexMetadata.getIndex(), secondBackingIndexMetadata.getIndex())));
