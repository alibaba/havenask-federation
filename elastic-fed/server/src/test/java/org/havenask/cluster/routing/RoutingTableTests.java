...
public class RoutingTableTests extends HavenaskAllocationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        RoutingTable testRoutingTable = new RoutingTable.Builder()
                ...
                .build();
        this.clusterState = ClusterState.builder(org.havenask.cluster.ClusterName.CLUSTER_NAME_SETTING
