...
public class PrimaryTermsTests extends HavenaskAllocationTestCase {
    ...
    public void setUp() throws Exception {
        ...
        this.clusterState = ClusterState.builder(org.havenask.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
