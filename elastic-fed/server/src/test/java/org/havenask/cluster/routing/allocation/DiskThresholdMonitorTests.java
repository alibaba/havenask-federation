...
public class DiskThresholdMonitorTests extends HavenaskAllocationTestCase {
    ...
    @TestLogging(value="org.havenask.cluster.routing.allocation.DiskThresholdMonitor:INFO", reason="testing INFO/WARN logging")
