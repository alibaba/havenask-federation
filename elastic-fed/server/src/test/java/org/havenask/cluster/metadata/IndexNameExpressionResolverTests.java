...
import static org.havenask.cluster.metadata.IndexMetadata.INDEX_HIDDEN_SETTING;
...
public class IndexNameExpressionResolverTests extends HavenaskTestCase {
    ...
    public void testIndicesAliasesRequestTargetDataStreams() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.havenask.common.collect.List.of(backingIndex.getIndex()), 1));
        ClusterState state = ClusterState.builder(new ClusterName("_name")).metadata(mdBuilder).build();
    ...
    public void testDataStreams() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(index2, false)
            .put(new DataStream(dataStreamName, createTimestampField("@timestamp"),
                org.havenask.common.collect.List.of(index1.getIndex(), index2.getIndex()), 2));
        ClusterState state = ClusterState.builder(new ClusterName("_name")).metadata(mdBuilder).build();
    ...
    public void testDataStreamsWithWildcardExpression() {
        ...
        Metadata.Builder mdBuilder = Metadata.builder()
            ...
            .put(new DataStream(dataStream1, createTimestampField("@timestamp"),
                org.havenask.common.collect.List.of(index1.getIndex(), index2.getIndex())))
            .put(new DataStream(dataStream2, createTimestampField("@timestamp"),
                org.havenask.common.collect.List.of(index3.getIndex(), index4.getIndex())));
    ...
    public void testDataStreamsWithRegularIndexAndAlias() {
        ...
        IndexMetadata justAnIndex = IndexMetadata.builder("logs-foobarbaz-0")
            .settings(HavenaskTestCase.settings(Version.CURRENT))
            .numberOfShards(1)
            .numberOfReplicas(1)
