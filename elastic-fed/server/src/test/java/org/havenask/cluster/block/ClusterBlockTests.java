...
public class ClusterBlockTests extends HavenaskTestCase {
    ...
    public void testGetIndexBlockWithId() {
        ...
        assertThat(builder.build().getIndexBlockWithId("index", randomValueOtherThan(blockId, HavenaskTestCase::randomInt)), nullValue());
    }
