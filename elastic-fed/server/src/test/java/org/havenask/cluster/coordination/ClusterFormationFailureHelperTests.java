...
public class ClusterFormationFailureHelperTests extends HavenaskTestCase {
    ...
    public void testDescriptionOnUnhealthyNodes() {
        ...
        final DiscoveryNode masterNode = new DiscoveryNode("local", buildNewFakeTransportAddress(), emptyMap(),
            org.havenask.common.collect.Set.of(DiscoveryNodeRole.MASTER_ROLE), Version.CURRENT);
