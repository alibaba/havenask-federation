...
public class TransportBulkActionIndicesThatCannotBeCreatedTests extends HavenaskTestCase {
    ...
    private void indicesThatCannotBeCreatedTestCase(Set<String> expected,
        ...
        final ExecutorService direct = HavenaskExecutors.newDirectExecutorService();
