...
public class TransportMasterNodeActionTests extends HavenaskTestCase {
    ...
    public void testDelegateToFailingMaster() throws ExecutionException, InterruptedException {
        ...
        if (rejoinSameMaster) {
            ...
            HavenaskException t = new HavenaskException("test");
            ...
            try {
                ...
                final HavenaskException es = (HavenaskException) cause;
