...
import org.havenask.index.shard.IndexShardNotStartedException;
...
public class ReplicationOperationTests extends HavenaskTestCase {
        ...
        for (ShardRouting replica : expectedReplicas) {
            ...
            if (randomBoolean()) {
                if (randomBoolean()) {
                    ...
                    cause = new HavenaskRejectedExecutionException("rejected");
                }
