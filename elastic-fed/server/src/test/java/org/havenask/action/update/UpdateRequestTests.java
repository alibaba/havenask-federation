...
import static org.havenask.script.MockScriptEngine.mockInlineScript;
...
public class UpdateRequestTests extends HavenaskTestCase {
    ...
    private void runTimeoutTest(final GetResult getResult, final UpdateRequest updateRequest) {
        final UpdateHelper.Result result = updateHelper.prepare(
                ...
                updateRequest,
                getResult,
                HavenaskTestCase::randomNonNegativeLong);
