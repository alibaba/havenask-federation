...
import org.havenask.action.support.ListenerTimeouts;
...
public class ListenerTimeoutsTests extends HavenaskTestCase {
    ...
    public void testListenerTimeout() {
        ...
        assertThat(exception.get(), instanceOf(HavenaskTimeoutException.class));
    }
