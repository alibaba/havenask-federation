...
import org.havenask.action.support.replication.TransportWriteAction.WritePrimaryResult;
...
public class TransportShardBulkActionTests extends IndexShardTestCase {
    ...
    public void testSkipBulkIndexRequestIfAborted() throws Exception {
        ...
        final HavenaskStatusException rejectionCause = new HavenaskStatusException("testing rejection", rejectionStatus);
    ...
    public void testUpdateRequestWithFailure() throws Exception {
        ...
        Exception err = new HavenaskException("I'm dead <(x.x)>");
    ...
    public void testFailureDuringUpdateProcessing() throws Exception {
        ...
        UpdateHelper updateHelper = mock(UpdateHelper.class);
        final HavenaskException err = new HavenaskException("oops");
    ...
    public void testForceExecutionOnRejectionAfterMappingUpdate() throws Exception {
        ...
        try {
            ...
            when(shard.getFailedIndexResult(any(HavenaskRejectedExecutionException.class), anyLong())).thenCallRealMethod();
            when(shard.mapperService()).thenReturn(mock(MapperService.class));
            ...
            assertThat(primaryResponse2.getFailure().getCause(), instanceOf(HavenaskRejectedExecutionException.class));
