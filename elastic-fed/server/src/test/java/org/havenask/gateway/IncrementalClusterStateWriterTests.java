...
public class IncrementalClusterStateWriterTests extends HavenaskAllocationTestCase {
    ...
    @TestLogging(value = "org.havenask.gateway:WARN", reason = "to ensure that we log gateway events on WARN level")
