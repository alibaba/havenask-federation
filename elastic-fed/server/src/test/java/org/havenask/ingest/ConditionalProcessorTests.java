...
import org.havenask.script.IngestConditionalScript;
...
public class ConditionalProcessorTests extends HavenaskTestCase {
    ...
    public void testPrecompiledError() {
        ScriptService scriptService = MockScriptService.singleContext(IngestConditionalScript.CONTEXT, code -> {
            throw new ScriptException("bad script", new ParseException("error", 0),
                org.havenask.common.collect.List.of(), "", "lang", null);
        }, org.havenask.common.collect.Map.of());
        Script script = new Script(ScriptType.INLINE, "lang", "foo", org.havenask.common.collect.Map.of());
    ...
    public void testRuntimeCompileError() {
        ...
        storedScripts.put("foo", new StoredScriptSource("lang", "", org.havenask.common.collect.Map.of()));
        ScriptService scriptService = MockScriptService.singleContext(IngestConditionalScript.CONTEXT, code -> {
            if (fail.get()) {
                throw new ScriptException("bad script", new ParseException("error", 0),
                    org.havenask.common.collect.List.of(), "", "lang", null);
        ...
        Script script = new Script(ScriptType.STORED, null, "foo", org.havenask.common.collect.Map.of());
        ...
        storedScripts.put("foo", new StoredScriptSource("lang", "changed", org.havenask.common.collect.Map.of()));
        IngestDocument ingestDoc = new IngestDocument(org.havenask.common.collect.Map.of(),
            org.havenask.common.collect.Map.of());
