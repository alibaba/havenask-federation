...
public class PipelineProcessorTests extends HavenaskTestCase {
    ...
    public void testThrowsOnRecursivePipelineInvocations() throws Exception {
        ...
        outerConfig.put("name", innerPipelineId);
        HavenaskException[] e = new HavenaskException[1];
        factory.create(Collections.emptyMap(), null, null, outerConfig)
            .execute(testIngestDocument, (result, e1) -> e[0] = (HavenaskException) e1);
        assertEquals(
