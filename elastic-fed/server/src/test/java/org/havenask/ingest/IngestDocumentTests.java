...
public class IngestDocumentTests extends HavenaskTestCase {
    ...
    public void testListAppendFieldValueWithDuplicate() {
        ...
        List<Object> list = (List<Object>) object;
        assertThat(list.size(), equalTo(3));
        assertThat(list, equalTo(org.havenask.common.collect.List.of("foo", "bar", "baz")));
    }
    ...
    public void testListAppendFieldValueWithoutDuplicate() {
        ...
        assertThat(list, equalTo(org.havenask.common.collect.List.of("foo", "bar", "baz", "foo2")));
    }
    ...
    public void testListAppendFieldValuesWithoutDuplicates() {
        ingestDocument.appendFieldValue("list2", org.havenask.common.collect.List.of("foo", "bar", "baz", "foo2"), false);
        Object object = ingestDocument.getSourceAndMetadata().get("list2");
        assertThat(object, instanceOf(List.class));
        @SuppressWarnings("unchecked")
        List<Object> list = (List<Object>) object;
