...
public class JodaCompatibleZonedDateTimeTests extends HavenaskTestCase {
    private static final Logger DEPRECATION_LOGGER =
        LogManager.getLogger("org.havenask.deprecation.script.JodaCompatibleZonedDateTime");
