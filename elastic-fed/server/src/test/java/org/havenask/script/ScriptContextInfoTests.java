...
import org.havenask.script.ScriptContextInfo.ScriptMethodInfo;
import org.havenask.script.ScriptContextInfo.ScriptMethodInfo.ParameterInfo;
...
public class ScriptContextInfoTests extends HavenaskTestCase {
    ...
    public void testCustomTypeContext() {
        String ct = "org.havenask.script.ScriptContextInfoTests$CustomType";
        String ct0 = ct + 0;
        String ct1 = ct + 1;
        String ct2 = ct + 2;
    ...
    public void testScriptContextInfoParser() throws IOException {
        String json = "{" +
            ...
            "        }," +
            "        {" +
            "          \"type\": \"org.havenask.index.similarity.ScriptedSimilarity$Query\"," +
            "          \"name\": \"query\"" +
            "        }," +
            "        {" +
            "          \"type\": \"org.havenask.index.similarity.ScriptedSimilarity$Field\"," +
            "          \"name\": \"field\"" +
            "        }," +
            "        {" +
            "          \"type\": \"org.havenask.index.similarity.ScriptedSimilarity$Term\"," +
            "          \"name\": \"term\"" +
            "        }," +
            "        {" +
            "          \"type\": \"org.havenask.index.similarity.ScriptedSimilarity$Doc\"," +
            "          \"name\": \"doc\"" +
            "        }" +
            "      ]" +
            "    }," +
        ...
        ScriptContextInfo expected = new ScriptContextInfo(
            ...
            new ScriptMethodInfo(
                ...
                Collections.unmodifiableList(Arrays.asList(
                    ...
                    new ParameterInfo("org.havenask.index.similarity.ScriptedSimilarity$Query", "query"),
                    new ParameterInfo("org.havenask.index.similarity.ScriptedSimilarity$Field", "field"),
                    new ParameterInfo("org.havenask.index.similarity.ScriptedSimilarity$Term", "term"),
                    new ParameterInfo("org.havenask.index.similarity.ScriptedSimilarity$Doc", "doc")
                )
            )),
