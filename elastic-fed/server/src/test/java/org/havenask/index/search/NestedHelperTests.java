...
public class NestedHelperTests extends HavenaskSingleNodeTestCase {
    ...
    public void testNested() throws IOException {
        ...
        HavenaskToParentBlockJoinQuery query = (HavenaskToParentBlockJoinQuery) queryBuilder.toQuery(context);
        ...
        query = (HavenaskToParentBlockJoinQuery) queryBuilder.toQuery(context);
