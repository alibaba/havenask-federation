...
public class IndexReaderWrapperTests extends HavenaskTestCase {
    ...
    public void testReaderCloseListenerIsCalled() throws IOException {
        ...
        DirectoryReader open = HavenaskDirectoryReader.wrap(DirectoryReader.open(writer), new ShardId("foo", "_na_", 1));
        ...
        HavenaskDirectoryReader.addReaderCloseListener(wrap.getDirectoryReader(), key -> {
