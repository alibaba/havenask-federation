...
public class StoreTests extends HavenaskTestCase {
    ...
    private static final Version MIN_SUPPORTED_LUCENE_VERSION = org.havenask.Version.CURRENT
    ...
    public void testMetadataSnapshotStreaming() throws Exception {
        ...
        org.havenask.Version targetNodeVersion = randomVersion(random());
