...
public class MultiFieldTests extends HavenaskSingleNodeTestCase {

    public void testMultiFieldMultiFields() throws Exception {
        String mapping = copyToStringFromClasspath("/org/havenask/index/mapper/multifield/test-multi-fields.json");
    ...
    private void testMultiField(String mapping) throws Exception {
        ...
        BytesReference json = new BytesArray(copyToBytesFromClasspath("/org/havenask/index/mapper/multifield/test-data.json"));
