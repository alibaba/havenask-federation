...
import org.havenask.common.settings.AbstractScopedSettings;
...
public class IndexSettingsTests extends HavenaskTestCase {
    ...
    public void testMaxAdjacencyMatrixFiltersSetting() {
        ...
        assertEquals(IndexSettings.MAX_ADJACENCY_MATRIX_FILTERS_SETTING.get(Settings.EMPTY).intValue(),
                settings.getMaxAdjacencyMatrixFilters());
        assertWarnings("[index.max_adjacency_matrix_filters] setting was deprecated in Havenask and will be removed in a "
