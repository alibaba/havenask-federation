...
public class BitSetFilterCacheTests extends HavenaskTestCase {
    ...
    public void testInvalidateEntries() throws Exception {
        ...
        reader = HavenaskDirectoryReader.wrap(reader, new ShardId("test", "_na_", 0));
    ...
    public void testListener() throws IOException {
        ...
        final IndexReader reader = HavenaskDirectoryReader.wrap(writerReader, new ShardId("test", "_na_", 0));
    ...
    public void testRejectOtherIndex() throws IOException {
        ...
        DirectoryReader reader = DirectoryReader.open(writer);
        writer.close();
        reader = HavenaskDirectoryReader.wrap(reader, new ShardId("test2", "_na_", 0));
