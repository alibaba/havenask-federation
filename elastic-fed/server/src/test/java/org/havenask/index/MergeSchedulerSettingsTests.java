...
import static org.havenask.common.util.concurrent.HavenaskExecutors.NODE_PROCESSORS_SETTING;
import static org.havenask.index.IndexSettingsTests.newIndexMeta;
import static org.havenask.index.MergeSchedulerConfig.MAX_MERGE_COUNT_SETTING;
import static org.havenask.index.MergeSchedulerConfig.MAX_THREAD_COUNT_SETTING;
import static org.hamcrest.core.StringContains.containsString;

public class MergeSchedulerSettingsTests extends HavenaskTestCase {
    ...
    public void testUpdateAutoThrottleSettings() throws Exception {
        ...
        mockAppender.start();
        final Logger settingsLogger = LogManager.getLogger("org.havenask.common.settings.IndexScopedSettings");
