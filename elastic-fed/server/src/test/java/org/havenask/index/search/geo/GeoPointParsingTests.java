...
package org.havenask.index.search.geo;
...
public class GeoPointParsingTests  extends HavenaskTestCase {
    ...
    public void testInvalidPointEmbeddedObject() throws IOException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, BytesReference.bytes(content))) {
            parser.nextToken();
            Exception e = expectThrows(HavenaskParseException.class, () -> GeoUtils.parseGeoPoint(parser));
