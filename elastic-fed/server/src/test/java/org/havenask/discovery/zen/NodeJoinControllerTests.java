...
import static org.havenask.test.VersionUtils.allVersions;
...
public class NodeJoinControllerTests extends HavenaskTestCase {
    ...
    private static ClusterState initialState(boolean withMaster) {
        DiscoveryNode localNode = new DiscoveryNode("node", HavenaskTestCase.buildNewFakeTransportAddress(), Collections.emptyMap(),
