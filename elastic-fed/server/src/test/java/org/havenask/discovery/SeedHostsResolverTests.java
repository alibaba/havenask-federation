...
public class SeedHostsResolverTests extends HavenaskTestCase {
    ...
    public void startResolver() {
        ...
        final ThreadFactory threadFactory = HavenaskExecutors.daemonThreadFactory("[" + getClass().getName() + "]");
        executorService =
            HavenaskExecutors.newScaling(
