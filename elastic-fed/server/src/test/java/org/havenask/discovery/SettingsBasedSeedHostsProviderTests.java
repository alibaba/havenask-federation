...
import org.havenask.discovery.SeedHostsProvider.HostsResolver;
...
public class SettingsBasedSeedHostsProviderTests extends HavenaskTestCase {
    ...
    public void testGetsHostsFromLegacySetting() {
        ...
        new SettingsBasedSeedHostsProvider(Settings.builder()
            ...
            .build(), null).getSeedAddresses(hostsResolver);
        assertTrue(hostsResolver.getResolvedHosts());
        assertWarnings("[discovery.zen.ping.unicast.hosts] setting was deprecated in Havenask and will be removed in a future " +
