...
public class FixedThreadPoolTests extends HavenaskThreadPoolTestCase {
    ...
    public void testRejectedExecutionCounter() throws InterruptedException {
        ...
        final int size = randomIntBetween(1, HavenaskExecutors.allocatedProcessors(Settings.EMPTY));
