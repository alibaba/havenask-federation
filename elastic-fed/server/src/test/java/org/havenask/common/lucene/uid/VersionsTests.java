...
package org.havenask.common.lucene.uid;
...
import static org.havenask.common.lucene.uid.VersionsAndSeqNoResolver.loadDocIdAndVersion;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.nullValue;

public class VersionsTests extends HavenaskTestCase {
    ...
    public void testVersions() throws Exception {
        ...
        DirectoryReader directoryReader = HavenaskDirectoryReader.wrap(DirectoryReader.open(writer), new ShardId("foo", "_na_", 1));
    ...
    public void testCacheFilterReader() throws Exception {
        ...
        assertEquals(size+1, VersionsAndSeqNoResolver.lookupStates.size());
        // now wrap the reader
        DirectoryReader wrapped = HavenaskDirectoryReader.wrap(reader, new ShardId("bogus", "_na_", 5));
