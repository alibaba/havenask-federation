...
import org.havenask.common.geo.parsers.GeoWKTParser;
...
public class GeoWKTShapeParserTests extends BaseGeoParsingTestCase {
    ...
    private void assertMalformed(ShapeBuilder<?, ?, ?> builder) throws IOException {
        ...
        assertValidException(xContentBuilder, HavenaskParseException.class);
    }
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertExpected(new org.havenask.geometry.Point(p.lon(), p.lat()), new PointBuilder().coordinate(c), false);
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        List<org.havenask.geometry.Point> points = new ArrayList<>(numPoints);
        for (int i = 0; i < numPoints; ++i) {
            Coordinate c = coordinates.get(i);
            points.add(new org.havenask.geometry.Point(c.x, c.y));
        }
    ...
    public void testParseOpenPolygon() throws IOException {
        ...
        HavenaskParseException exception = expectThrows(HavenaskParseException.class,
    ...
    public void testMalformedWKT() throws IOException {
        ...
        assertValidException(builder, HavenaskParseException.class);
    }
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertExpected(expected, builder, true);
        assertExpected(new org.havenask.geometry.Rectangle(r.minLon, r.maxLon, r.maxLat, r.minLat), builder, false);
        assertMalformed(builder);
    }
