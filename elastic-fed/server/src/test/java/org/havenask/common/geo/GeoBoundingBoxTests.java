 ...
 */
public class GeoBoundingBoxTests extends HavenaskTestCase {
    ...
    public void testInvalidParseInvalidWKT() throws IOException {
        ...
        parser.nextToken();
        HavenaskParseException e = expectThrows(HavenaskParseException.class, () -> GeoBoundingBox.parseBoundingBox(parser));
