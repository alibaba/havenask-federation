...
public class ListenableFutureTests extends HavenaskTestCase {
    ...
    public void testListenableFutureNotifiesListeners() {
        ...
        for (int i = 0; i < numberOfListeners; i++) {
            future.addListener(
                ActionListener.wrap(notifications::incrementAndGet), HavenaskExecutors.newDirectExecutorService(), threadContext);
        }
    ...
    public void testListenableFutureNotifiesListenersOnException() {
        ...
        for (int i = 0; i < numberOfListeners; i++) {
            ...
            }), HavenaskExecutors.newDirectExecutorService(), threadContext);
        }
    ...
    public void testConcurrentListenerRegistrationAndCompletion() throws BrokenBarrierException, InterruptedException {
        ...
        executorService = HavenaskExecutors.newFixed("testConcurrentListenerRegistrationAndCompletion", numberOfThreads, 1000,
            HavenaskExecutors.daemonThreadFactory("listener"), threadContext);
