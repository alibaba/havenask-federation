...
public class JavaJodaTimeDuellingTests extends HavenaskTestCase {
    @Override
  ...
  */
    ...
    public void testExceptionWhenCompositeParsingFailsDateMath(){
        ...
        HavenaskParseException e1 = expectThrows(HavenaskParseException.class,
        ...
        HavenaskParseException e2 = expectThrows(HavenaskParseException.class,
