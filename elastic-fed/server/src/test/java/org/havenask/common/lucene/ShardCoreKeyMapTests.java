...
package org.havenask.common.lucene;
...
public class ShardCoreKeyMapTests extends HavenaskTestCase {
    ...
    public void testAddingAClosedReader() throws Exception {
        ...
        try (Directory dir = newDirectory();
            ...
            try (DirectoryReader dirReader = HavenaskDirectoryReader.wrap(writer.getReader(), new ShardId("index1", "_na_", 1))) {
    ...
    public void testBasics() throws IOException {
        ...
        HavenaskDirectoryReader reader1 = HavenaskDirectoryReader.wrap(w1.getReader(), shardId1);
        HavenaskDirectoryReader reader2 = HavenaskDirectoryReader.wrap(w2.getReader(), shardId2);
        HavenaskDirectoryReader reader3 = HavenaskDirectoryReader.wrap(w3.getReader(), shardId3);
        ...
        w1.addDocument(new Document());
        HavenaskDirectoryReader newReader1 = HavenaskDirectoryReader.wrap(w1.getReader(), shardId1);
        reader1.close();
        reader1 = newReader1;
        ...
        w2.addDocument(new Document());
        w2.forceMerge(1);
        HavenaskDirectoryReader newReader2 = HavenaskDirectoryReader.wrap(w2.getReader(), shardId2);
        reader2.close();
        reader2 = newReader2;
