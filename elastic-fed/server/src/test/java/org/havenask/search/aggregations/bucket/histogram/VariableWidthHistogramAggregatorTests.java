...
public class VariableWidthHistogramAggregatorTests extends AggregatorTestCase {
    ...
    public void testAsSubAggregation() throws IOException {
        ...
        CheckedConsumer<RandomIndexWriter, IOException> buildIndex = iw -> {
            iw.addDocument(
                org.havenask.common.collect.List.of(new SortedNumericDocValuesField("t", 1), new SortedNumericDocValuesField("v", 1))
            );
            iw.addDocument(
                org.havenask.common.collect.List.of(new SortedNumericDocValuesField("t", 1), new SortedNumericDocValuesField("v", 10))
            );
            iw.addDocument(
                org.havenask.common.collect.List.of(new SortedNumericDocValuesField("t", 1), new SortedNumericDocValuesField("v", 11))
            );

            iw.addDocument(
                org.havenask.common.collect.List.of(new SortedNumericDocValuesField("t", 2), new SortedNumericDocValuesField("v", 20))
            );
            iw.addDocument(
                org.havenask.common.collect.List.of(new SortedNumericDocValuesField("t", 2), new SortedNumericDocValuesField("v", 30))
            );
        };
        Consumer<LongTerms> verify = terms -> {
            ...
            assertThat(
                ...
                equalTo(org.havenask.common.collect.List.of(1.0, 10.5))
            );
            ...
            assertThat(
                ...
                equalTo(org.havenask.common.collect.List.of(20.0, 30))
            );
        };
    ...
    public void testHugeShardSize() throws Exception {
        ...
        testSearchCase(DEFAULT_QUERY, dataset, true, aggregation -> aggregation.field(NUMERIC_FIELD).setShardSize(1000000000),
            histogram -> assertThat(
                ...
                equalTo(org.havenask.common.collect.List.of(1.0, 2.0, 3.0)))
        );
    }
