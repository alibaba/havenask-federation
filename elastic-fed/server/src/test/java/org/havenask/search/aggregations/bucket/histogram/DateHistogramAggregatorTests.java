    ...
    public void testAsSubAgg() throws IOException {
        ...
        asSubAggTestCase(builder, (StringTerms terms) -> {
            ...
            assertThat(adh.getBuckets().stream().map(bucket -> bucket.getKey().toString()).collect(toList()),
                equalTo(org.havenask.common.collect.List.of("2020-01-01T00:00Z", "2021-01-01T00:00Z")
            ));
            ...
            assertThat(
                ...
                equalTo(org.havenask.common.collect.List.of("2020-01-01T00:00Z"))
            );
        });
        ...
        asSubAggTestCase(builder, (StringTerms terms) -> {
            ...
            assertThat(
                ...
                equalTo(org.havenask.common.collect.List.of("2021-01-01T00:00Z"))
            );
