...
import static org.havenask.search.aggregations.AggregationBuilders.geoDistance;
...
public class GeoDistanceIT extends HavenaskIntegTestCase {
    ...
    public void testMultiValues() throws Exception {
        SearchResponse response = client().prepareSearch("idx-multi")
                .addAggregation(geoDistance("amsterdam_rings", new GeoPoint(52.3760, 4.894))
                        .field("location")
                        .unit(DistanceUnit.KILOMETERS)
                        .distanceType(org.havenask.common.geo.GeoDistance.ARC)
                        .addUnboundedTo(500)
                        .addRange(500, 1000)
                        .addUnboundedFrom(1000))
                .get();
