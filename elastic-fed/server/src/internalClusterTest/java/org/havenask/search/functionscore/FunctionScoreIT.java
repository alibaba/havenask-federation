...
public class FunctionScoreIT extends HavenaskIntegTestCase {
    ...
    public void testMinScoreFunctionScoreBasic() throws IOException {
        float score = randomValueOtherThanMany((f) -> Float.compare(f, 0) < 0, HavenaskTestCase::randomFloat);
        float minScore = randomValueOtherThanMany((f) -> Float.compare(f, 0) < 0, HavenaskTestCase::randomFloat);
