...
import static org.havenask.client.transport.TransportClient.CLIENT_TRANSPORT_NODES_SAMPLER_INTERVAL;

@ClusterScope(scope = Scope.TEST)
public class NodeDisconnectIT  extends HavenaskIntegTestCase {
