...
import org.havenask.search.aggregations.bucket.histogram.Histogram.Bucket;
...
public class IndicesRequestCacheIT extends HavenaskIntegTestCase {
    ...
    public void testQueryRewrite() throws Exception {
        ...
        HavenaskAssertions.assertAllSuccessful(forceMergeResponse);
        refresh();
        ensureSearchable("index");
        ...
        final SearchResponse r1 = client.prepareSearch("index").setSearchType(SearchType.QUERY_THEN_FETCH).setSize(0)
            ...
            .get();
        HavenaskAssertions.assertAllSuccessful(r1);
        ...
        final SearchResponse r2 = client.prepareSearch("index").setSearchType(SearchType.QUERY_THEN_FETCH).setSize(0)
            ...
            .addAggregation(new GlobalAggregationBuilder("global"))
            .get();
        HavenaskAssertions.assertAllSuccessful(r2);
        ...
        final SearchResponse r3 = client.prepareSearch("index").setSearchType(SearchType.QUERY_THEN_FETCH).setSize(0)
            ...
            .addAggregation(new GlobalAggregationBuilder("global"))
            .get();
        HavenaskAssertions.assertAllSuccessful(r3);
    ...
    public void testCanCache() throws Exception {
        ...
        HavenaskAssertions.assertAllSuccessful(r5);
        ...
        HavenaskAssertions.assertAllSuccessful(r6);
        ...
        HavenaskAssertions.assertAllSuccessful(r4);
    ...
    public void testProfileDisableCache() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            HavenaskAssertions.assertAllSuccessful(resp);
