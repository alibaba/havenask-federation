...
import org.havenask.cluster.metadata.IndexGraveyardTests;
...
import org.havenask.snapshots.SnapshotsInProgressSerializationTests;
...
import static org.havenask.cluster.metadata.AliasMetadata.newAliasMetadataBuilder;
import static org.havenask.cluster.routing.RandomShardRoutingMutator.randomChange;
import static org.havenask.cluster.routing.RandomShardRoutingMutator.randomReason;
...
@HavenaskIntegTestCase.ClusterScope(scope = HavenaskIntegTestCase.Scope.SUITE, numDataNodes = 0, numClientNodes = 0)
public class ClusterStateDiffIT extends HavenaskIntegTestCase {
