...
public class RemoveSettingsCommandIT extends HavenaskIntegTestCase {
    ...
    public void testRemoveSettingsAbortedByUser() throws Exception {
        ...
        expectThrows(() -> removeSettings(environment, true,
            ...
            HavenaskNodeCommand.ABORTED_BY_USER_MSG);
    }
    ...
    private MockTerminal executeCommand(HavenaskNodeCommand command, Environment environment, boolean abort, String... args)
        throws Exception {
