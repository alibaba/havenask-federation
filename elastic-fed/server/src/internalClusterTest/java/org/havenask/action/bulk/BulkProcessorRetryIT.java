...
@HavenaskIntegTestCase.ClusterScope(scope = HavenaskIntegTestCase.Scope.SUITE, numDataNodes = 2)
public class BulkProcessorRetryIT extends HavenaskIntegTestCase {
