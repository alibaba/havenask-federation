...
public class Version implements Comparable<Version>, ToXContentFragment {
    ...
    public static final Version V_1_1_0 = new Version(1010099, org.apache.lucene.util.Version.LUCENE_8_7_0);
    public static final Version V_1_2_0 = new Version(1020099, org.apache.lucene.util.Version.LUCENE_8_7_0);
    ...
    /**
     * Return the {@link Version} of Havenask that has been used to create an index given its settings.
     *
    ...
    Version(int id, org.apache.lucene.util.Version luceneVersion) {
        // flip the 28th bit of the ID; identify as an havenask vs legacy system:
        // we start from version 1 for havenask, so ignore the 0 (empty) version
        if(id != 0) {
            this.id = id ^ MASK;
            id &= 0xF7FFFFFF;
        } else {
    ...
    public boolean isCompatible(Version version) {
        ...
        // Havenask version 1 is the functional equivalent of predecessor version 7
