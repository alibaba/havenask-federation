...
class HavenaskUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    private static final Logger logger = LogManager.getLogger(HavenaskUncaughtExceptionHandler.class);
    ...
    void onFatalUncaught(final String threadName, final Throwable t) {
        ...
        // Without a final flush, the stacktrace may not be shown before Havenask exits
    ...
    void onNonFatalUncaught(final String threadName, final Throwable t) {
        ...
        Terminal.DEFAULT.errorPrintln(message);
        t.printStackTrace(Terminal.DEFAULT.getErrorWriter());
        // Without a final flush, the stacktrace may not be shown if Havenask goes on to exit
        Terminal.DEFAULT.flush();
    }
