...
final class HavenaskPolicy extends Policy {
    ...
    HavenaskPolicy(Map<String, URL> codebases, PermissionCollection dynamic, Map<String,Policy> plugins, boolean filterBadDefaults,
