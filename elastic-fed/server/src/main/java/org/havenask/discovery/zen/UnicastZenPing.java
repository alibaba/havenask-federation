...
public class UnicastZenPing implements ZenPing {
    ...
    protected final HavenaskThreadPoolExecutor unicastZenPingExecutorService;
    ...
    public UnicastZenPing(Settings settings, ThreadPool threadPool, TransportService transportService,
        ...
        final ThreadFactory threadFactory = HavenaskExecutors.daemonThreadFactory(settings, "[unicast_connect]");
        unicastZenPingExecutorService = HavenaskExecutors.newScaling(
