...
public class NamedAnalyzer extends DelegatingAnalyzerWrapper {
    ...
    public NamedAnalyzer(String name, AnalyzerScope scope, Analyzer analyzer, int positionIncrementGap) {
        ...
        if (analyzer instanceof org.havenask.index.analysis.AnalyzerComponentsProvider) {
            this.analysisMode = ((org.havenask.index.analysis.AnalyzerComponentsProvider) analyzer).getComponents().analysisMode();
        } else {
