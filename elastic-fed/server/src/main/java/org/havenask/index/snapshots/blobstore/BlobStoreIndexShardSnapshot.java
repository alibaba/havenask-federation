...
public class BlobStoreIndexShardSnapshot implements ToXContentFragment {
    ...
    public static class FileInfo {
        ...
        /**
         * Returns file md5 checksum provided by {@link org.havenask.index.store.Store}
         *
        ...
        public static FileInfo fromXContent(XContentParser parser) throws IOException {
                    ...
                    if (token == XContentParser.Token.FIELD_NAME) {
                        ...
                        if (token.isValue()) {
                            if (NAME.equals(currentFieldName)) {
                                ...
                                throw new HavenaskParseException("unknown parameter [{}]", currentFieldName);
                            }
                        } else {
            ...
            if (name == null || Strings.validFileName(name) == false) {
                ...
                throw new HavenaskParseException("missing or invalid written_by [" + writtenByStr + "]");
            } else if (checksum == null) {
                throw new HavenaskParseException("missing checksum for name [" + name + "]");
            }
    ...
    // + there is a constraint in #fromXContent() that leads to HavenaskParseException("unknown parameter [incremental_file_count]");
