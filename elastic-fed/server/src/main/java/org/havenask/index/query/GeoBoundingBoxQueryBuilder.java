...
public class GeoBoundingBoxQueryBuilder extends AbstractQueryBuilder<GeoBoundingBoxQueryBuilder> {
    ...
    public static GeoBoundingBoxQueryBuilder fromXContent(XContentParser parser) throws IOException {
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                try {
                    ...
                    throw new HavenaskParseException("failed to parse [{}] query. [{}]", NAME, e.getMessage());
                }
        ...
        if (bbox == null) {
            throw new HavenaskParseException("failed to parse [{}] query. bounding box not provided", NAME);
        }
