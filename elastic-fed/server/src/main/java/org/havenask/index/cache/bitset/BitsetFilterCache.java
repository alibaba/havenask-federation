...
package org.havenask.index.cache.bitset;
...
import org.havenask.common.cache.Cache;
import org.havenask.common.cache.CacheBuilder;
import org.havenask.common.cache.RemovalListener;
...
import org.havenask.index.IndexWarmer;
import org.havenask.index.IndexWarmer.TerminationHandle;
 ...
 * {@link org.havenask.index.cache.query.QueryCache} should be used instead.
 */
public final class BitsetFilterCache extends AbstractIndexComponent
    ...
    final class BitSetProducerWarmer implements IndexWarmer.Listener {
        ...
        @Override
        public IndexWarmer.TerminationHandle warmReader(final IndexShard indexShard, final HavenaskDirectoryReader reader) {
