...
public final class PreConfiguredTokenFilter extends PreConfiguredAnalysisComponent<TokenFilterFactory> {
     ...
     */
    public static PreConfiguredTokenFilter havenaskVersion(String name, boolean useFilterForMultitermQueries,
            BiFunction<TokenStream, org.havenask.Version, TokenStream> create) {
        return new PreConfiguredTokenFilter(name, useFilterForMultitermQueries, true, CachingStrategy.HAVENASK, create);
    }
    ...
    public static PreConfiguredTokenFilter havenaskVersion(String name, boolean useFilterForMultitermQueries,
        ...
        return new PreConfiguredTokenFilter(name, useFilterForMultitermQueries, useFilterForParsingSynonyms,
                CachingStrategy.HAVENASK, create);
    }
