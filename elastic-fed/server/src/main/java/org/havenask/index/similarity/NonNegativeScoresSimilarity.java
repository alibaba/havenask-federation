...
public final class NonNegativeScoresSimilarity extends Similarity {
    ...
    // Escape hatch
    private static final String HAVENASK_ENFORCE_POSITIVE_SCORES = "havenask.enforce.positive.scores";
    private static final boolean ENFORCE_POSITIVE_SCORES;
    static {
        String enforcePositiveScores = System.getProperty(HAVENASK_ENFORCE_POSITIVE_SCORES);
        if (enforcePositiveScores == null) {
            ...
            throw new IllegalArgumentException(HAVENASK_ENFORCE_POSITIVE_SCORES + " may only be unset or set to [false], but got [" +
