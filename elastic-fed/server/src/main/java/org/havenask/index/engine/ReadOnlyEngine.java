...
public class ReadOnlyEngine extends Engine {
    ...
    private final HavenaskReaderManager readerManager;
    ...
    public ReadOnlyEngine(EngineConfig config, SeqNoStats seqNoStats, TranslogStats translogStats, boolean obtainLock,
        ...
        try {
            ...
            store.incRef();
            HavenaskDirectoryReader reader = null;
            ...
            try {
                ...
                readerManager = new HavenaskReaderManager(reader, refreshListener);
    ...
    protected final HavenaskDirectoryReader wrapReader(
        ...
        return HavenaskDirectoryReader.wrap(reader, engineConfig.getShardId());
    }
    ...
    @Override
    protected ReferenceManager<HavenaskDirectoryReader> getReferenceManager(SearcherScope scope) {
    ...
    protected void processReader(HavenaskDirectoryReader reader) {
