...
public class DeleteByQueryRequestBuilder extends
    ...
    public DeleteByQueryRequestBuilder(HavenaskClient client, ActionType<BulkByScrollResponse> action) {
        this(client, action, new SearchRequestBuilder(client, SearchAction.INSTANCE));
    }

    private DeleteByQueryRequestBuilder(HavenaskClient client,
