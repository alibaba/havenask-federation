...
public abstract class MappedFieldType {
     ...
     * when this error occurs in a request. see: {@link org.havenask.ExceptionsHelper#status}
     */
     ...
     *  @throws HavenaskParseException if {@code value} cannot be converted to the expected data type
