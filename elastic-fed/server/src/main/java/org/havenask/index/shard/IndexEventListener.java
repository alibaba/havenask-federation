 ...
 * via {@link org.havenask.index.IndexModule#addIndexEventListener(IndexEventListener)}. All listeners have the same
...
public interface IndexEventListener {
    ...
    /**
     * Called after a shard's {@link org.havenask.index.shard.IndexShardState} changes.
