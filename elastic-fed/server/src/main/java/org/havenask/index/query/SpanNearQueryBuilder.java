...
import static org.havenask.index.query.SpanQueryBuilder.SpanQueryBuilderUtil.checkNoBoost;
...
public class SpanNearQueryBuilder extends AbstractQueryBuilder<SpanNearQueryBuilder> implements SpanQueryBuilder {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
         ...
         * unordered SpanNearQuery. Should Havenask have the same checks or wrap those thrown exceptions?
         */
        if (isGap) {
