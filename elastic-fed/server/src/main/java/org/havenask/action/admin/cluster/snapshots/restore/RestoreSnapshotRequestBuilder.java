...
public class RestoreSnapshotRequestBuilder extends MasterNodeOperationRequestBuilder<RestoreSnapshotRequest,
     ...
     */
    public RestoreSnapshotRequestBuilder(HavenaskClient client, RestoreSnapshotAction action) {
     ...
     */
    public RestoreSnapshotRequestBuilder(HavenaskClient client, RestoreSnapshotAction action, String repository, String name) {
