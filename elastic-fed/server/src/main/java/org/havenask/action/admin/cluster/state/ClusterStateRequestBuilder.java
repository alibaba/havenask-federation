...
public class ClusterStateRequestBuilder extends MasterNodeReadOperationRequestBuilder<ClusterStateRequest,
    ...
    public ClusterStateRequestBuilder(HavenaskClient client, ClusterStateAction action) {
    ...
    /**
     * Should the cluster state result include the {@link org.havenask.cluster.metadata.Metadata}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.havenask.cluster.node.DiscoveryNodes}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.havenask.cluster.ClusterState.Custom}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * Should the cluster state result include the {@link org.havenask.cluster.routing.RoutingTable}. Defaults
     * to {@code true}.
     */
    ...
    /**
     * When {@link #setMetadata(boolean)} is set, which indices to return the {@link org.havenask.cluster.metadata.IndexMetadata}
