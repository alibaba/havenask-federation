...
package org.havenask.action.admin.indices.exists.indices;
...
public class IndicesExistsRequestBuilder
    ...
    public IndicesExistsRequestBuilder(HavenaskClient client, IndicesExistsAction action, String... indices) {
