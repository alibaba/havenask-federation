...
import org.havenask.action.admin.indices.alias.get.BaseAliasesRequestBuilder;
...
public class AliasesExistRequestBuilder extends BaseAliasesRequestBuilder<AliasesExistResponse, AliasesExistRequestBuilder> {
    ...
    public AliasesExistRequestBuilder(HavenaskClient client, AliasesExistAction action, String... aliases) {
