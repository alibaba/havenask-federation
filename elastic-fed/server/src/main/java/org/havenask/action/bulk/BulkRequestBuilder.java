...
public class BulkRequestBuilder extends ActionRequestBuilder<BulkRequest, BulkResponse>
    ...
    /**
     * @deprecated use {@link #BulkRequestBuilder(HavenaskClient, BulkAction, String)} instead
     */
    @Deprecated
    public BulkRequestBuilder(HavenaskClient client, BulkAction action, @Nullable String globalIndex, @Nullable String globalType) {
        super(client, action, new BulkRequest(globalIndex, globalType));
    }

    public BulkRequestBuilder(HavenaskClient client, BulkAction action, @Nullable String globalIndex) {
        super(client, action, new BulkRequest(globalIndex));
    }

    public BulkRequestBuilder(HavenaskClient client, BulkAction action) {
