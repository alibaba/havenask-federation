...
import org.havenask.action.support.WriteRequestBuilder;
import org.havenask.action.support.replication.ReplicationRequestBuilder;
...
public class IndexRequestBuilder extends ReplicationRequestBuilder<IndexRequest, IndexResponse, IndexRequestBuilder>
    ...
    public IndexRequestBuilder(HavenaskClient client, IndexAction action) {
        super(client, action, new IndexRequest());
    }

    public IndexRequestBuilder(HavenaskClient client, IndexAction action, @Nullable String index) {
     ...
     * <p>
     * Note, its preferable to either set it using {@link #setSource(org.havenask.common.xcontent.XContentBuilder)}
    ...
    /**
     * Set to {@code true} to force this index to use {@link org.havenask.action.index.IndexRequest.OpType#CREATE}.
     */
