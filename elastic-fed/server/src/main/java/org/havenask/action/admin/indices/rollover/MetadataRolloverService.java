...
import static org.havenask.cluster.metadata.IndexAbstraction.Type.ALIAS;
import static org.havenask.cluster.metadata.IndexAbstraction.Type.DATA_STREAM;
import static org.havenask.cluster.metadata.MetadataCreateDataStreamService.lookupTemplateForDataStream;
import static org.havenask.cluster.metadata.MetadataIndexTemplateService.findV1Templates;
...
public class MetadataRolloverService {
    ...
    private static final List<IndexAbstraction.Type> VALID_ROLLOVER_TARGETS = org.havenask.common.collect.List.of(ALIAS, DATA_STREAM);
