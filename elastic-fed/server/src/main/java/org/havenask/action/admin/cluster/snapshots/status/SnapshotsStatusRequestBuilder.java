...
public class SnapshotsStatusRequestBuilder extends MasterNodeOperationRequestBuilder<SnapshotsStatusRequest,
     ...
     */
    public SnapshotsStatusRequestBuilder(HavenaskClient client, SnapshotsStatusAction action) {
     ...
     */
    public SnapshotsStatusRequestBuilder(HavenaskClient client, SnapshotsStatusAction action, String repository) {
