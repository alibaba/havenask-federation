...
public class AnalyzeRequestBuilder
    ...
    public AnalyzeRequestBuilder(HavenaskClient client, AnalyzeAction action) {
        super(client, action, new AnalyzeAction.Request());
    }

    public AnalyzeRequestBuilder(HavenaskClient client, AnalyzeAction action, String index, String... text) {
