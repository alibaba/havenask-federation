...
interface SearchPhaseContext extends Executor {
    ...
    /**
     * Returns a connection to the node if connected otherwise and {@link org.havenask.transport.ConnectTransportException} will be
     * thrown.
     */
     ...
     * @see org.havenask.search.query.QuerySearchResult#getContextId()
     * @see org.havenask.search.fetch.FetchSearchResult#getContextId()
     *
     */
