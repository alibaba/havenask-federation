...
public class GetSnapshotsRequestBuilder extends MasterNodeOperationRequestBuilder<GetSnapshotsRequest,
     ...
     */
    public GetSnapshotsRequestBuilder(HavenaskClient client, GetSnapshotsAction action) {
     ...
     */
    public GetSnapshotsRequestBuilder(HavenaskClient client, GetSnapshotsAction action, String repository) {
