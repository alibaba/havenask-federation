...
public class GetRepositoriesRequestBuilder
     ...
     */
    public GetRepositoriesRequestBuilder(HavenaskClient client, GetRepositoriesAction action) {
     ...
     * Creates new get repository request builder
     */
    public GetRepositoriesRequestBuilder(HavenaskClient client, GetRepositoriesAction action, String... repositories) {
