...
package org.havenask.action.support.single.instance;
...
public abstract class InstanceShardOperationRequestBuilder<Request extends InstanceShardOperationRequest<Request>,
    ...
    protected InstanceShardOperationRequestBuilder(HavenaskClient client, ActionType<Response> action, Request request) {
