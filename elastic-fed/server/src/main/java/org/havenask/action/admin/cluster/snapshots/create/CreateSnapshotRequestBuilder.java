...
public class CreateSnapshotRequestBuilder extends MasterNodeOperationRequestBuilder<CreateSnapshotRequest,
     ...
     */
    public CreateSnapshotRequestBuilder(HavenaskClient client, CreateSnapshotAction action) {
     ...
     */
    public CreateSnapshotRequestBuilder(HavenaskClient client, CreateSnapshotAction action, String repository, String snapshot) {
