...
public class SearchRequestBuilder extends ActionRequestBuilder<SearchRequest, SearchResponse> {
    ...
    public SearchRequestBuilder(HavenaskClient client, SearchAction action) {
    ...
    /**
     * Should each {@link org.havenask.search.SearchHit} be returned with an
    ...
    /**
     * Should each {@link org.havenask.search.SearchHit} be returned with its
     * version.
     */
     ...
     *
     * @see org.havenask.search.sort.SortBuilders
     */
     ...
     * {@link #addRescorer(org.havenask.search.rescore.RescorerBuilder, int)}.
     *
    ...
    /**
     * If specified, Havenask will execute this search request using reader contexts from that point in time.
     */
