...
public class GetIndexTemplatesRequestBuilder extends MasterNodeReadOperationRequestBuilder<
    ...
    public GetIndexTemplatesRequestBuilder(HavenaskClient client, GetIndexTemplatesAction action) {
        super(client, action, new GetIndexTemplatesRequest());
    }

    public GetIndexTemplatesRequestBuilder(HavenaskClient client, GetIndexTemplatesAction action, String... names) {
