...
public class TypesExistsRequestBuilder
     ...
     */
    public TypesExistsRequestBuilder(HavenaskClient client, TypesExistsAction action, String... indices) {
        super(client, action, new TypesExistsRequest(indices, Strings.EMPTY_ARRAY));
    }

    TypesExistsRequestBuilder(HavenaskClient client, TypesExistsAction action) {
