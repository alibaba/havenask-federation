...
public class DeleteRequestBuilder extends ReplicationRequestBuilder<DeleteRequest, DeleteResponse, DeleteRequestBuilder>
    ...
    public DeleteRequestBuilder(HavenaskClient client, DeleteAction action) {
        super(client, action, new DeleteRequest());
    }

    public DeleteRequestBuilder(HavenaskClient client, DeleteAction action, @Nullable String index) {
