    ...
    public void connectToNode(DiscoveryNode node, ConnectionProfile connectionProfile,
        ...
        if (existingListener != null) {
            try {
                ...
                existingListener.addListener(listener, HavenaskExecutors.newDirectExecutorService());
            } finally {
                connectingRefCounter.decRef();
            }
            return;
        ...
        currentListener.addListener(listener, HavenaskExecutors.newDirectExecutorService());
