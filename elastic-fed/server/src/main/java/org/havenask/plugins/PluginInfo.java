...
public class PluginInfo implements Writeable, ToXContentObject {
    ...
    public static final String HAVENASK_PLUGIN_PROPERTIES = "plugin-descriptor.properties";
    public static final String HAVENASK_PLUGIN_POLICY = "plugin-security.policy";

    private final String name;
    private final String description;
    private final String version;
    private final Version havenaskVersion;
     ...
     * @param havenaskVersion     the version of Havenask the plugin was built for
     * @param javaVersion           the version of Java the plugin was built with
     * @param classname             the entry point to the plugin
     * @param extendedPlugins       other plugins this plugin extends through SPI
     * @param hasNativeController   whether or not the plugin has a native controller
     */
    public PluginInfo(String name, String description, String version, Version havenaskVersion, String javaVersion,
                      String classname, List<String> extendedPlugins, boolean hasNativeController) {
        this.name = name;
        this.description = description;
        this.version = version;
        this.havenaskVersion = havenaskVersion;
    ...
    public PluginInfo(final StreamInput in) throws IOException {
        ...
        if (in.getVersion().onOrAfter(LegacyESVersion.V_6_3_0)) {
            havenaskVersion = Version.readVersion(in);
    ...
    public void writeTo(final StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(LegacyESVersion.V_6_3_0)) {
            Version.writeVersion(havenaskVersion, out);
    ...
    public static PluginInfo readFromProperties(final Path path) throws IOException {
        final Path descriptor = path.resolve(HAVENASK_PLUGIN_PROPERTIES);
        ...
        final String esVersionString = propsMap.remove("havenask.version");
        if (esVersionString == null) {
            throw new IllegalArgumentException(
                    "property [havenask.version] is missing for plugin [" + name + "]");
        }
    ...
    /**
     * The version of Havenask the plugin was built for.
     *
     * @return an Havenask version
     */
    public Version getHavenaskVersion() {
        return havenaskVersion;
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        builder.startObject();
        {
            ...
            builder.field("havenask_version", havenaskVersion);
    ...
    public String toString(String prefix) {
        final StringBuilder information = new StringBuilder()
            ...
            .append(prefix).append("Havenask Version: ").append(havenaskVersion).append("\n")
