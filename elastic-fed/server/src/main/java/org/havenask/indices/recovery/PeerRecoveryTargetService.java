...
import org.havenask.indices.recovery.RecoveriesCollection.RecoveryRef;
            ...
            final Consumer<Exception> retryOnMappingException = exception -> {
                ...
                observer.waitForNextChange(new ClusterStateObserver.Listener() {
                    ...
                    public void onClusterServiceClose() {
                        listener.onFailure(new HavenaskException(
                    ...
                    public void onTimeout(TimeValue timeout) {
                        ...
                        listener.onFailure(new HavenaskTimeoutException("timed out waiting for mapping updates " +
                            "(timeout [" + timeout + "])"));
                    }
                });
            };
