...
package org.havenask.indices.breaker;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.message.ParameterizedMessage;
import org.havenask.common.Booleans;
import org.havenask.common.breaker.ChildMemoryCircuitBreaker;
...
import org.havenask.monitor.jvm.GcNames;
...
import static org.havenask.indices.breaker.BreakerSettings.CIRCUIT_BREAKER_LIMIT_SETTING;
import static org.havenask.indices.breaker.BreakerSettings.CIRCUIT_BREAKER_OVERHEAD_SETTING;
...
public class HierarchyCircuitBreakerService extends CircuitBreakerService {
    ...
    private static final String CHILD_LOGGER_PREFIX = "org.havenask.indices.breaker.";
    ...
    static OverLimitStrategy createOverLimitStrategy(boolean trackRealMemoryUsage) {
        ...
        if (trackRealMemoryUsage && jvmInfo.useG1GC().equals("true")
            ...
            && Booleans.parseBoolean(System.getProperty("havenask.real_memory_circuit_breaker.g1_over_limit_strategy.enabled"), true)) {
            TimeValue lockTimeout = TimeValue.timeValueMillis(
                Integer.parseInt(System.getProperty("havenask.real_memory_circuit_breaker.g1_over_limit_strategy.lock_timeout_ms", "500"))
            );
