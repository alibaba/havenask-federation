...
import org.havenask.search.profile.query.ProfileWeight;
import org.havenask.search.profile.query.QueryProfileBreakdown;
import org.havenask.search.profile.query.QueryProfiler;
import org.havenask.search.profile.query.QueryTimingType;
...
public class ContextIndexSearcher extends IndexSearcher implements Releasable {
    ...
    public void search(List<LeafReaderContext> leaves, Weight weight, CollectorManager manager,
        ...
        // We need to reset shard index; Havenask will set shard index later during reduce stage
