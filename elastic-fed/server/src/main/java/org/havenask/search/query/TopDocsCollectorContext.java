...
import org.havenask.action.search.MaxScoreCollector;
...
import org.havenask.common.lucene.search.function.ScriptScoreQuery;
import org.havenask.common.util.CachedSupplier;
...
import static org.havenask.search.profile.query.CollectorResult.REASON_SEARCH_COUNT;
import static org.havenask.search.profile.query.CollectorResult.REASON_SEARCH_TOP_HITS;
    ...
    private static class MaxScoreQueryVisitor extends QueryVisitor {
        ...
        void checkMaxScoreInfo(Query query) {
            if (query instanceof FunctionScoreQuery
                ...
                hasInfMaxScore = true;
            } else if (query instanceof HavenaskToParentBlockJoinQuery) {
                HavenaskToParentBlockJoinQuery q = (HavenaskToParentBlockJoinQuery) query;
