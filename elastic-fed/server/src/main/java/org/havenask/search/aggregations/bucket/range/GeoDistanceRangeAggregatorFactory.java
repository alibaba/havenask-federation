...
import org.havenask.search.aggregations.bucket.range.GeoDistanceAggregationBuilder.Range;
...
public class GeoDistanceRangeAggregatorFactory extends ValuesSourceAggregatorFactory {
    ...
    private static class DistanceSource extends ValuesSource.Numeric {
        ...
        private final org.havenask.common.geo.GeoPoint origin;

        DistanceSource(ValuesSource.GeoPoint source, GeoDistance distanceType,
                       org.havenask.common.geo.GeoPoint origin, DistanceUnit units) {
            this.source = source;
