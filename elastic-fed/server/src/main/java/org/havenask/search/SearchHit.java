...
import static org.havenask.common.lucene.Lucene.readExplanation;
import static org.havenask.common.lucene.Lucene.writeExplanation;
...
public final class SearchHit implements Writeable, ToXContentObject, Iterable<DocumentField> {
    ...
    public BytesReference getSourceRef() {
        ...
        try {
            ...
            throw new HavenaskParseException("failed to decompress source", e);
        }
    }
    ...
    public String getSourceAsString() {
        ...
        try {
            ...
            throw new HavenaskParseException("failed to convert source to a json string");
        }
    }
    ...
    * */
     ...
     * {@link org.havenask.search.suggest.completion.CompletionSuggestion.Entry.Option} which unfortunately inlines
     * the output of
     * {@link #toInnerXContent(XContentBuilder, org.havenask.common.xcontent.ToXContent.Params)}
