...
public class SourceLookup implements Map {
    ...
    public Map<String, Object> loadSourceIfNeeded() {
        ...
        try {
            ...
            throw new HavenaskParseException("failed to parse / load source", e);
        }
        return this.source;
    }
    ...
    public static Map<String, Object> sourceAsMap(BytesReference source) throws HavenaskParseException {
