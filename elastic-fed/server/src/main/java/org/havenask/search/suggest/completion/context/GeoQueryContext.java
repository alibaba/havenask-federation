...
import static org.havenask.common.geo.GeoUtils.parsePrecision;
import static org.havenask.search.suggest.completion.context.GeoContextMapping.CONTEXT_BOOST;
import static org.havenask.search.suggest.completion.context.GeoContextMapping.CONTEXT_NEIGHBOURS;
import static org.havenask.search.suggest.completion.context.GeoContextMapping.CONTEXT_PRECISION;
import static org.havenask.search.suggest.completion.context.GeoContextMapping.CONTEXT_VALUE;
...
public final class GeoQueryContext implements ToXContentObject {
    ...
    public static GeoQueryContext fromXContent(XContentParser parser) throws IOException {
        ...
        if (token == XContentParser.Token.START_OBJECT) {
            ...
            throw new HavenaskParseException("geo context must be an object or string");
        }
