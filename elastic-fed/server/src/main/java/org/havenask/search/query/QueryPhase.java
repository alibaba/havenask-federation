...
import org.havenask.common.util.concurrent.QueueResizingHavenaskThreadPoolExecutor;
...
import org.havenask.search.aggregations.AggregationPhase;
...
import org.havenask.search.profile.query.InternalProfileCollector;
import org.havenask.search.rescore.RescorePhase;
...
import static org.havenask.search.query.QueryCollectorContext.createMinScoreCollectorContext;
import static org.havenask.search.query.QueryCollectorContext.createMultiCollectorContext;
import static org.havenask.search.query.TopDocsCollectorContext.createTopDocsCollectorContext;
import static org.havenask.search.query.TopDocsCollectorContext.shortcutTotalHitCount;
...
public class QueryPhase {
    ...
    public static final boolean SYS_PROP_REWRITE_SORT = Booleans.parseBoolean(System.getProperty("havenask.search.rewrite_sort", "true"));
    ...
    static boolean executeInternal(SearchContext searchContext) throws QueryPhaseExecutionException {
        ...
        try {
            ...
            try {
                ...
                if (executor instanceof QueueResizingHavenaskThreadPoolExecutor) {
                    QueueResizingHavenaskThreadPoolExecutor rExecutor = (QueueResizingHavenaskThreadPoolExecutor) executor;
