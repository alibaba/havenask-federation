...
public final class ConfigurationUtils {
     ...
     *
     * If the property value isn't of type string a {@link HavenaskParseException} is thrown.
     */
     ...
     *
     * If the property value isn't of type string an {@link HavenaskParseException} is thrown.
     * If the property is missing an {@link HavenaskParseException} is thrown
     */
     ...
     *
     * If the property value isn't of type string a {@link HavenaskParseException} is thrown.
     * If the property is missing and no default value has been specified a {@link HavenaskParseException} is thrown
     */
    public static String readStringProperty(String processorType, String processorTag, Map<String, Object> configuration,
     ...
     * Returns and removes the specified property from the specified configuration map.
     *
     * If the property value isn't of type string or int a {@link HavenaskParseException} is thrown.
     * If the property is missing and no default value has been specified a {@link HavenaskParseException} is thrown
     */
     ...
     * Returns and removes the specified property from the specified configuration map.
     *
     * If the property value isn't of type int a {@link HavenaskParseException} is thrown.
     * If the property is missing an {@link HavenaskParseException} is thrown
     */
     ...
     *
     * If the property value isn't of type list an {@link HavenaskParseException} is thrown.
     */
     ...
     *
     * If the property value isn't of type map an {@link HavenaskParseException} is thrown.
     * If the property is missing an {@link HavenaskParseException} is thrown
     */
    ...
    public static HavenaskException newConfigurationException(String processorType, String processorTag,
        ...
        HavenaskParseException exception = new HavenaskParseException(msg);
    ...
    public static HavenaskException newConfigurationException(String processorType, String processorTag,
        ...
        HavenaskException exception = ExceptionsHelper.convertToHavenaskException(cause);
        addMetadataToException(exception, processorType, processorTag, propertyName);
        return exception;
    }
    ...
    private static void addMetadataToException(HavenaskException exception, String processorType,
                                               String processorTag, String propertyName) {
        if (processorType != null) {
            exception.addMetadata("havenask.processor_type", processorType);
        }
        if (processorTag != null) {
            exception.addMetadata("havenask.processor_tag", processorTag);
        }
        if (propertyName != null) {
            exception.addMetadata("havenask.property_name", propertyName);
        }
    }
        ...
        if (factory != null) {
            ...
            try {
                ...
                if (config.isEmpty() == false) {
                    throw new HavenaskParseException("processor [{}] doesn't support one or more provided configuration parameters {}",
