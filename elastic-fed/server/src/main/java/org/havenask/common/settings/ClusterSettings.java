...
import org.havenask.bootstrap.BootstrapSettings;
...
import org.havenask.cluster.coordination.ElectionSchedulerFactory;
...
import org.havenask.cluster.coordination.Reconfigurator;
...
import org.havenask.discovery.HandshakingTransportAddressConnector;
import org.havenask.discovery.PeerFinder;
import org.havenask.discovery.SeedHostsResolver;
...
import org.havenask.indices.analysis.HunspellService;
...
import org.havenask.monitor.jvm.JvmGcMonitorService;
import org.havenask.monitor.jvm.JvmService;
import org.havenask.monitor.os.OsService;
import org.havenask.monitor.process.ProcessService;
...
import org.havenask.persistent.decider.EnableAssignmentDecider;
...
import org.havenask.transport.ProxyConnectionStrategy;
...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
            ...
            HavenaskExecutors.PROCESSORS_SETTING,
            HavenaskExecutors.NODE_PROCESSORS_SETTING,
