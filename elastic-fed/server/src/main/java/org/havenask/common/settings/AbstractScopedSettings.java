...
public abstract class AbstractScopedSettings {
    ...
    */
     ...
     * <p>
     * Note: Only settings registered in {@link org.havenask.cluster.ClusterModule} can be changed dynamically.
     * </p>
     */
        ...
        if (setting == null) {
            ...
            if (validateInternalOrPrivateIndex) {
                if (setting.isInternalIndex()) {
                    ...
                    throw new IllegalArgumentException(
                            "can not update private setting [" + setting.getKey() + "]; this setting is managed by Havenask");
                }
            }
        }
