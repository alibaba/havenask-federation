 ...
 */
public final class HavenaskLeafReader extends SequentialStoredFieldsLeafReader {
     ...
     */
    public HavenaskLeafReader(LeafReader in, ShardId shardId) {
        super(in);
    ...
    public static HavenaskLeafReader getHavenaskLeafReader(LeafReader reader) {
        if (reader instanceof FilterLeafReader) {
            if (reader instanceof HavenaskLeafReader) {
                return (HavenaskLeafReader) reader;
            } else {
                ...
                return getHavenaskLeafReader(((FilterLeafReader) reader).getDelegate());
            }
        }
        return null;
    }
