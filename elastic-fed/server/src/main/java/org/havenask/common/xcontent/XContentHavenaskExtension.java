...
/**
 * SPI extensions for Havenask-specific classes (like the Lucene or Joda
 * dependency classes) that need to be encoded by {@link XContentBuilder} in a
 * specific way.
 */
public class XContentHavenaskExtension implements XContentBuilderExtension {
    ...
    public Map<Class<?>, XContentBuilder.Writer> getXContentWriters() {
        ...
        // Fully-qualified here to reduce ambiguity around our (Havenask') Version class
