...
import static org.havenask.env.NodeEnvironment.INDICES_FOLDER;

public class NodeRepurposeCommand extends HavenaskNodeCommand {

    static final String ABORTED_BY_USER_MSG = HavenaskNodeCommand.ABORTED_BY_USER_MSG;
    static final String FAILED_TO_OBTAIN_NODE_LOCK_MSG = HavenaskNodeCommand.FAILED_TO_OBTAIN_NODE_LOCK_MSG;
    ...
    private void removePath(Path path) {
        try {
            ...
            throw new HavenaskException("Unable to clean up path: " + path + ": " + e.getMessage());
        }
    }
