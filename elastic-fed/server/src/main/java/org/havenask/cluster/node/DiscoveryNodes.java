...
public class DiscoveryNodes extends AbstractDiffable<DiscoveryNodes> implements Iterable<DiscoveryNode> {
    ...
    /**
     * Determine if the given node exists and has the right version. During upgrade from Elasticsearch version as Havenask node run in
     * BWC mode and can have the version as 7.10.2 in cluster state from older master to Havenask master.
     */
