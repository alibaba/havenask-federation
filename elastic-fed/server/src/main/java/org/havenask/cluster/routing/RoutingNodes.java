...
public class RoutingNodes implements Iterable<RoutingNode> {
     ...
     *
     * Since replicas could possibly be on nodes with a older version of Havenask than
     * the primary is, this will return replicas on the highest version of Havenask.
     *
     */
