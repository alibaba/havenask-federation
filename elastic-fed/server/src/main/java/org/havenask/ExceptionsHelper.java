...
public final class ExceptionsHelper {
    ...
    public static RuntimeException convertToRuntime(Exception e) {
        ...
        return new HavenaskException(e);
    }

    public static HavenaskException convertToHavenaskException(Exception e) {
        if (e instanceof HavenaskException) {
            return (HavenaskException) e;
        }
        return new HavenaskException(e);
    }
    ...
    public static RestStatus status(Throwable t) {
        if (t != null) {
            if (t instanceof HavenaskException) {
                return ((HavenaskException) t).status();
            } else if (t instanceof IllegalArgumentException) {
                return RestStatus.BAD_REQUEST;
            } else if (t instanceof JsonParseException) {
                return RestStatus.BAD_REQUEST;
            } else if (t instanceof HavenaskRejectedExecutionException) {
    ...
    public static Throwable unwrapCause(Throwable t) {
        int counter = 0;
        Throwable result = t;
        while (result instanceof HavenaskWrapperException) {
    ...
    public static <T extends Throwable> void maybeThrowRuntimeAndSuppress(List<T> exceptions) {
        ...
        if (main != null) {
            throw new HavenaskException(main);
        }
    }
        ...
        GroupBy(ShardOperationFailedException failure) {
            ...
            if (indexName == null) {
                if (cause instanceof HavenaskException) {
                    final Index index = ((HavenaskException) cause).getIndex();
                    if (index != null) {
