...
/**
 * An {@link org.havenask.cli.EnvironmentAwareCommand} that needs to access the havenask keystore, possibly
...
public abstract class KeyStoreAwareCommand extends EnvironmentAwareCommand {
    ...
    protected static SecureString readPassword(Terminal terminal, boolean withVerification) throws UserException {
        ...
        if (withVerification) {
            passwordArray = terminal.readSecret("Enter new password for the havenask keystore (empty for no password): ",
            ...
            passwordArray = terminal.readSecret("Enter password for the havenask keystore : ");
        }
