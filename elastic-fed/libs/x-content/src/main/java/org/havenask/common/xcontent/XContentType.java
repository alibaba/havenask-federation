...
/**
 * The content type of {@link org.havenask.common.xcontent.XContent}.
 */
public enum XContentType {
     ...
     * in a form of application/vnd.havenask+json;compatible-with=7.
    ...
    private static String removeVersionInMediaType(String mediaType) {
        if (mediaType.contains("vnd.havenask")) {
            return mediaType.replaceAll("vnd.havenask\\+", "")
