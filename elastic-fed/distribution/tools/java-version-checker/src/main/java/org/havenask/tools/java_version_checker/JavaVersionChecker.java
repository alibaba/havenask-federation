...
package org.havenask.tools.java_version_checker;
...
final class JavaVersionChecker {
    ...
    public static void main(final String[] args) {
        ...
        if (JavaVersion.compare(JavaVersion.CURRENT, JavaVersion.JAVA_11) < 0) {
            final String message = String.format(
                Locale.ROOT,
                "future versions of Havenask will require Java 11; your Java version from [%s] does not meet this requirement",
                System.getProperty("java.home")
            );
            errPrintln(message);
        }
