...
package org.havenask.example.resthandler;
 ...
 * <p>
 * This class extends {@link HavenaskClientYamlSuiteTestCase}, which takes care of parsing the YAML files
 ...
 * <p>
 * Once validated, {@link HavenaskClientYamlSuiteTestCase} executes the REST tests against a single node
 * integration cluster which has the plugin already installed by the Gradle build script.
 * </p>
 */
public class ExampleRestHandlerClientYamlTestSuiteIT extends HavenaskClientYamlSuiteTestCase {
    ...
    public static Iterable<Object[]> parameters() throws Exception {
        ...
        // see HavenaskClientYamlSuiteTestCase.REST_TESTS_SUITE
        return HavenaskClientYamlSuiteTestCase.createParameters();
    }
}
