...
class S3Repository extends MeteredBlobStoreRepository {
     ...
     * {@link org.havenask.snapshots.SnapshotsService#SHARD_GEN_IN_REPO_DATA_VERSION} ({@link LegacyESVersion#V_7_6_0}).
    ...
    S3Repository(
        ...
        if (S3ClientSettings.checkDeprecatedCredentials(metadata.settings())) {
            ...
            deprecationLogger.deprecate("s3_repository_secret_settings",
                    ...
                    + "store these in named clients and the havenask keystore for secure settings.");
        }
    ...
    private static Map<String, String> buildLocation(RepositoryMetadata metadata) {
        return org.havenask.common.collect.Map.of("base_path", BASE_PATH_SETTING.get(metadata.settings()),
