...
import org.havenask.plugin.analysis.kuromoji.AnalysisKuromojiPlugin;
...
public class KuromojiAnalysisTests extends HavenaskTestCase {
    ...
    private static TestAnalysis createTestAnalysis() throws IOException {
        ...
        String json = "/org/havenask/index/analysis/kuromoji_analysis.json";
