...
import org.havenask.discovery.azure.classic.AzureSeedHostsProvider.Deployment;
...
public interface AzureComputeService {
    ...
    final class Discovery {
        ...
        public static final Setting<String> ENDPOINT_NAME_SETTING = new Setting<>("discovery.azure.endpoint.name", "havenask",
