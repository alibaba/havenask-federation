...
public class RetryHttpInitializerWrapperTests extends HavenaskTestCase {
    ...
    public void testSimpleRetry() throws Exception {
        ...
        // TODO (URL) replace w/ havenask url
        HttpRequest request = client.getRequestFactory().buildRequest(
            "Get", new GenericUrl("https://github.com/alibaba/havenask-federation"), null);
    ...
    public void testRetryWaitTooLong() throws Exception {
        ...
        HttpRequest request1 = client.getRequestFactory().buildRequest("Get", new GenericUrl(
            "https://github.com/alibaba/havenask-federation"), null);
        try {
            request1.execute();
