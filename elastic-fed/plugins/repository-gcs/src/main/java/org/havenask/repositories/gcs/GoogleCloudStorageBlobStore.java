...
class GoogleCloudStorageBlobStore implements BlobStore {
    ...
    static {
        final String key = "havenask.repository_gcs.large_blob_threshold_byte_size";
    ...
    private void writeBlobResumable(BlobInfo blobInfo, InputStream inputStream, long size, boolean failIfAlreadyExists)
        ...
        for (int retry = 0; retry < 3; ++retry) {
            try {
                 ...
                 */
                org.havenask.core.internal.io.Streams.copy(inputStream, Channels.newOutputStream(new WritableByteChannel() {
