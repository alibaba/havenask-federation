...
import static org.havenask.repositories.gcs.TestUtils.createServiceAccount;
...
public class GoogleCloudStorageBlobContainerRetriesTests extends AbstractBlobContainerRetriesTestCase {
    ...
    private HttpHandler safeHandler(HttpHandler handler) {
        final HttpHandler loggingHandler = HavenaskMockAPIBasedRepositoryIntegTestCase.wrap(handler, logger);
        return exchange -> {
            try {
