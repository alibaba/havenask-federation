...
package org.havenask.client.sniff.documentation;
...
import org.havenask.client.sniff.NodesSniffer;
import org.havenask.client.sniff.SniffOnFailureListener;
import org.havenask.client.sniff.Sniffer;
    ...
    public void usage() throws IOException {
        ...
        }
        {
            ...
            RestClient restClient = RestClient.builder(
                    new HttpHost("localhost", 9200, "http"))
                    .build();
            NodesSniffer nodesSniffer = new HavenaskNodesSniffer(
                    restClient,
                    HavenaskNodesSniffer.DEFAULT_SNIFF_REQUEST_TIMEOUT,
                    HavenaskNodesSniffer.Scheme.HTTPS);
            Sniffer sniffer = Sniffer.builder(restClient)
