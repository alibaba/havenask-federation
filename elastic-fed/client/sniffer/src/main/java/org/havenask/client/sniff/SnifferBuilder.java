...
public final class SnifferBuilder {
    ...
    /**
     * Creates a new builder instance by providing the {@link RestClient} that will be used to communicate with havenask
     */
    ...
    /**
     * Sets the {@link NodesSniffer} to be used to read hosts. A default instance of {@link HavenaskNodesSniffer}
     * is created when not provided. This method can be used to change the configuration of the {@link HavenaskNodesSniffer},
    ...
    public Sniffer build() {
        if (nodesSniffer == null) {
            this.nodesSniffer = new HavenaskNodesSniffer(restClient);
        }
