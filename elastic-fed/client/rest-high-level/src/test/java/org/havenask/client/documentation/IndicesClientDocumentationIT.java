...
import org.havenask.client.GetAliasesResponse;
import org.havenask.client.RequestOptions;
import org.havenask.client.RestHighLevelClient;
import org.havenask.client.SyncedFlushResponse;
...
import org.havenask.client.indices.DetailAnalyzeResponse;
 ...
 */
public class IndicesClientDocumentationIT extends HavenaskRestHighLevelClientTestCase {
    ...
    public void testGetAlias() throws Exception {
...

        {
            ...
            HavenaskException exception = response.getException(); // <2>
    ...
    public void testDeleteAlias() throws Exception {
        ...
        }
        {
            ...
            org.havenask.client.core.AcknowledgedResponse deleteAliasResponse =
...

        {
            ...
            ActionListener<org.havenask.client.core.AcknowledgedResponse> listener =
                new ActionListener<org.havenask.client.core.AcknowledgedResponse>() {
                    @Override
                    public void onResponse(org.havenask.client.core.AcknowledgedResponse deleteAliasResponse) {
                        // <1>
                    }
