...
public class RemoteInfoResponseTests extends AbstractResponseTestCase<org.havenask.action.admin.cluster.remote.RemoteInfoResponse,
        RemoteInfoResponse> {

    @Override
    protected org.havenask.action.admin.cluster.remote.RemoteInfoResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new org.havenask.action.admin.cluster.remote.RemoteInfoResponse(remoteInfos);
    }
    ...
    @Override
    protected void assertInstances(org.havenask.action.admin.cluster.remote.RemoteInfoResponse serverTestInstance,
        ...
        for (org.havenask.client.cluster.RemoteConnectionInfo clientRemoteInfo : clientInstance.getInfos()) {
