 ...
 */
public class TasksClientDocumentationIT extends HavenaskRestHighLevelClientTestCase {
    ...
    public void testListTasks() throws IOException {
        ...
        List<HavenaskException> nodeFailures = response.getNodeFailures(); // <1>
    ...
    public void testCancelTasks() throws IOException {
        RestHighLevelClient client = highLevelClient();
        {
            ...
            CancelTasksRequest request = new org.havenask.client.tasks.CancelTasksRequest.Builder()
            ...
            CancelTasksRequest byTaskIdRequest = new org.havenask.client.tasks.CancelTasksRequest.Builder() // <1>
                .withTaskId(new org.havenask.client.tasks.TaskId("myNode",44L)) // <2>
        ...
        CancelTasksRequest request = new org.havenask.client.tasks.CancelTasksRequest.Builder().build();
        ...
        List<org.havenask.client.tasks.TaskInfo> tasks = response.getTasks(); // <1>
        // end::cancel-tasks-response-tasks

        // tag::cancel-tasks-response-calc
        Map<String, List<org.havenask.client.tasks.TaskInfo>> perNodeTasks = response.getPerNodeTasks(); // <1>
        List<org.havenask.client.tasks.TaskGroup> groups = response.getTaskGroups(); // <2>
        // end::cancel-tasks-response-calc


        // tag::cancel-tasks-response-failures
        List<org.havenask.client.tasks.HavenaskException> nodeFailures = response.getNodeFailures(); // <1>
        List<org.havenask.client.tasks.TaskOperationFailure> taskFailures = response.getTaskFailures(); // <2>
