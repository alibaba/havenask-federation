...
public class StoredScriptsIT extends HavenaskRestHighLevelClientTestCase {
    ...
    public void testDeleteStoredScript() throws Exception {
        ...
        final HavenaskStatusException statusException = expectThrows(HavenaskStatusException.class,
