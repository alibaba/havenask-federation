...
public class BroadcastResponseTests extends AbstractResponseTestCase<org.havenask.action.support.broadcast.BroadcastResponse,
        BroadcastResponse> {
    ...
    @Override
    protected org.havenask.action.support.broadcast.BroadcastResponse createServerTestInstance(XContentType xContentType) {
        ...
        return new org.havenask.action.support.broadcast.BroadcastResponse(total, successful, failed, failures);
    }
    ...
    @Override
    protected void assertInstances(org.havenask.action.support.broadcast.BroadcastResponse serverTestInstance,
