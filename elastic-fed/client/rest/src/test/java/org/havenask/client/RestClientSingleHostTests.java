...
import static org.havenask.client.RestClientTestUtil.getAllErrorStatusCodes;
import static org.havenask.client.RestClientTestUtil.getHttpMethods;
import static org.havenask.client.RestClientTestUtil.getOkStatusCodes;
import static org.havenask.client.RestClientTestUtil.randomStatusCode;
...
public class RestClientSingleHostTests extends RestClientTestCase {
    ...
    /**
     * Emulates Havenask's HeaderWarningLogger.formatWarning in simple
    ...
    private static String formatWarningWithoutDate(String warningBody) {
        ...
        return "299 Havenask-1.2.2-SNAPSHOT-" + hash + " \"" + warningBody + "\"";
    }
