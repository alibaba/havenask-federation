...
import static org.havenask.client.ResponseException.buildMessage;
...
// if the exception is not of type HavenaskException or RuntimeException it will be wrapped in a UncategorizedExecutionException
