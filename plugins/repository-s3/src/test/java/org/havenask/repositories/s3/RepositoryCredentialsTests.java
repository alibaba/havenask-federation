...
import static org.havenask.repositories.s3.S3ClientSettings.ACCESS_KEY_SETTING;
import static org.havenask.repositories.s3.S3ClientSettings.SECRET_KEY_SETTING;
...
public class RepositoryCredentialsTests extends HavenaskSingleNodeTestCase {

    static {
        AccessController.doPrivileged((PrivilegedAction<Void>) () -> {
            // required for client settings overwriting when running in IDE
            System.setProperty("havenask.allow_insecure_settings", "true");
            return null;
        });
    }
    ...
    public void testRepositoryCredentialsOverrideSecureCredentials() {
        ...
        assertWarnings(
            "[secret_key] setting was deprecated in Havenask and will be removed in a future release!"
                + " See the breaking changes documentation for the next major version.",
            "Using s3 access/secret key from repository settings. Instead store these in named clients and"
                + " the havenask keystore for secure settings.",
            "[access_key] setting was deprecated in Havenask and will be removed in a future release!"
                + " See the breaking changes documentation for the next major version.");
    }
