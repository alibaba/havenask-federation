...
package org.havenask.cloud.azure.classic;
...
import org.havenask.cloud.azure.classic.management.AzureComputeService.Discovery;
import org.havenask.cloud.azure.classic.management.AzureComputeService.Management;
...
import org.havenask.plugin.discovery.azure.classic.AzureDiscoveryPlugin;
...
import static org.havenask.common.util.CollectionUtils.newSingletonArrayList;
import static org.havenask.discovery.DiscoveryModule.DISCOVERY_SEED_PROVIDERS_SETTING;

public abstract class AbstractAzureComputeServiceTestCase extends HavenaskIntegTestCase {
