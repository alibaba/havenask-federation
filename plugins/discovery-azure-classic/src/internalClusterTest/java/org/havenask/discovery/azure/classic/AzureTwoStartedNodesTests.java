...
import org.havenask.cloud.azure.classic.AbstractAzureComputeServiceTestCase;
...
public class AzureTwoStartedNodesTests extends AbstractAzureComputeServiceTestCase {
    ...
    public void testTwoNodesShouldRunUsingPrivateOrPublicIp() {
        final String hostType =
            randomFrom(org.havenask.discovery.azure.classic.AzureSeedHostsProvider.HostType.values()).getType();
