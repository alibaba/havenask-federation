...
package org.havenask.cloud.azure.classic.management;
...
import org.havenask.cloud.azure.classic.AzureServiceRemoteException;
...
public class AzureComputeServiceImpl extends AbstractLifecycleComponent
    ...
    public AzureComputeServiceImpl(Settings settings) {
        ...
        try {
            ...
            throw new HavenaskException("Unable to configure Azure compute service", e);
        }
    }
    ...
    @Override
    protected void doStart() throws HavenaskException {
    }

    @Override
    protected void doStop() throws HavenaskException {
    }

    @Override
    protected void doClose() throws HavenaskException {
        if (client != null) {
            try {
                client.close();
            } catch (IOException e) {
