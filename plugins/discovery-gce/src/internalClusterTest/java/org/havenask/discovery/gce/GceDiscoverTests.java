...
import org.havenask.plugin.discovery.gce.GceDiscoveryPlugin;
...
@HavenaskIntegTestCase.ClusterScope(supportsDedicatedMasters = false, numDataNodes = 0, numClientNodes = 0)
public class GceDiscoverTests extends HavenaskIntegTestCase {
