...
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.APPLICATION_NAME_SETTING;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.CONNECT_TIMEOUT_SETTING;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.CREDENTIALS_FILE_SETTING;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.ENDPOINT_SETTING;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.PROJECT_ID_SETTING;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.READ_TIMEOUT_SETTING;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.getClientSettings;
import static org.havenask.repositories.gcs.GoogleCloudStorageClientSettings.loadCredential;

public class GoogleCloudStorageClientSettingsTests extends HavenaskTestCase {
    ...
    private static GoogleCloudStorageClientSettings randomClient(final String clientName,
        ...
        String endpoint;
        if (randomBoolean()) {
            endpoint = randomFrom("http://www.havenask.org", "http://metadata.google.com:88/oauth", "https://www.googleapis.com",
                    "https://www.havenask.org:443", "http://localhost:8443", "https://www.googleapis.com/oauth/token");
