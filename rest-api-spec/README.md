# Havenask REST API JSON specification

This repository contains a collection of JSON files which describe the [Havenask](https://github.com/alibaba/havenask-federation) HTTP API.
...
The specification follows the same backward compatibility guarantees as Havenask.
