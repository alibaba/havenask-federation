...
public class TimeValueTests extends HavenaskTestCase {
    ...
    public void testFailOnUnknownUnits() {
        try {
            ...
            fail("Expected HavenaskParseException");
    ...
    public void testCompareValue() {
        ...
        long secondRandom = randomValueOtherThan(firstRandom, HavenaskTestCase::randomNonNegativeLong);
