...
package org.havenask.grok;

import org.havenask.grok.GrokCaptureConfig.NativeExtracterMap;
...
import static org.havenask.grok.GrokCaptureType.BOOLEAN;
import static org.havenask.grok.GrokCaptureType.DOUBLE;
import static org.havenask.grok.GrokCaptureType.FLOAT;
import static org.havenask.grok.GrokCaptureType.INTEGER;
import static org.havenask.grok.GrokCaptureType.LONG;
import static org.havenask.grok.GrokCaptureType.STRING;
...
public class GrokTests extends HavenaskTestCase {
    public void testMatchWithoutCaptures() {
        Grok grok = new Grok(Grok.BUILTIN_PATTERNS, "value", logger::warn);
        assertThat(grok.captures("value"), equalTo(org.havenask.common.collect.Map.of()));
        assertThat(grok.captures("prefix_value"), equalTo(org.havenask.common.collect.Map.of()));
    ...
    public void testCaputuresBytes() {
        ...
        assertThat(captureBytes(grok, utf8, 0, utf8.length), equalTo(org.havenask.common.collect.Map.of("n", 10)));
        assertThat(captureBytes(grok, utf8, 0, 1), equalTo(org.havenask.common.collect.Map.of("n", 1)));
        utf8 = "10 11 12".getBytes(StandardCharsets.UTF_8);
        assertThat(captureBytes(grok, utf8, 0, 2), equalTo(org.havenask.common.collect.Map.of("n", 10)));
        assertThat(captureBytes(grok, utf8, 3, 2), equalTo(org.havenask.common.collect.Map.of("n", 11)));
        assertThat(captureBytes(grok, utf8, 6, 2), equalTo(org.havenask.common.collect.Map.of("n", 12)));
    }
    ...
    public void testSimpleSyslogLine() {
        ...
        assertCaptureConfig(
            ...
            org.havenask.common.collect.Map.ofEntries(
                org.havenask.common.collect.Map.entry("facility", STRING),
                org.havenask.common.collect.Map.entry("logsource", STRING),
                org.havenask.common.collect.Map.entry("message", STRING),
                org.havenask.common.collect.Map.entry("pid", STRING),
                org.havenask.common.collect.Map.entry("priority", STRING),
                org.havenask.common.collect.Map.entry("program", STRING),
                org.havenask.common.collect.Map.entry("timestamp", STRING),
                org.havenask.common.collect.Map.entry("timestamp8601", STRING)
            )
        );
    ...
    public void testSyslog5424Line() {
        ...
        assertCaptureConfig(
            grok,
            org.havenask.common.collect.Map.ofEntries(
                org.havenask.common.collect.Map.entry("syslog5424_app", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_host", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_msg", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_msgid", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_pri", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_proc", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_sd", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_ts", STRING),
                org.havenask.common.collect.Map.entry("syslog5424_ver", STRING)
            )
        );
        Map<String, Object> matches = grok.captures(line);
    ...
    public void testDatePattern() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of("timestamp", STRING));
        Map<String, Object> matches = grok.captures(line);
    ...
    public void testNilCoercedValues() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of("duration", FLOAT));
    ...
    public void testNilWithNoCoercion() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of("duration", STRING));
        Map<String, Object> matches = grok.captures("test 28.4ms");
    ...
    public void testUnicodeSyslog() {
        ...
        assertCaptureConfig(
            grok,
            org.havenask.common.collect.Map.ofEntries(
                org.havenask.common.collect.Map.entry("syslog_hostname", STRING),
                org.havenask.common.collect.Map.entry("syslog_message", STRING),
                org.havenask.common.collect.Map.entry("syslog_pid", STRING),
                org.havenask.common.collect.Map.entry("syslog_pri", STRING),
                org.havenask.common.collect.Map.entry("syslog_program", STRING),
                org.havenask.common.collect.Map.entry("syslog_timestamp", STRING)
            )
        );
    ...
    public void testNamedFieldsWithWholeTextMatch() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of("stimestamp", STRING));
    ...
    public void testWithOniguramaNamedCaptures() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of("foo", STRING));
    ...
    public void testISO8601() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of());
    ...
    public void testNoNamedCaptures() {
        ...
        assertCaptureConfig(g, org.havenask.common.collect.Map.of("EXCITED_NAME_0", STRING, "NAME_21", STRING, "NAME_22", STRING));
    ...
    public void testBooleanCaptures() {
        ...
        assertCaptureConfig(g, org.havenask.common.collect.Map.of("name", STRING, "status", BOOLEAN));
    ...
    public void testNumericCaptures() {
        ...
        assertCaptureConfig(g, org.havenask.common.collect.Map.of("bytes", FLOAT, "id", LONG, "rating", DOUBLE));
    ...
    public void testNumericCapturesCoercion() {
        ...
        Grok g = new Grok(bank, pattern, logger::warn);
        assertCaptureConfig(g, org.havenask.common.collect.Map.of("bytes", FLOAT, "status", STRING));
    ...
    public void testGarbageTypeNameBecomesString() {
        ...
        Grok g = new Grok(bank, pattern, logger::warn);
        assertCaptureConfig(g, org.havenask.common.collect.Map.of("f", STRING));
        assertThat(g.captures("12009.34"), equalTo(org.havenask.common.collect.Map.of("f", "12009.34")));
    }
    ...
    public void testApacheLog() {
        ...
        assertCaptureConfig(
            grok,
            org.havenask.common.collect.Map.ofEntries(
                org.havenask.common.collect.Map.entry("agent", STRING),
                org.havenask.common.collect.Map.entry("auth", STRING),
                org.havenask.common.collect.Map.entry("bytes", STRING),
                org.havenask.common.collect.Map.entry("clientip", STRING),
                org.havenask.common.collect.Map.entry("httpversion", STRING),
                org.havenask.common.collect.Map.entry("ident", STRING),
                org.havenask.common.collect.Map.entry("rawrequest", STRING),
                org.havenask.common.collect.Map.entry("referrer", STRING),
                org.havenask.common.collect.Map.entry("request", STRING),
                org.havenask.common.collect.Map.entry("response", STRING),
                org.havenask.common.collect.Map.entry("timestamp", STRING),
                org.havenask.common.collect.Map.entry("verb", STRING)
            )
        );
    ...
    public void testComplete() {
        ...
        assertCaptureConfig(
            ...
            org.havenask.common.collect.Map.ofEntries(
                org.havenask.common.collect.Map.entry("agent", STRING),
                org.havenask.common.collect.Map.entry("auth", STRING),
                org.havenask.common.collect.Map.entry("bytes", INTEGER),
                org.havenask.common.collect.Map.entry("clientip", STRING),
                org.havenask.common.collect.Map.entry("httpversion", STRING),
                org.havenask.common.collect.Map.entry("ident", STRING),
                org.havenask.common.collect.Map.entry("referrer", STRING),
                org.havenask.common.collect.Map.entry("request", STRING),
                org.havenask.common.collect.Map.entry("response", INTEGER),
                org.havenask.common.collect.Map.entry("timestamp", STRING),
                org.havenask.common.collect.Map.entry("verb", STRING)
            )
        );
    ...
    public void testMultipleNamedCapturesWithSameName() {
        ...
        assertCaptureConfig(grok, org.havenask.common.collect.Map.of("num", STRING));
