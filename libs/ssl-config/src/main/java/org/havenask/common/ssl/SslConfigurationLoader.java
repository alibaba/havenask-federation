...
package org.havenask.common.ssl;
...
import static org.havenask.common.ssl.KeyStoreUtil.inferKeyStoreType;
import static org.havenask.common.ssl.SslConfiguration.ORDERED_PROTOCOL_ALGORITHM_MAP;
import static org.havenask.common.ssl.SslConfigurationKeys.CERTIFICATE;
import static org.havenask.common.ssl.SslConfigurationKeys.CERTIFICATE_AUTHORITIES;
import static org.havenask.common.ssl.SslConfigurationKeys.CIPHERS;
import static org.havenask.common.ssl.SslConfigurationKeys.CLIENT_AUTH;
import static org.havenask.common.ssl.SslConfigurationKeys.KEY;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_ALGORITHM;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_LEGACY_KEY_PASSWORD;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_LEGACY_PASSWORD;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_PATH;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_SECURE_KEY_PASSWORD;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_SECURE_PASSWORD;
import static org.havenask.common.ssl.SslConfigurationKeys.KEYSTORE_TYPE;
import static org.havenask.common.ssl.SslConfigurationKeys.KEY_LEGACY_PASSPHRASE;
import static org.havenask.common.ssl.SslConfigurationKeys.KEY_SECURE_PASSPHRASE;
import static org.havenask.common.ssl.SslConfigurationKeys.PROTOCOLS;
import static org.havenask.common.ssl.SslConfigurationKeys.TRUSTSTORE_ALGORITHM;
import static org.havenask.common.ssl.SslConfigurationKeys.TRUSTSTORE_LEGACY_PASSWORD;
import static org.havenask.common.ssl.SslConfigurationKeys.TRUSTSTORE_PATH;
import static org.havenask.common.ssl.SslConfigurationKeys.TRUSTSTORE_SECURE_PASSWORD;
import static org.havenask.common.ssl.SslConfigurationKeys.TRUSTSTORE_TYPE;
import static org.havenask.common.ssl.SslConfigurationKeys.VERIFICATION_MODE;
...
public abstract class SslConfigurationLoader {
     ...
     *
     * @param basePath The base path to use for any settings that represent file paths. Typically points to the Havenask
