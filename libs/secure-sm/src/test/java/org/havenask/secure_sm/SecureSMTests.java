...
package org.havenask.secure_sm;
...
public class SecureSMTests extends TestCase {
    ...
    public void testClassCanExit() {
        ...
        assertTrue(SecureSM.classCanExit("org.havenask.Foo", new String[]{"org.havenask.Foo"}));
        assertFalse(SecureSM.classCanExit("org.havenask.Foo", new String[]{"org.havenask.Bar"}));
    }
