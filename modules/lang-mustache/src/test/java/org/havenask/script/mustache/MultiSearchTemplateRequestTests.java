...
public class MultiSearchTemplateRequestTests extends HavenaskTestCase {

    public void testParseRequest() throws Exception {
        byte[] data = StreamsUtils.copyToBytesFromClasspath("/org/havenask/script/mustache/simple-msearch-template.json");
