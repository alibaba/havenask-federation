...
import org.havenask.painless.spi.annotation.DeprecatedAnnotation;
import org.havenask.painless.spi.annotation.NoImportAnnotation;
import org.havenask.painless.spi.annotation.WhitelistAnnotationParser;
...
public class WhitelistLoaderTests extends ScriptTestCase {
    public void testUnknownAnnotations() {
        ...
        RuntimeException expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.havenask.painless.annotation.unknown");
        });
        assertEquals(
        ...
        expected = expectThrows(RuntimeException.class, () -> {
            WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.havenask.painless.annotation.unknown_with_options");
        });
        assertEquals(
    ...
    public void testAnnotations() {
        ...
        Whitelist whitelist = WhitelistLoader.loadFromResourceFiles(Whitelist.class, parsers, "org.havenask.painless.annotation");
