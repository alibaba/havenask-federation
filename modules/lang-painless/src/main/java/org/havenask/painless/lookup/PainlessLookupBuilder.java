...
package org.havenask.painless.lookup;

import org.havenask.bootstrap.BootstrapInfo;
import org.havenask.painless.Def;
...
import org.havenask.painless.spi.WhitelistClass;
import org.havenask.painless.spi.WhitelistClassBinding;
import org.havenask.painless.spi.WhitelistConstructor;
import org.havenask.painless.spi.WhitelistField;
import org.havenask.painless.spi.WhitelistInstanceBinding;
import org.havenask.painless.spi.WhitelistMethod;
import org.havenask.painless.spi.annotation.InjectConstantAnnotation;
import org.havenask.painless.spi.annotation.NoImportAnnotation;
...
import static org.havenask.painless.lookup.PainlessLookupUtility.DEF_CLASS_NAME;
import static org.havenask.painless.lookup.PainlessLookupUtility.buildPainlessConstructorKey;
import static org.havenask.painless.lookup.PainlessLookupUtility.buildPainlessFieldKey;
import static org.havenask.painless.lookup.PainlessLookupUtility.buildPainlessMethodKey;
import static org.havenask.painless.lookup.PainlessLookupUtility.typeToCanonicalTypeName;
import static org.havenask.painless.lookup.PainlessLookupUtility.typeToJavaType;
import static org.havenask.painless.lookup.PainlessLookupUtility.typesToCanonicalTypeNames;
    ...
    private void generateBridgeMethod(PainlessClassBuilder painlessClassBuilder, PainlessMethod painlessMethod) {
        ...
        if (bridgePainlessMethod == null) {
            ...
            String bridgeClassName =
                    "org/havenask/painless/Bridge$" + javaMethod.getDeclaringClass().getSimpleName() + "$" + javaMethod.getName();
