...
import org.havenask.painless.FunctionRef;
...
import org.havenask.painless.spi.annotation.NonDeterministicAnnotation;
import org.havenask.painless.symbol.Decorations;
import org.havenask.painless.symbol.Decorations.AllEscape;
import org.havenask.painless.symbol.Decorations.AnyBreak;
import org.havenask.painless.symbol.Decorations.AnyContinue;
import org.havenask.painless.symbol.Decorations.BeginLoop;
...
import org.havenask.painless.symbol.Decorations.DefOptimized;
...
import org.havenask.painless.symbol.Decorations.InLoop;
...
import org.havenask.painless.symbol.Decorations.LastLoop;
...
import org.havenask.painless.symbol.Decorations.PartialCanonicalTypeName;
...
import org.havenask.painless.symbol.SemanticScope.LambdaScope;
    ...
    public void visitRegex(ERegex userRegexNode, SemanticScope semanticScope) {
        ...
        if (semanticScope.getScriptScope().getCompilerSettings().areRegexesEnabled() == CompilerSettings.RegexEnabled.FALSE) {
            throw userRegexNode.createError(new IllegalStateException("Regexes are disabled. Set [script.painless.regex.enabled] to [true] "
                    + "in havenask.yaml to allow them. Be careful though, regexes break out of Painless's protection against deep "
