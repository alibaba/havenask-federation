...
public class DiscountedCumulativeGainTests extends HavenaskTestCase {
    ...
    public void testSerialization() throws IOException {
        ...
        DiscountedCumulativeGain deserialized =
            HavenaskTestCase.copyWriteable(original, new NamedWriteableRegistry(Collections.emptyList()),
