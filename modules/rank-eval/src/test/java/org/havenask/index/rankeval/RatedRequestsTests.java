...
public class RatedRequestsTests extends HavenaskTestCase {
    ...
    private static RatedRequest copy(RatedRequest original) throws IOException {
        ...
        return HavenaskTestCase.copyWriteable(original, new NamedWriteableRegistry(namedWriteables), RatedRequest::new);
    }
