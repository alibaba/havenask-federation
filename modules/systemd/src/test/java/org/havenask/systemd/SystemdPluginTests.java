...
public class SystemdPluginTests extends HavenaskTestCase {
    ...
    public void testInvalid() {
        ...
        assertThat(e, hasToString(containsString("HAVENASK_SD_NOTIFY set to unexpected value [" + esSDNotify + "]")));
    }
