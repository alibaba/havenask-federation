...
import org.havenask.percolator.QueryAnalyzer.QueryExtraction;
import org.havenask.percolator.QueryAnalyzer.Result;
...
import static org.havenask.percolator.QueryAnalyzer.analyze;
import static org.havenask.percolator.QueryAnalyzer.selectBestResult;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.is;
import static org.hamcrest.Matchers.sameInstance;
import static org.hamcrest.collection.IsCollectionWithSize.hasSize;

public class QueryAnalyzerTests extends HavenaskTestCase {
    ...
    public void testToParentBlockJoinQuery() {
        ...
        HavenaskToParentBlockJoinQuery query =
            new HavenaskToParentBlockJoinQuery(termQuery, queryBitSetProducer, ScoreMode.None, "child");
        Result result = analyze(query, Version.CURRENT);
        assertFalse(result.verified);
        assertThat(result.minimumShouldMatch, equalTo(1));
