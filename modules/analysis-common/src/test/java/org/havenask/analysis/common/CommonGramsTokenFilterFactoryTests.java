...
public class CommonGramsTokenFilterFactoryTests extends HavenaskTokenStreamTestCase {
    ...
    public void testCommonGramsAnalysis() throws IOException {
        String json = "/org/havenask/analysis/common/commongrams.json";
        Settings settings = Settings.builder()
    ...
    public void testQueryModeCommonGramsAnalysis() throws IOException {
        String json = "/org/havenask/analysis/common/commongrams_query_mode.json";
        Settings settings = Settings.builder()
                .loadFromStream(json, getClass().getResourceAsStream(json), false)
            .put(Environment.PATH_HOME_SETTING.getKey(), createHome())
                .build();
