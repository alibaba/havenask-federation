...
public class HavenaskWordnetSynonymParserTests extends HavenaskTokenStreamTestCase {

    public void testLenientParser() throws IOException, ParseException {
        HavenaskWordnetSynonymParser parser = new HavenaskWordnetSynonymParser(true, false, true, new StandardAnalyzer());
        String rules =
            "s(100000001,1,'&',a,1,0).\n" +
    ...
    public void testLenientParserWithSomeIncorrectLines() throws IOException, ParseException {
        ...
        stopSet.add("bar");
        HavenaskWordnetSynonymParser parser =
            new HavenaskWordnetSynonymParser(true, false, true, new StandardAnalyzer(stopSet));
        String rules =
    ...
    public void testNonLenientParser() {
        HavenaskWordnetSynonymParser parser = new HavenaskWordnetSynonymParser(true, false, false, new StandardAnalyzer());
        String rules =
            "s(100000001,1,'&',a,1,0).\n" +
            "s(100000001,2,'and',a,1,0).\n" +
            "s(100000002,1,'come',v,1,0).\n" +
