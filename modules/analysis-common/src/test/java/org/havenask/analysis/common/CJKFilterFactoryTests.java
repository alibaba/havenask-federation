...
public class CJKFilterFactoryTests extends HavenaskTokenStreamTestCase {
    private static final String RESOURCE = "/org/havenask/analysis/common/cjk_analysis.json";

    private HavenaskTestCase.TestAnalysis analysis;
