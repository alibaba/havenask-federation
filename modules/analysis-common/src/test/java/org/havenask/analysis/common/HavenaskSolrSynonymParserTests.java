...
public class HavenaskSolrSynonymParserTests extends HavenaskTokenStreamTestCase {

    public void testLenientParser() throws IOException, ParseException {
        HavenaskSolrSynonymParser parser = new HavenaskSolrSynonymParser(true, false, true, new StandardAnalyzer());
        String rules =
            "&,and\n" +
    ...
    public void testLenientParserWithSomeIncorrectLines() throws IOException, ParseException {
        ...
        stopSet.add("bar");
        HavenaskSolrSynonymParser parser =
            new HavenaskSolrSynonymParser(true, false, true, new StandardAnalyzer(stopSet));
    ...
    public void testNonLenientParser() {
        HavenaskSolrSynonymParser parser = new HavenaskSolrSynonymParser(true, false, false, new StandardAnalyzer());
        String rules =
            "&,and=>and\n" +
            "come,advance,approach\n";
        StringReader rulesReader = new StringReader(rules);
