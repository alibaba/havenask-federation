...
public class HavenaskSolrSynonymParser extends SolrSynonymParser {
    private static final Logger logger = LogManager.getLogger(HavenaskSolrSynonymParser.class);

    private final boolean lenient;

    public HavenaskSolrSynonymParser(boolean dedup, boolean expand, boolean lenient, Analyzer analyzer) {
