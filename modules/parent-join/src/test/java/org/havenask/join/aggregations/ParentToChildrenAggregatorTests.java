...
import org.havenask.join.mapper.MetaJoinFieldMapper;
...
public class ParentToChildrenAggregatorTests extends AggregatorTestCase {
    ...
    public void testParentChild() throws IOException {
        ...
        IndexReader indexReader = HavenaskDirectoryReader.wrap(DirectoryReader.open(directory),
    ...
    public void testParentChildAsSubAgg() throws IOException {
        try (Directory directory = newDirectory()) {
            ...
            try (
                IndexReader indexReader = HavenaskDirectoryReader.wrap(
