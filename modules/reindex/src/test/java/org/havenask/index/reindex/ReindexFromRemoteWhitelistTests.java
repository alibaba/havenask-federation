...
import static org.havenask.index.reindex.ReindexValidator.buildRemoteWhitelist;
import static org.havenask.index.reindex.ReindexValidator.checkRemoteWhitelist;

/**
 * Tests the reindex-from-remote whitelist of remotes.
 */
public class ReindexFromRemoteWhitelistTests extends HavenaskTestCase {
    ...
    private void assertMatchesTooMuch(List<String> whitelist) {
        ...
        assertEquals("Refusing to start because whitelist " + whitelist + " accepts all addresses. "
                + "This would allow users to reindex-from-remote any URL they like effectively having Havenask make HTTP GETs "
