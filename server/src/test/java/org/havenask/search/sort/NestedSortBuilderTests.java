...
public class NestedSortBuilderTests extends HavenaskTestCase {
    ...
    public void testRewrite() throws IOException {
        QueryBuilder filterThatRewrites = new MatchNoneQueryBuilder() {
            @Override
            protected QueryBuilder doRewrite(org.havenask.index.query.QueryRewriteContext queryShardContext) throws IOException {
