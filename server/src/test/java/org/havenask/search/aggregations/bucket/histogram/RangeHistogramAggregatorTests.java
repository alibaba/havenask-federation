    ...
    public void testAsSubAgg() throws IOException {
        ...
        CheckedConsumer<RandomIndexWriter, IOException> buildIndex = iw -> {
            ...
            for (int n = 0; n < 10000; n++) {
                BytesRef outerRange = RangeType.LONG.encodeRanges(org.havenask.common.collect.Set.of(
                    new RangeFieldMapper.Range(RangeType.LONG, n % 100, n % 100 + 10, true, true)
                ));
                BytesRef innerRange = RangeType.LONG.encodeRanges(org.havenask.common.collect.Set.of(
                    new RangeFieldMapper.Range(RangeType.LONG, n / 100, n / 100 + 10, true, true)
                ));

                docs.add(org.havenask.common.collect.List.of(
