...
public class CoreValuesSourceTypeTests extends HavenaskTestCase {
    ...
    public void testFromString() {
        ...
        assertThat(e.getMessage(),
            equalTo("No enum constant org.havenask.search.aggregations.support.CoreValuesSourceType.DOES_NOT_EXIST"));
