        ...
        testCase((deferringCollector, delegate) -> new LeafBucketCollector() {
            ...
            equalTo(
                org.havenask.common.collect.Map.of(
                    0L,
                    org.havenask.common.collect.List.of(0, 1, 2, 3, 4, 5, 6, 7),
                    1L,
                    org.havenask.common.collect.List.of(8),
                    2L,
                    org.havenask.common.collect.List.of(9)
                )
            );
        });
    }
        ...
        testCase((deferringCollector, delegate) -> new LeafBucketCollector() {
            ...
            assertThat(
                ...
                equalTo(
                    org.havenask.common.collect.Map.of(
                        0L,
                        org.havenask.common.collect.List.of(4, 5, 6, 7),
                        1L,
                        org.havenask.common.collect.List.of(8),
                        2L,
                        org.havenask.common.collect.List.of(9)
        ...
        testCase((deferringCollector, delegate) -> new LeafBucketCollector() {
            ...
            assertThat(
                ...
                equalTo(
                    org.havenask.common.collect.Map.of(
                        0L,
                        org.havenask.common.collect.List.of(0, 1, 2, 3),
                        1L,
                        org.havenask.common.collect.List.of(8),
                        2L,
                        org.havenask.common.collect.List.of(9)
