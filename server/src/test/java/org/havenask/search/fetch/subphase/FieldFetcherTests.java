...
public class FieldFetcherTests extends HavenaskSingleNodeTestCase {
    ...
    public void testLeafValues() throws IOException {
        ...
        List<FieldAndFormat> fieldAndFormats = org.havenask.common.collect.List.of(
    ...
    public void testObjectValues() throws IOException {
        ...
        assertThat(rangeField.getValue(), equalTo(org.havenask.common.collect.Map.of("gte", 0.0f, "lte", 2.718f)));
    }
    ...
    public void testDateFormat() throws IOException {
        ...
        Map<String, DocumentField> fields = fetchFields(mapperService, source, org.havenask.common.collect.List.of(
            new FieldAndFormat("field", null),
    ...
    private Map<String, DocumentField> fetchFields(MapperService mapperService, XContentBuilder source, String fieldPattern)
        ...
        List<FieldAndFormat> fields = org.havenask.common.collect.List.of(new FieldAndFormat(fieldPattern, null));
    ...
    private Map<String, DocumentField> fetchFields(MapperService mapperService, XContentBuilder source, List<FieldAndFormat> fields)
        ...
        return fieldFetcher.fetch(sourceLookup, org.havenask.common.collect.Set.of());
    }
