...
import static org.havenask.search.internal.ContextIndexSearcher.intersectScorerAndBitSet;
import static org.havenask.search.internal.ExitableDirectoryReader.ExitableLeafReader;
import static org.havenask.search.internal.ExitableDirectoryReader.ExitablePointValues;
import static org.havenask.search.internal.ExitableDirectoryReader.ExitableTerms;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.instanceOf;

public class ContextIndexSearcherTests extends HavenaskTestCase {
    ...
    public void doTestContextIndexSearcher(boolean sparse, boolean deletions) throws IOException {
        ...
        DirectoryReader reader = HavenaskDirectoryReader.wrap(DirectoryReader.open(w),
            ...
            super(in, new SubReaderWrapper() {
                ...
                public LeafReader wrap(LeafReader reader) {
                    try {
                        ...
                        throw ExceptionsHelper.convertToHavenaskException(e);
                    }
                }
            });
