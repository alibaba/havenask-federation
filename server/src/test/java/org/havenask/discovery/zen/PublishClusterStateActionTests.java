...
import org.havenask.transport.TransportConnectionListener;
...
public class PublishClusterStateActionTests extends HavenaskTestCase {
    ...
    public void testDisablingDiffPublishing() throws Exception {
        ...
        assertWarnings(
            "[discovery.zen.publish_diff.enable] setting was deprecated in Havenask and will be removed in a future release! " +
    ...
    public void testPublishingWithSendingErrors() throws Exception {
        ...
        assertWarnings(
            "[discovery.zen.publish_timeout] setting was deprecated in Havenask and will be removed in a future release! " +
                "See the breaking changes documentation for the next major version.",
            "[discovery.zen.commit_timeout] setting was deprecated in Havenask and will be removed in a future release! " +
                "See the breaking changes documentation for the next major version.");
    }
    ...
    public static class MockPublishAction extends PublishClusterStateAction {
        ...
        protected void handleIncomingClusterStateRequest(BytesTransportRequest request, TransportChannel channel) throws IOException {
            if (errorOnSend.get()) {
                throw new HavenaskException("forced error on incoming cluster state");
            }
        ...
        protected void handleCommitRequest(PublishClusterStateAction.CommitClusterStateRequest request, TransportChannel channel) {
            if (errorOnCommit.get()) {
                throw new HavenaskException("forced error on incoming commit");
            }
