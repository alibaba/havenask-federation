...
package org.havenask.discovery.zen;
...
import org.havenask.cluster.coordination.JoinTaskExecutor;
import org.havenask.cluster.coordination.NodeRemovalClusterStateTaskExecutor;
import org.havenask.cluster.coordination.ValidateJoinRequest;
...
import org.havenask.discovery.zen.PublishClusterStateActionTests.AssertingAckListener;
import org.havenask.discovery.zen.ZenDiscovery.ZenNodeRemovalClusterStateTaskExecutor;
...
import static org.havenask.cluster.routing.RoutingTableTests.updateActiveAllocations;
import static org.havenask.cluster.service.MasterServiceTests.discoveryState;
import static org.havenask.discovery.zen.ElectMasterService.DISCOVERY_ZEN_MINIMUM_MASTER_NODES_SETTING;
import static org.havenask.discovery.zen.ZenDiscovery.shouldIgnoreOrRejectNewClusterState;
...
public class ZenDiscoveryUnitTests extends HavenaskTestCase {
    ...
    public void testNodesUpdatedAfterClusterStatePublished() throws Exception {
        ...
        assertWarnings("[discovery.zen.minimum_master_nodes] setting was deprecated in Havenask and will be removed in a future " +
    ...
    private ZenDiscovery buildZenDiscovery(Settings settings, TransportService service, MasterService masterService,
        ...
        ZenDiscovery zenDiscovery = new ZenDiscovery(settings, threadPool, service,
            ...
            HavenaskAllocationTestCase.createAllocationService(), Collections.emptyList(), (s, p, r) -> {});
        zenDiscovery.start();
        return zenDiscovery;
    }
