...
import org.havenask.discovery.zen.PendingClusterStatesQueue.ClusterStateContext;
...
public class PendingClusterStatesQueueTests extends HavenaskTestCase {
    ...
    public void testFailedStateCleansSupersededStatesOnly() {
        ...
        queue.markAsFailed(toFail, new HavenaskException("boo!"));
    ...
    public void testFailAllAndClear() {
        ...
        PendingClusterStatesQueue queue = createQueueWithStates(states);
        List<ClusterStateContext> committedContexts = randomCommitStates(queue);
        queue.failAllStatesAndClear(new HavenaskException("boo!"));
