...
import org.havenask.discovery.zen.MasterFaultDetection;
import org.havenask.discovery.zen.NodesFaultDetection;
...
public class ZenFaultDetectionTests extends HavenaskTestCase {
    ...
    public void testNodesFaultDetectionConnectOnDisconnect() throws InterruptedException {
        ...
        assertWarnings(
            "[discovery.zen.fd.connect_on_network_disconnect] setting was deprecated in Havenask and will be removed in a future " +
                "release! See the breaking changes documentation for the next major version.",
            "[discovery.zen.fd.ping_interval] setting was deprecated in Havenask and will be removed in a future " +
                "release! See the breaking changes documentation for the next major version.");
    }
