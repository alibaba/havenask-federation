...
import org.havenask.repositories.FilterRepository;
...
import static org.havenask.snapshots.InternalSnapshotsInfoService.INTERNAL_SNAPSHOT_INFO_MAX_CONCURRENT_FETCHES_SETTING;
...
public class InternalSnapshotsInfoServiceTests extends HavenaskTestCase {
    ...
    public void testCleanUpSnapshotShardSizes() throws Exception {
        ...
        if (randomBoolean()) {
            ...
            final AllocationService allocationService = HavenaskAllocationTestCase.createAllocationService(Settings.builder()
            ...
            applyClusterState("starting shards for " + indexName, clusterState ->
                    HavenaskAllocationTestCase.startInitializingShardsAndReroute(allocationService, clusterState, indexName));
    ...
    private ClusterState demoteMasterNode(final ClusterState currentState) {
        final DiscoveryNode node = new DiscoveryNode("other", HavenaskTestCase.buildNewFakeTransportAddress(), Collections.emptyMap(),
