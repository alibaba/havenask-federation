...
public class BuildTests extends HavenaskTestCase {
    ...
    public void testJarMetadata() throws IOException {
        URL url = Build.getHavenaskCodeSourceLocation();
    ...
    public void testSerializationBWC() throws IOException {
        ...
        final Version post10HavenaskVersion =
        ...
        final WriteableBuild post10Havenask = copyWriteable(dockerBuild, writableRegistry(), WriteableBuild::new,
            post10HavenaskVersion);
        ...
        assertThat(post10Havenask.build.getQualifiedVersion(), equalTo(dockerBuild.build.getQualifiedVersion()));
        assertThat(post10Havenask.build.getDistribution(), equalTo(dockerBuild.build.getDistribution()));
    }
