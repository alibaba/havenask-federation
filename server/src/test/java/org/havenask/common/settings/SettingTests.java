...
import org.havenask.common.settings.AbstractScopedSettings.SettingUpdater;
...
public class SettingTests extends HavenaskTestCase {
    ...
    public void testNonSecureSettingInKeystore() {
        ...
        assertThat(e.getMessage(), containsString("must be stored inside havenask.yml"));
    }

    @TestLogging(value="org.havenask.common.settings.IndexScopedSettings:INFO",
    ...
    public void testLogSettingUpdate() throws Exception {
        ...
        mockLogAppender.addExpectation(new MockLogAppender.SeenEventExpectation(
            "message",
            "org.havenask.common.settings.IndexScopedSettings",
            Level.INFO,
