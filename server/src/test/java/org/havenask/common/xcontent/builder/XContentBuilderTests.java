...
package org.havenask.common.xcontent.builder;
...
import org.havenask.common.xcontent.XContentHavenaskExtension;
...
public class XContentBuilderTests extends HavenaskTestCase {
    ...
    public void testDateTypesConversion() throws Exception {
        Date date = new Date();
        String expectedDate = XContentHavenaskExtension.DEFAULT_DATE_PRINTER.print(date.getTime());
        Calendar calendar = new GregorianCalendar(TimeZone.getTimeZone("UTC"), Locale.ROOT);
        String expectedCalendar = XContentHavenaskExtension.DEFAULT_DATE_PRINTER.print(calendar.getTimeInMillis());
        XContentBuilder builder = XContentFactory.contentBuilder(XContentType.JSON);
