...
package org.havenask.common.xcontent.support;
...
public class XContentMapValuesTests extends AbstractFilteringTestCase {
    ...
    public void testExtractValueWithNullValue() throws Exception {
        ...
        assertEquals(org.havenask.common.collect.List.of("value1", "NULL", "value2"),
            XContentMapValues.extractValue("array", map, "NULL"));
        assertEquals(org.havenask.common.collect.List.of("NULL", "value"),
