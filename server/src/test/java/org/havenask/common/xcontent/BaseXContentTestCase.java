...
public abstract class BaseXContentTestCase extends HavenaskTestCase {
    ...
    public void testReadableInstant() throws Exception {
        ...
        expected = "{'t5':'" + XContentHavenaskExtension.DEFAULT_DATE_PRINTER.print(t5) + "'}";
    ...
    public void testObjects() throws Exception {
        ...
        final DateTimeFormatter formatter = XContentHavenaskExtension.DEFAULT_DATE_PRINTER;
        final Date d1 = new DateTime(2016, 1, 1, 0, 0, DateTimeZone.UTC).toDate();
    ...
    public void testUnknownObject() throws Exception {
        ...
        objects.put("{'obj':'class org.havenask.common.xcontent.BaseXContentTestCase'}", BaseXContentTestCase.class);
