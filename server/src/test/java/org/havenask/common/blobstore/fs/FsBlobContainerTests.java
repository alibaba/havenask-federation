...
public class FsBlobContainerTests extends HavenaskTestCase {
    ...
    public void setupMockFileSystems() {
        ...
        PathUtilsForTesting.installMock(fileSystem); // restored by restoreFileSystem in HavenaskTestCase
    }
