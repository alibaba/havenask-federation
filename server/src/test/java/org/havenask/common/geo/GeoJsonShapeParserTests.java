...
public class GeoJsonShapeParserTests extends BaseGeoParsingTestCase {
    ...
    public void testParsePoint() throws IOException, ParseException {
        ...
        assertGeometryEquals(new org.havenask.geometry.Point(100d, 0d), pointGeoJson, false);
    }
    ...
    public void testParseLineString() throws IOException, ParseException {
        ...
        try (XContentParser parser = createParser(lineGeoJson)) {
            ...
            HavenaskGeoAssertions.assertLineString(shape, true);
        }

        try (XContentParser parser = createParser(lineGeoJson)) {
            parser.nextToken();
            HavenaskGeoAssertions.assertLineString(parse(parser), false);
        }
    }
    ...
    public void testParseMultiDimensionShapes() throws IOException {
        ...
        parser.nextToken();
        HavenaskGeoAssertions.assertValidException(parser, HavenaskParseException.class);
    ...
    public void testParseEnvelope() throws IOException, ParseException {
        ...
        assertGeometryEquals(expected, multilinesGeoJson, true);
        assertGeometryEquals(new org.havenask.geometry.Rectangle(-50, 50, 30, -30),
            multilinesGeoJson, false);
    ...
    public void testParsePolygon() throws IOException, ParseException {
        ...
        org.havenask.geometry.Polygon p = new org.havenask.geometry.Polygon(
            new org.havenask.geometry.LinearRing(
    ...
    public void testParse3DPolygon() throws IOException, ParseException {
        ...
        try (XContentParser parser = createParser(polygonGeoJson)) {
            parser.nextToken();
            HavenaskGeoAssertions.assertEquals(jtsGeom(expected), ShapeParser.parse(parser, mapperBuilder).buildS4J());
        }

        org.havenask.geometry.Polygon p = new org.havenask.geometry.Polygon(new org.havenask.geometry.LinearRing(
    ...
    public void testParseInvalidMultiPolygon() throws IOException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, multiPolygonGeoJson)) {
            parser.nextToken();
            HavenaskGeoAssertions.assertValidException(parser, InvalidShapeException.class);
            assertNull(parser.nextToken());
        }
    }
    ...
    public void testParseOGCPolygonWithoutHoles() throws IOException, ParseException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            Shape shape = ShapeParser.parse(parser).buildS4J();
            HavenaskGeoAssertions.assertPolygon(shape, true);
        }

        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            HavenaskGeoAssertions.assertPolygon(parse(parser), false);
        }
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            Shape shape = ShapeParser.parse(parser).buildS4J();
            HavenaskGeoAssertions.assertMultiPolygon(shape, true);
        }

        try (XContentParser parser = createParser(JsonXContent.jsonXContent, polygonGeoJson)) {
            parser.nextToken();
            HavenaskGeoAssertions.assertMultiPolygon(parse(parser), false);
        }
    ...
    public void testParseInvalidPolygon() throws IOException {
        ...
        try (XContentParser parser = createParser(JsonXContent.jsonXContent, invalidPoly)) {
            parser.nextToken();
            HavenaskGeoAssertions.assertValidException(parser, IllegalArgumentException.class);
            assertNull(parser.nextToken());
        }
    ...
    public void testParsePolygonWithHole() throws IOException, ParseException {
        ...
        org.havenask.geometry.LinearRing hole =
            new org.havenask.geometry.LinearRing(
                new double[] {100.8d, 100.8d, 100.2d, 100.2d, 100.8d}, new double[] {0.8d, 0.2d, 0.2d, 0.8d, 0.8d});
        org.havenask.geometry.Polygon p =
            new org.havenask.geometry.Polygon(new org.havenask.geometry.LinearRing(
    ...
    public void testParseMultiPoint() throws IOException, ParseException {
        ...
        assertGeometryEquals(new MultiPoint(Arrays.asList(
            new org.havenask.geometry.Point(100, 0),
            new org.havenask.geometry.Point(101, 1))), multiPointGeoJson, false);
    }
    ...
    public void testParseMultiPolygon() throws IOException, ParseException {
        ...
        org.havenask.geometry.LinearRing hole = new org.havenask.geometry.LinearRing(
            new double[] {100.8d, 100.8d, 100.2d, 100.2d, 100.8d}, new double[] {0.8d, 0.2d, 0.2d, 0.8d, 0.8d});

        org.havenask.geometry.MultiPolygon polygons = new org.havenask.geometry.MultiPolygon(Arrays.asList(
            new org.havenask.geometry.Polygon(new org.havenask.geometry.LinearRing(
        ...
        org.havenask.geometry.LinearRing luceneHole =
            new org.havenask.geometry.LinearRing(
                new double[] {100.8d, 100.8d, 100.2d, 100.2d, 100.8d}, new double[] {0.8d, 0.2d, 0.2d, 0.8d, 0.8d});

        org.havenask.geometry.Polygon lucenePolygons = (new org.havenask.geometry.Polygon(
            new org.havenask.geometry.LinearRing(
    ...
    public void testParseGeometryCollection() throws IOException, ParseException {
        ...
        GeometryCollection<Geometry> geometryExpected = new GeometryCollection<> (Arrays.asList(
            new Line(new double[] {100d, 101d}, new double[] {0d, 1d}),
            new org.havenask.geometry.Point(102d, 2d),
            new org.havenask.geometry.MultiPolygon(Arrays.asList(
                new org.havenask.geometry.Polygon(new org.havenask.geometry.LinearRing(
    ...
    public void testThatParserExtractsCorrectTypeAndCoordinatesFromArbitraryJson() throws IOException, ParseException {
        XContentBuilder pointGeoJson = XContentFactory.jsonBuilder()
            ...
            org.havenask.geometry.Point expectedPt = new org.havenask.geometry.Point(100, 0);
