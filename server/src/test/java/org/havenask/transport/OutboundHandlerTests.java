...
public class OutboundHandlerTests extends HavenaskTestCase {
    ...
    public void testErrorResponse() throws IOException {
        ...
        long requestId = randomLongBetween(0, 300);
        threadContext.putHeader("header", "header_value");
        HavenaskException error = new HavenaskException("boom");
        ...
        assertThat(remoteException.getCause(), instanceOf(HavenaskException.class));
