...
public class TcpTransportTests extends HavenaskTestCase {
    ...
    @TestLogging(reason = "testing logging", value = "org.havenask.transport.TcpTransport:DEBUG")
    public void testExceptionHandling() throws IllegalAccessException {
        testExceptionHandling(false, new HavenaskException("simulated"), true,
            new MockLogAppender.UnseenEventExpectation("message", "org.havenask.transport.TcpTransport", Level.ERROR, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "org.havenask.transport.TcpTransport", Level.WARN, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "org.havenask.transport.TcpTransport", Level.INFO, "*"),
            new MockLogAppender.UnseenEventExpectation("message", "org.havenask.transport.TcpTransport", Level.DEBUG, "*"));
        testExceptionHandling(new HavenaskException("simulated"),
            new MockLogAppender.SeenEventExpectation("message", "org.havenask.transport.TcpTransport",
        ...
        testExceptionHandling(new HavenaskException("Connection reset"),
            new MockLogAppender.SeenEventExpectation("message", "org.havenask.transport.TcpTransport",
                Level.DEBUG, "close connection exception caught on transport layer [*], disconnecting from relevant node"));
