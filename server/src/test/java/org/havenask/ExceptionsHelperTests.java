...
import static org.havenask.ExceptionsHelper.maybeError;
import static org.hamcrest.CoreMatchers.equalTo;
import static org.hamcrest.CoreMatchers.instanceOf;
import static org.hamcrest.CoreMatchers.nullValue;

public class ExceptionsHelperTests extends HavenaskTestCase {
    ...
    public void testStatus() {
        ...
        assertThat(ExceptionsHelper.status(new HavenaskRejectedExecutionException("rejected")), equalTo(RestStatus.TOO_MANY_REQUESTS));
    }
    ...
    public void testGroupByNullTarget() {
        ...
        for (ShardOperationFailedException shardOperationFailedException : groupBy) {
            ...
            assertThat(shardOperationFailedException.getCause(), instanceOf(HavenaskException.class));
            HavenaskException havenaskException = (HavenaskException) shardOperationFailedException.getCause();
            assertThat(havenaskException.getMessage(), equalTo(expectedErrors[i]));
            assertThat(havenaskException.getIndex().getName(), equalTo(expectedIndices[i++]));
        }
    }
