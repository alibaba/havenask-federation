...
import static org.havenask.index.seqno.LocalCheckpointTracker.BIT_SET_SIZE;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.is;
import static org.hamcrest.Matchers.oneOf;

public class LocalCheckpointTrackerTests extends HavenaskTestCase {
    ...
    public void testLazyInitialization() {
        ...
        assertThat(tracker.hasProcessed(randomValueOtherThan(seqNo, HavenaskTestCase::randomNonNegativeLong)), equalTo(false));
        assertThat(tracker.processedSeqNo.size(), equalTo(1));
    }
    ...
    public void testSimpleOverFlow() {
        ...
        final long notCompletedSeqNo = randomValueOtherThanMany(seqNoList::contains, HavenaskTestCase::randomNonNegativeLong);
        ...
        for (int t = 0; t < threads.length; t++) {
            ...
            threads[t] = new Thread(new AbstractRunnable() {
                ...
                public void onFailure(Exception e) {
                    throw new HavenaskException("failure in background thread", e);
                }
