...
public class TranslogHeaderTests extends HavenaskTestCase {
    ...
    public void testLegacyTranslogVersions() throws Exception {
        checkFailsToOpen("/org/havenask/index/translog/translog-v0.binary", IllegalStateException.class, "pre-1.4 translog");
        checkFailsToOpen("/org/havenask/index/translog/translog-v1.binary", IllegalStateException.class, "pre-2.0 translog");
        checkFailsToOpen("/org/havenask/index/translog/translog-v1-truncated.binary", IllegalStateException.class, "pre-2.0 translog");
        checkFailsToOpen("/org/havenask/index/translog/translog-v1-corrupted-magic.binary",
            TranslogCorruptedException.class, "translog looks like version 1 or later, but has corrupted header");
        checkFailsToOpen("/org/havenask/index/translog/translog-v1-corrupted-body.binary",
