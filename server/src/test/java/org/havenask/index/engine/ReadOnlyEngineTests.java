...
import org.havenask.index.engine.TranslogHandler;
...
import static org.havenask.common.lucene.index.HavenaskDirectoryReader.getHavenaskDirectoryReader;
    ...
    public void testReadOnlyEngine() throws Exception {
        ...
        try (Store store = createStore()) {
            ...
            try (InternalEngine engine = createEngine(config)) {
                ...
                HavenaskDirectoryReader esReader = getHavenaskDirectoryReader(dirReader);
