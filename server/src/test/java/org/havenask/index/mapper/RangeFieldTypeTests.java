...
import org.havenask.index.mapper.RangeFieldMapper.RangeFieldType;
...
public class RangeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        MappedFieldType longMapper = new RangeFieldMapper.Builder("field", RangeType.LONG, true)
            .build(context)
            .fieldType();
        Map<String, Object> longRange = org.havenask.common.collect.Map.of("gte", 3.14, "lt", "42.9");
        assertEquals(Collections.singletonList(org.havenask.common.collect.Map.of("gte", 3L, "lt", 42L)),
        ...
        MappedFieldType dateMapper = new RangeFieldMapper.Builder("field", RangeType.DATE, true)
            ...
            .build(context)
            .fieldType();
        Map<String, Object> dateRange = org.havenask.common.collect.Map.of("lt", "1990/12/29", "gte", 597429487111L);
        assertEquals(Collections.singletonList(org.havenask.common.collect.Map.of("lt", "1990/12/29", "gte", "1988/12/06")),
    ...
    public void testParseSourceValueWithFormat() throws IOException {
        ...
        MappedFieldType dateMapper = new RangeFieldMapper.Builder("field", RangeType.DATE, true)
            ...
            .build(context)
            .fieldType();
        Map<String, Object> dateRange = org.havenask.common.collect.Map.of("lt", "1990-12-29T00:00:00.000Z");
        assertEquals(Collections.singletonList(org.havenask.common.collect.Map.of("lt", "1990/12/29")),
            fetchSourceValue(dateMapper, dateRange, "yyy/MM/dd"));
        assertEquals(Collections.singletonList(org.havenask.common.collect.Map.of("lt", "662428800000")),
