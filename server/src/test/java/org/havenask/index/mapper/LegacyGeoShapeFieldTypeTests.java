...
import org.havenask.index.mapper.LegacyGeoShapeFieldMapper.GeoShapeFieldType;
...
public class LegacyGeoShapeFieldTypeTests extends FieldTypeTestCase {
    ...
    public void testFetchSourceValue() throws IOException {
        ...
        Map<String, Object> jsonLineString = org.havenask.common.collect.Map.of("type", "LineString", "coordinates",
