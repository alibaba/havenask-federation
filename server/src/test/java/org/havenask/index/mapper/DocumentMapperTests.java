...
public class DocumentMapperTests extends MapperServiceTestCase {
    ...
    public void testMergeMetaForIndexTemplate() throws IOException {
        ...
        Map<String, Object> expected = org.havenask.common.collect.Map.of(
            "field", "value",
            "object", org.havenask.common.collect.Map.of("field1", "value1", "field2", "value2"));
        ...
        expected = org.havenask.common.collect.Map.of(
            "field", "value",
            "object", org.havenask.common.collect.Map.of("field1", "value1", "field2", "new_value", "field3", "value3"));
        assertThat(mergedMapper.meta(), equalTo(expected));
    }
}
