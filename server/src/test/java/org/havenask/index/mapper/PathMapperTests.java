...
public class PathMapperTests extends HavenaskSingleNodeTestCase {
    public void testPathMapping() throws IOException {
        String mapping = copyToStringFromClasspath("/org/havenask/index/mapper/path/test-mapping.json");
