...
import org.havenask.index.mapper.NumberFieldTypeTests.OutOfRangeSpec;
...
public class NumberFieldMapperTests extends AbstractNumericFieldMapperTestCase {
    ...
    protected Set<String> types() {
        return org.havenask.common.collect.Set.of("byte", "short", "integer", "long", "float", "double", "half_float");
    }

    @Override
    protected Set<String> wholeTypes() {
        return org.havenask.common.collect.Set.of("byte", "short", "integer", "long");
    }
