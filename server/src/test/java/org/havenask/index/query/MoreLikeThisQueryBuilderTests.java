...
import org.havenask.action.termvectors.MultiTermVectorsItemResponse;
...
import org.havenask.common.lucene.search.MoreLikeThisQuery;
...
public class MoreLikeThisQueryBuilderTests extends AbstractQueryTestCase<MoreLikeThisQueryBuilder> {
    ...
    private XContentBuilder randomArtificialDoc() {
        ...
        try {
            ...
            throw new HavenaskException("Unable to generate random artificial doc!");
        }
        return doc;
    }
