...
import org.havenask.common.lucene.search.function.FunctionScoreQuery.FilterScoreFunction;
import org.havenask.common.lucene.search.function.FunctionScoreQuery.ScoreMode;
import org.havenask.common.lucene.search.function.LeafScoreFunction;
import org.havenask.common.lucene.search.function.RandomScoreFunction;
import org.havenask.common.lucene.search.function.ScoreFunction;
import org.havenask.common.lucene.search.function.WeightFactorFunction;
...
public class FunctionScoreTests extends HavenaskTestCase {
    ...
    private static double[] randomPositiveDoubles(int size) {
        ...
        for (int i = 0; i < values.length; i++) {
            double rand = randomValueOtherThanMany((d) -> Double.compare(d, 0) < 0, HavenaskTestCase::randomDouble);
    ...
    public void testWithInvalidScores() {
        ...
        HavenaskException exc = expectThrows(HavenaskException.class, () -> localSearcher.search(query1, 1));
        ...
        exc = expectThrows(HavenaskException.class, () -> localSearcher.search(query2, 1));
