...
public class InnerHitBuilderTests extends HavenaskTestCase {
     ...
     * {@link SearchSourceBuilder#collapse(org.havenask.search.collapse.CollapseBuilder)})
     */
    ...
    private static InnerHitBuilder serializedCopy(InnerHitBuilder original) throws IOException {
        return HavenaskTestCase.copyWriteable(original, namedWriteableRegistry, InnerHitBuilder::new);
    }
