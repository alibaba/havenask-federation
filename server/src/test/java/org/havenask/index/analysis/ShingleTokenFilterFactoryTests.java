...
public class ShingleTokenFilterFactoryTests extends HavenaskTokenStreamTestCase {
    private static final String RESOURCE = "/org/havenask/index/analysis/shingle_analysis.json";

    public void testDefault() throws IOException {
        HavenaskTestCase.TestAnalysis analysis = AnalysisTestsHelper.createTestAnalysisFromClassPath(createTempDir(), RESOURCE);
    ...
    * is greater than the allowed value of max_shingle_diff
    ...
    public void testMaxShingleDiffException() throws Exception{
        String RESOURCE2 = "/org/havenask/index/analysis/shingle_analysis2.json";
        int maxAllowedShingleDiff = 3;
        int shingleDiff = 8;
        try {
            HavenaskTestCase.TestAnalysis analysis = AnalysisTestsHelper.createTestAnalysisFromClassPath(createTempDir(), RESOURCE2);
