...
import org.havenask.index.fielddata.plain.AbstractLeafOrdinalsFieldData;
...
public class FieldDataCacheTests extends HavenaskTestCase {
    ...
    public void testLoadGlobal_neverCacheIfFieldIsMissing() throws Exception {
        ...
        iw.close();
        DirectoryReader ir =
            HavenaskDirectoryReader.wrap(DirectoryReader.open(dir), new ShardId("_index", "_na_", 0));
