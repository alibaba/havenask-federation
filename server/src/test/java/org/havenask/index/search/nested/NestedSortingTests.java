...
package org.havenask.index.search.nested;
...
import org.havenask.index.fielddata.AbstractFieldDataTestCase;
import org.havenask.index.fielddata.IndexFieldData;
import org.havenask.index.fielddata.NoOrdinalsStringFieldDataTests;
import org.havenask.index.fielddata.fieldcomparator.BytesRefFieldComparatorSource;
import org.havenask.index.fielddata.plain.PagedBytesIndexFieldData;
...
import org.havenask.search.sort.NestedSortBuilder;
...
import static org.havenask.index.mapper.SeqNoFieldMapper.PRIMARY_TERM_NAME;
...
public class NestedSortingTests extends AbstractFieldDataTestCase {
    ...
    public void testDuel() throws Exception {
        ...
        reader = HavenaskDirectoryReader.wrap(reader, new ShardId(indexService.index(), 0));
