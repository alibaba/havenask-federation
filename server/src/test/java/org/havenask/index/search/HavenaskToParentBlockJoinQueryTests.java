...
public class HavenaskToParentBlockJoinQueryTests extends HavenaskTestCase {

    public void testEquals() {
        Query q1 = new HavenaskToParentBlockJoinQuery(
                new TermQuery(new Term("is", "child")),
                new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
                ScoreMode.Avg, "nested");

        Query q2 = new HavenaskToParentBlockJoinQuery(
                new TermQuery(new Term("is", "child")),
                new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
                ScoreMode.Avg, "nested");
        assertEquals(q1, q2);
        ...
        Query q3 = new HavenaskToParentBlockJoinQuery(
        ...
        Query q4 = new HavenaskToParentBlockJoinQuery(
                new TermQuery(new Term("is", "child")),
        ...
        Query q5 = new HavenaskToParentBlockJoinQuery(
                new TermQuery(new Term("is", "child")),
                new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
        ...
        Query q6 = new HavenaskToParentBlockJoinQuery(
                new TermQuery(new Term("is", "child")),
                new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
    ...
    public void testRewrite() throws IOException {
        Query q = new HavenaskToParentBlockJoinQuery(
                new PhraseQuery("body", "term"), // rewrites to a TermQuery
                new QueryBitSetProducer(new TermQuery(new Term("is", "parent"))),
                ScoreMode.Avg, "nested");
        Query expected = new HavenaskToParentBlockJoinQuery(
