...
import org.havenask.action.termvectors.TermVectorsRequest.Flag;
...
public class TermVectorsUnitTests extends HavenaskTestCase {
    ...
    public void testMultiParser() throws Exception {
        byte[] bytes = StreamsUtils.copyToBytesFromClasspath("/org/havenask/action/termvectors/multiRequest1.json");
        ...
        bytes = StreamsUtils.copyToBytesFromClasspath("/org/havenask/action/termvectors/multiRequest2.json");
    ...
    public void testMultiParserFilter() throws Exception {
        byte[] bytes = StreamsUtils.copyToBytesFromClasspath("/org/havenask/action/termvectors/multiRequest3.json");
        XContentParser data = createParser(JsonXContent.jsonXContent, bytes);
        MultiTermVectorsRequest request = new MultiTermVectorsRequest();
        request.add(new TermVectorsRequest(), data);
