...
import org.havenask.search.fetch.ShardFetchSearchRequest;
...
public class FetchSearchPhaseTests extends HavenaskTestCase {
    ...
    public void testShortcutQueryAndFetchOptimization() {
        ...
        QueryPhaseResultConsumer results = controller.newSearchPhaseResults(HavenaskExecutors.newDirectExecutorService(),
    ...
    public void testExceptionFailsPhase() {
        ...
        QueryPhaseResultConsumer results =
            controller.newSearchPhaseResults(HavenaskExecutors.newDirectExecutorService(),
                new NoopCircuitBreaker(CircuitBreaker.REQUEST), SearchProgressListener.NOOP,
                mockSearchPhaseContext.getRequest(), 2, exc  -> {});
        int resultSetSize = randomIntBetween(2, 10);
