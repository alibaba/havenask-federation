...
public class DfsQueryPhaseTests extends HavenaskTestCase {
    ...
    public void testDfsWith2Shards() throws IOException {
        ...
        QueryPhaseResultConsumer consumer = searchPhaseController.newSearchPhaseResults(HavenaskExecutors.newDirectExecutorService(),
