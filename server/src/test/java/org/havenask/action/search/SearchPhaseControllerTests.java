...
public class SearchPhaseControllerTests extends HavenaskTestCase {
    private ThreadPool threadPool;
    private HavenaskThreadPoolExecutor fixedExecutor;
    ...
    public void setup() {
        ...
        fixedExecutor = HavenaskExecutors.newFixed("test", 1, 10,
