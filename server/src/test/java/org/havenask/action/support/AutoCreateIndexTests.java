...
public class AutoCreateIndexTests extends HavenaskTestCase {
    ...
    public void testUpdate() {
        ...
        AutoCreateIndex autoCreateIndex = new AutoCreateIndex(settings, clusterSettings,
            ...
            new SystemIndices(org.havenask.common.collect.Map.of()));
    ...
    private static ClusterState buildClusterState(String... indices) {
        ...
        return ClusterState.builder(org.havenask.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
    ...
    private AutoCreateIndex newAutoCreateIndex(Settings settings) {
        SystemIndices systemIndices = new SystemIndices(org.havenask.common.collect.Map.of("plugin",
            org.havenask.common.collect.List.of(new SystemIndexDescriptor(TEST_SYSTEM_INDEX_NAME, ""))));
