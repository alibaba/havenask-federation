...
import org.havenask.ingest.CompoundProcessor;
...
import static org.havenask.action.ingest.SimulatePipelineRequest.Fields;
import static org.havenask.action.ingest.SimulatePipelineRequest.SIMULATED_PIPELINE_ID;
import static org.havenask.ingest.IngestDocument.Metadata.ID;
import static org.havenask.ingest.IngestDocument.Metadata.INDEX;
import static org.havenask.ingest.IngestDocument.Metadata.ROUTING;
import static org.havenask.ingest.IngestDocument.Metadata.TYPE;
import static org.havenask.ingest.IngestDocument.Metadata.VERSION;
import static org.havenask.ingest.IngestDocument.Metadata.VERSION_TYPE;
import static org.havenask.ingest.IngestDocument.Metadata.IF_SEQ_NO;
import static org.havenask.ingest.IngestDocument.Metadata.IF_PRIMARY_TERM;
...
public class SimulatePipelineRequestParsingTests extends HavenaskTestCase {
    ...
    public void testNotValidDocs() {
        ...
        requestContent.put(Fields.DOCS, docs);
        requestContent.put(Fields.PIPELINE, pipelineConfig);
        Exception e3 = expectThrows(HavenaskParseException.class,
            () -> SimulatePipelineRequest.parse(requestContent, false, ingestService));
