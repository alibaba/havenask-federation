...
public class PutMappingRequestTests extends HavenaskTestCase {
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndDataStreamsAndWriteAliases() {
        ...
        List<Tuple<String, Integer>> dsMetadata = org.havenask.common.collect.List.of(
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(dsMetadata,
            org.havenask.common.collect.List.of("index1", "index2", "index3"));
        cs = addAliases(cs, org.havenask.common.collect.List.of(
            tuple("alias1", org.havenask.common.collect.List.of(tuple("index1", false), tuple("index2", true))),
            tuple("alias2", org.havenask.common.collect.List.of(tuple("index2", false), tuple("index3", true)))
        ));
    ...
    public void testResolveIndicesWithoutWriteIndexOnlyAndDataStreamsAndWriteAliases() {
        ...
        expectedIndices.addAll(org.havenask.common.collect.List.of("index1", "index2", "index3"));
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndNoSingleWriteIndex() {
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(dsMetadata,
            org.havenask.common.collect.List.of("index1", "index2", "index3"));
        final ClusterState cs2 = addAliases(cs, org.havenask.common.collect.List.of(
            tuple("alias1", org.havenask.common.collect.List.of(tuple("index1", false), tuple("index2", true))),
            tuple("alias2", org.havenask.common.collect.List.of(tuple("index2", false), tuple("index3", true)))
        ));
    ...
    public void testResolveIndicesWithWriteIndexOnlyAndAliasWithoutWriteIndex() {
        ...
        ClusterState cs = DeleteDataStreamRequestTests.getClusterStateWithDataStreams(dsMetadata,
            org.havenask.common.collect.List.of("index1", "index2", "index3"));
        final ClusterState cs2 = addAliases(cs, org.havenask.common.collect.List.of(
            tuple("alias1", org.havenask.common.collect.List.of(tuple("index1", false), tuple("index2", false))),
            tuple("alias2", org.havenask.common.collect.List.of(tuple("index2", false), tuple("index3", false)))
        ));
