...
package org.havenask.action.admin.indices.resolve;

import org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedAlias;
import org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream;
import org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex;
import org.havenask.action.admin.indices.resolve.ResolveIndexAction.Response;
...
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.BACKING_INDICES_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedDataStream.TIMESTAMP_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ALIASES_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.ATTRIBUTES_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndex.DATA_STREAM_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.ResolvedIndexAbstraction.NAME_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.Response.DATA_STREAMS_FIELD;
import static org.havenask.action.admin.indices.resolve.ResolveIndexAction.Response.INDICES_FIELD;
...
public class ResolveIndexResponseTests extends AbstractSerializingTestCase<Response> {
    ...
    private static ResolvedIndex createTestResolvedIndexInstance() {
        ...
        String[] attributes = randomSubsetOf(
            org.havenask.common.collect.List.of("open", "hidden", "frozen")).toArray(Strings.EMPTY_ARRAY);
