...
public class CreateIndexRequestTests extends HavenaskTestCase {
    ...
    public void testSettingsType() throws IOException {
        ...
        CreateIndexRequest parsedCreateIndexRequest = new CreateIndexRequest();
        HavenaskParseException e = expectThrows(HavenaskParseException.class, () -> parsedCreateIndexRequest.source(builder));
