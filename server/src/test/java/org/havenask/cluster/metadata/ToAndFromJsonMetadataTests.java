...
import static org.havenask.cluster.metadata.Metadata.CONTEXT_MODE_API;
import static org.havenask.cluster.metadata.Metadata.CONTEXT_MODE_GATEWAY;
import static org.hamcrest.Matchers.contains;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.is;

public class ToAndFromJsonMetadataTests extends HavenaskTestCase {
    ...
    public void testSimpleJsonFromAndTo() throws IOException {
        ...
        Metadata metadata = Metadata.builder()
                ...
                .put(new DataStream("data-stream1", createTimestampField("@timestamp"),
                    org.havenask.common.collect.List.of(idx1.getIndex())))
                .put(new DataStream("data-stream2", createTimestampField("@timestamp"),
                    org.havenask.common.collect.List.of(idx2.getIndex())))
                .build();
