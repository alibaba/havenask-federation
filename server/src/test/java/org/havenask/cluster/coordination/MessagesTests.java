...
public class MessagesTests extends HavenaskTestCase {
                ...
                switch (randomInt(4)) {
                    ...
                    case 2:
                        ...
                        return new Join(join.getSourceNode(), join.getTargetNode(),
                            randomValueOtherThan(join.getTerm(), HavenaskTestCase::randomNonNegativeLong), join.getLastAcceptedTerm(),
                            join.getLastAcceptedVersion());
                    case 3:
                        // change last accepted term
                        return new Join(join.getSourceNode(), join.getTargetNode(), join.getTerm(),
                            randomValueOtherThan(join.getLastAcceptedTerm(), HavenaskTestCase::randomNonNegativeLong),
                            join.getLastAcceptedVersion());
                    case 4:
                        // change version
                        return new Join(join.getSourceNode(), join.getTargetNode(),
                            join.getTerm(), join.getLastAcceptedTerm(),
                            randomValueOtherThan(join.getLastAcceptedVersion(), HavenaskTestCase::randomNonNegativeLong));
                    default:
                ...
                switch (randomInt(1)) {
                    case 0:
                        ...
                        return new PublishResponse(
                            randomValueOtherThan(publishResponse.getTerm(), HavenaskTestCase::randomNonNegativeLong),
                            publishResponse.getVersion());
                    case 1:
                        // change version
                        return new PublishResponse(publishResponse.getTerm(),
                            randomValueOtherThan(publishResponse.getVersion(), HavenaskTestCase::randomNonNegativeLong));
                    default:
                        throw new AssertionError();
                }
            });
                ...
                switch (randomInt(1)) {
                    ...
                    case 1:
                        ...
                        return new StartJoinRequest(startJoinRequest.getSourceNode(),
                            randomValueOtherThan(startJoinRequest.getTerm(), HavenaskTestCase::randomNonNegativeLong));
                    default:
                        throw new AssertionError();
                }
            });
                ...
                switch (randomInt(2)) {
                    ...
                    case 1:
                        ...
                        return new ApplyCommitRequest(applyCommit.getSourceNode(),
                            randomValueOtherThan(applyCommit.getTerm(), HavenaskTestCase::randomNonNegativeLong),
                            applyCommit.getVersion());
                    case 2:
                        // change version
                        return new ApplyCommitRequest(applyCommit.getSourceNode(), applyCommit.getTerm(),
                            randomValueOtherThan(applyCommit.getVersion(), HavenaskTestCase::randomNonNegativeLong));
                    default:
                        throw new AssertionError();
                }
            });
            ...
            joinRequest -> {
                if (randomBoolean() && joinRequest.getOptionalJoin().isPresent() == false) {
                    ...
                    return new JoinRequest(joinRequest.getSourceNode(),
                        randomValueOtherThan(joinRequest.getMinimumTerm(), HavenaskTestCase::randomNonNegativeLong),
                ...
                switch (randomInt(2)) {
                    ...
                    case 2:
                        return new PreVoteResponse(
                            preVoteResponse.getCurrentTerm(),
                            preVoteResponse.getLastAcceptedTerm(),
                            randomValueOtherThan(preVoteResponse.getLastAcceptedVersion(), HavenaskTestCase::randomNonNegativeLong));
                    default:
                        throw new AssertionError();
                }
            });
