...
public class CoordinationMetadataTests extends HavenaskTestCase {
    ...
    public void testVotingConfigurationSerializationEqualsHashCode() {
        ...
        EqualsHashCodeTestUtils.checkEqualsAndHashCode(initialConfig,
                (CopyFunction<VotingConfiguration>) orig -> HavenaskTestCase.copyWriteable(orig,
    ...
    public void testVotingTombstoneSerializationEqualsHashCode() {
        ...
        EqualsHashCodeTestUtils.checkEqualsAndHashCode(tombstone,
                (CopyFunction<VotingConfigExclusion>) orig -> HavenaskTestCase.copyWriteable(orig,
    ...
    public void testCoordinationMetadataSerializationEqualsHashCode() {
        ...
        EqualsHashCodeTestUtils.checkEqualsAndHashCode(initialMetadata,
                (CopyFunction<CoordinationMetadata>) orig -> HavenaskTestCase.copyWriteable(orig,
            ...
            meta -> {
                ...
                switch (randomInt(3)) {
                    case 0:
                        builder.term(randomValueOtherThan(meta.term(), HavenaskTestCase::randomNonNegativeLong));
                        break;
                    case 1:
