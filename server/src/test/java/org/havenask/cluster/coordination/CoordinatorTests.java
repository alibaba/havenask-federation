...
import org.havenask.cluster.coordination.AbstractCoordinatorTestCase;
import org.havenask.cluster.coordination.AbstractCoordinatorTestCase.Cluster.ClusterNode;
import org.havenask.cluster.coordination.ClusterFormationFailureHelper;
...
import org.havenask.cluster.coordination.DetachClusterCommand;
import org.havenask.cluster.coordination.FollowersChecker;
import org.havenask.cluster.coordination.JoinHelper;
import org.havenask.cluster.coordination.LagDetector;
import org.havenask.cluster.coordination.Publication;
...
import static org.havenask.cluster.coordination.AbstractCoordinatorTestCase.Cluster.EXTREME_DELAY_VARIABILITY;
...
import static org.havenask.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_ALL;
import static org.havenask.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_METADATA_WRITES;
import static org.havenask.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_SETTING;
import static org.havenask.cluster.coordination.NoMasterBlockService.NO_MASTER_BLOCK_WRITES;
...
public class CoordinatorTests extends AbstractCoordinatorTestCase {
    ...
    private static class BrokenCustom extends AbstractDiffable<ClusterState.Custom> implements ClusterState.Custom {
        ...
        public void writeTo(StreamOutput out) throws IOException {
            throw new HavenaskException(EXCEPTION_MESSAGE);
        }
    ...
    public void testClusterRecoversAfterExceptionDuringSerialization() {
        try (Cluster cluster = new Cluster(randomIntBetween(1, 5))) {
            ...
            leader1.submitUpdateTask("broken-task",
                ...
                (source, e) -> {
                    assertThat(e.getCause(), instanceOf(HavenaskException.class));
