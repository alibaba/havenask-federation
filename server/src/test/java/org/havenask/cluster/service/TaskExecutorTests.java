...
public class TaskExecutorTests extends HavenaskTestCase {

    protected static ThreadPool threadPool;
    protected PrioritizedHavenaskThreadPoolExecutor threadExecutor;
    ...
    public void setUpExecutor() {
        threadExecutor = HavenaskExecutors.newSinglePrioritizing(getClass().getName() + "/" + getTestName(),
