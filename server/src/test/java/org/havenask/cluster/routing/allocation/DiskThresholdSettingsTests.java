...
public class DiskThresholdSettingsTests extends HavenaskTestCase {
    ...
    public void testUpdate() {
        ...
        assertWarnings("[cluster.routing.allocation.disk.include_relocations] setting was deprecated in Havenask and " +
