...
public class GatewayMetaStatePersistedStateTests extends HavenaskTestCase {
    ...
    public void testSetLastAcceptedStateTermChanged() throws IOException {
        ...
        try {
            ...
            final long version = randomNonNegativeLong();
            final long term = randomValueOtherThan(Long.MAX_VALUE, HavenaskTestCase::randomNonNegativeLong);
    ...
    public void testCurrentTermAndTermAreDifferent() throws IOException {
        ...
        try {
            ...
            long term = randomValueOtherThan(currentTerm, HavenaskTestCase::randomNonNegativeLong);
