...
import org.havenask.cluster.routing.UnassignedInfo.AllocationStatus;
...
import static org.havenask.cluster.routing.UnassignedInfo.Reason.CLUSTER_RECOVERED;
import static org.havenask.cluster.routing.UnassignedInfo.Reason.INDEX_CREATED;
import static org.havenask.cluster.routing.UnassignedInfo.Reason.INDEX_REOPENED;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.lessThanOrEqualTo;

public class PrimaryShardAllocatorTests extends HavenaskAllocationTestCase {
    ...
    private RoutingAllocation getRestoreRoutingAllocation(AllocationDeciders allocationDeciders, Long shardSize, String... allocIds) {
        ...
        RoutingTable routingTable = RoutingTable.builder()
            ...
            .build();
        ClusterState state = ClusterState.builder(org.havenask.cluster.ClusterName.CLUSTER_NAME_SETTING.getDefault(Settings.EMPTY))
            .metadata(metadata)
