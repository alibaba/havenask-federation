...
package org.havenask.recovery;

import org.havenask.HavenaskException;
import org.havenask.cluster.node.DiscoveryNode;
import org.havenask.common.unit.TimeValue;
import org.havenask.index.replication.HavenaskIndexLevelReplicationTestCase;
import org.havenask.index.shard.IndexShard;
import org.havenask.index.shard.ShardId;
import org.havenask.index.store.Store;
import org.havenask.indices.recovery.RecoveriesCollection;
...
public class RecoveriesCollectionTests extends HavenaskIndexLevelReplicationTestCase {
    ...
    public void testResetRecovery() throws Exception {
        try (ReplicationGroup shards = createGroup(0)) {
            ...
            expectThrows(HavenaskException.class, () -> recoveryTarget.store());
            expectThrows(HavenaskException.class, () -> recoveryTarget.indexShard());
