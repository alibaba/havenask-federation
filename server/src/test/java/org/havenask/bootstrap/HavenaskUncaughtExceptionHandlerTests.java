...
public class HavenaskUncaughtExceptionHandlerTests extends HavenaskTestCase {
    ...
    public void testUncaughtError() throws InterruptedException {
        ...
        thread.setUncaughtExceptionHandler(new HavenaskUncaughtExceptionHandler() {
    ...
    private void assertFatal(Throwable cause) {
        assertTrue(HavenaskUncaughtExceptionHandler.isFatalUncaught(cause));
    }

    private void assertNonFatal(Throwable cause) {
        assertFalse(HavenaskUncaughtExceptionHandler.isFatalUncaught(cause));
    }
