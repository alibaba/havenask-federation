...
import org.havenask.index.analysis.HunspellTokenFilterFactory;
import org.havenask.index.analysis.KeywordAnalyzerProvider;
import org.havenask.index.analysis.LowercaseNormalizerProvider;
...
import org.havenask.index.analysis.ShingleTokenFilterFactory;
import org.havenask.index.analysis.SimpleAnalyzerProvider;
import org.havenask.index.analysis.StandardAnalyzerProvider;
import org.havenask.index.analysis.StandardTokenizerFactory;
import org.havenask.index.analysis.StopAnalyzerProvider;
...
import org.havenask.index.analysis.WhitespaceAnalyzerProvider;
...
public final class AnalysisModule {
    ...
    static Map<String, PreConfiguredCharFilter> setupPreConfiguredCharFilters(List<AnalysisPlugin> plugins) {
        ...
        // No char filter are available in lucene-core so none are built in to Havenask core
    ...
    static Map<String, PreConfiguredTokenFilter> setupPreConfiguredTokenFilters(List<AnalysisPlugin> plugins) {
        ...
        preConfiguredTokenFilters.register( "standard",
            PreConfiguredTokenFilter.havenaskVersion("standard", true, (reader, version) -> {
