...
public final class EngineConfig {
    ...
    /**
     * Creates a new {@link org.havenask.index.engine.EngineConfig}
     */
    public EngineConfig(ShardId shardId, ThreadPool threadPool,
        ...
        final String escapeHatchProperty = "havenask.index.memory.max_index_buffer_size";
    ...
    /**
     * Returns an {@link org.havenask.index.engine.Engine.Warmer} used to warm new searchers before they are used for searching.
     */
    ...
    /**
     * Returns the {@link org.havenask.index.store.Store} instance that provides access to the
