 ...
 */
public final class HavenaskMergePolicy extends FilterMergePolicy {

    private static final Logger logger = LogManager.getLogger(HavenaskMergePolicy.class);
    ...
    public HavenaskMergePolicy(MergePolicy delegate) {
        super(delegate);
    }
