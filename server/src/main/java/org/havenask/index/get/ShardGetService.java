...
import org.havenask.index.fieldvisitor.CustomFieldsVisitor;
...
public final class ShardGetService extends AbstractIndexShardComponent {
    ...
    /**
     * Returns {@link GetResult} based on the specified {@link org.havenask.index.engine.Engine.GetResult} argument.
    ...
    private GetResult innerGetLoadFromStoredFields(String type, String id, String[] storedFields, FetchSourceContext fetchSourceContext,
        ...
        if (fieldVisitor != null) {
            try {
                ...
                throw new HavenaskException("Failed to get type [" + type + "] and id [" + id + "]", e);
            }
            ...
            if (get.isFromTranslog()) {
                ...
                if (forceSourceForComputingTranslogStoredFields == false) {
                    try {
                        ...
                        throw new HavenaskException("Failed to reapply filters for [" + id + "] after reading from translog", e);
                    }
                } else {
        ...
        if (source != null) {
            ...
            if (fetchSourceContext.fetchSource() == false) {
                ...
                try {
                    ...
                    throw new HavenaskException("Failed to get id [" + id + "] with includes/excludes set", e);
                }
            }
        }
        ...
        if (source != null && (fetchSourceContext.includes().length > 0 || fetchSourceContext.excludes().length > 0)) {
            ...
            try {
                ...
                throw new HavenaskException("Failed to get type [" + type + "] and id [" + id + "] with includes/excludes set", e);
            }
        }
