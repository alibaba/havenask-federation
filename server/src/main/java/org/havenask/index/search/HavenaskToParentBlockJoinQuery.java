...
public final class HavenaskToParentBlockJoinQuery extends Query {

    private final ToParentBlockJoinQuery query;
    private final String path;
    private final ScoreMode scoreMode;

    public HavenaskToParentBlockJoinQuery(Query childQuery, BitSetProducer parentsFilter, ScoreMode scoreMode, String path) {
        this(new ToParentBlockJoinQuery(childQuery, parentsFilter, scoreMode), path, scoreMode);
    }

    private HavenaskToParentBlockJoinQuery(ToParentBlockJoinQuery query, String path, ScoreMode scoreMode) {
        this.query = query;
        this.path = path;
    ...
    public Query rewrite(IndexReader reader) throws IOException {
        ...
        if (innerRewrite != query) {
            ...
            if (innerRewrite instanceof ToParentBlockJoinQuery) {
                return new HavenaskToParentBlockJoinQuery((ToParentBlockJoinQuery) innerRewrite, path, scoreMode);
            } else {
                return innerRewrite;
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        HavenaskToParentBlockJoinQuery that = (HavenaskToParentBlockJoinQuery) obj;
