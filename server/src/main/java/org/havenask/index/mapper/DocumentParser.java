...
import org.havenask.index.mapper.DynamicTemplate.XContentFieldType;
...
import static org.havenask.index.mapper.FieldMapper.IGNORE_MALFORMED_SETTING;
        ...
        if (token == XContentParser.Token.VALUE_STRING) {
            ...
            if (parseableAsLong && context.root().numericDetection()) {
                ...
                for (DateFormatter dateTimeFormatter : context.root().dynamicDateTimeFormatters()) {
                    ...
                    } catch (HavenaskParseException | DateTimeParseException | IllegalArgumentException e) {
