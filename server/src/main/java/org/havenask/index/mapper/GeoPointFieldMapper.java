...
import org.havenask.index.fielddata.plain.AbstractLatLonPointIndexFieldData;
import org.havenask.index.mapper.GeoPointFieldMapper.ParsedGeoPoint;
import org.havenask.index.query.QueryShardContext;
import org.havenask.index.query.VectorGeoPointShapeQueryProcessor;
    ...
    protected static class ParsedGeoPoint extends GeoPoint implements AbstractPointGeometryFieldMapper.ParsedPoint {
        ...
        public void normalize(String name) {
            if (isNormalizable(lat()) && isNormalizable(lon())) {
                ...
                throw new HavenaskParseException("cannot normalize the point - not a number");
            }
        }
