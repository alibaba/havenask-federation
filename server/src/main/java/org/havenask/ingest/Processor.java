...
public interface Processor {
     ...
     * and that gets passed around to all {@link org.havenask.plugins.IngestPlugin}s.
     */
    class Parameters {
        ...
        /**
         * Allows processors to read headers set by {@link org.havenask.action.support.ActionFilter}
