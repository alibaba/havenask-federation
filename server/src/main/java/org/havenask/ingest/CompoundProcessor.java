...
public class CompoundProcessor implements Processor {
    ...
    void executeOnFailureAsync(int currentOnFailureProcessor, IngestDocument ingestDocument, HavenaskException exception,
    ...
    private void putFailureMetadata(IngestDocument ingestDocument, HavenaskException cause) {
