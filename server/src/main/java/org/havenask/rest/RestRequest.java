...
import static org.havenask.common.unit.ByteSizeValue.parseBytesSizeValue;
...
public class RestRequest implements ToXContent.Params {
    ...
    public final BytesReference requiredContent() {
        if (hasContent() == false) {
            throw new HavenaskParseException("request body is required");
    ...
    /**
     * A parser for the contents of this request if there is a body, otherwise throws an {@link HavenaskParseException}. Use
     ...
     * otherwise throws an {@link HavenaskParseException}. Use {@link #withContentOrSourceParamParserOrNull(CheckedConsumer)} instead
    ...
    public final Tuple<XContentType, BytesReference> contentOrSourceParam() {
        if (hasContentOrSourceParam() == false) {
            throw new HavenaskParseException("request body or source parameter is required");
        } else if (hasContent()) {
