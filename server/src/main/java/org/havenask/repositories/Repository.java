...
public interface Repository extends LifecycleComponent {
     ...
     * See {@link org.havenask.plugins.RepositoryPlugin}.
     */
    interface Factory {
        /**
     ...
     *             {@link org.havenask.snapshots.SnapshotsService#NO_REPO_INITIALIZE_VERSION} is present.
     */
    @Deprecated
     ...
     * @param verificationToken value returned by {@link org.havenask.repositories.Repository#startVerification()}
     ...
     * <p>
     * The index commit point can be obtained by using {@link org.havenask.index.engine.Engine#acquireLastIndexCommit} method.
     ...
     * thus the same semantics as with {@link org.havenask.cluster.ClusterStateApplier#applyClusterState} apply for the
