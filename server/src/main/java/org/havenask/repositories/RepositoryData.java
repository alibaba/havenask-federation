...
public final class RepositoryData {
     ...
     * {@link org.havenask.cluster.metadata.IndexMetadata} blob name in it that can be removed after removing the given snapshot from
     * the repository.
     ...
     *                         {@link org.havenask.cluster.metadata.IndexMetadata} in them
     */
    ...
    public XContentBuilder snapshotsToXContent(final XContentBuilder builder, final Version repoMetaVersion) throws IOException {
        ...
        if (shouldWriteIndexGens) {
            ...
            // Add min version field to make it impossible for older Havenask versions to deserialize this object
                    ...
                    case SNAPSHOTS:
                        ...
                        while ((currToken = parser.nextToken()) != XContentParser.Token.END_ARRAY) {
                            ...
                            if (snapshotId == null) {
                                ...
                                throw new HavenaskParseException("Detected a corrupted repository, index " + indexId
