...
public final class ShardGenerations {
     ...
     * {@link org.havenask.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for it.
     */
    ...
    /**
     * Get the generation of the {@link org.havenask.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for a given index
     * and shard.
     ...
     *     {@link org.havenask.snapshots.SnapshotsService#SHARD_GEN_IN_REPO_DATA_VERSION}. If a caller expects a shard to exist in the
     ...
     * @return generation of the {@link org.havenask.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob
     */
    @Nullable
