...
package org.havenask.search.aggregations.bucket.terms.heuristic;
...
public class PercentageScore extends SignificanceHeuristic {
    ...
    public static SignificanceHeuristic parse(XContentParser parser)
        ...
        if (!parser.nextToken().equals(XContentParser.Token.END_OBJECT)) {
            throw new HavenaskParseException("failed to parse [percentage] significance heuristic. expected an empty object, " +
