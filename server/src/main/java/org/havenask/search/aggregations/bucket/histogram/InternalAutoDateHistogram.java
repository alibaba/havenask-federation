...
import org.havenask.search.aggregations.KeyComparable;
import org.havenask.search.aggregations.bucket.IteratorAndCurrent;
...
public final class InternalAutoDateHistogram extends
    ...
    private BucketReduceResult addEmptyBuckets(BucketReduceResult current, ReduceContext reduceContext) {
        ...
        InternalAggregations reducedEmptySubAggs = InternalAggregations.reduce(
            org.havenask.common.collect.List.of(bucketInfo.emptySubAggregations), reduceContext
        );
