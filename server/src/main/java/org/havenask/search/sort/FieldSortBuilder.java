...
import static org.havenask.index.mapper.DateFieldMapper.Resolution.MILLISECONDS;
import static org.havenask.index.mapper.DateFieldMapper.Resolution.NANOSECONDS;
...
public class FieldSortBuilder extends SortBuilder<FieldSortBuilder> {
     ...
     * Specifying a type tells Havenask what type the sort values should
     ...
     * Specifying a numeric type tells Havenask what type the sort values should
    ...
    public boolean isBottomSortShardDisjoint(QueryShardContext context, SearchSortValuesAndFormats bottomSortValues) throws IOException {
        ...
        } catch (HavenaskParseException exc) {
