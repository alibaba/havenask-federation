...
import org.havenask.index.fielddata.plain.AbstractLatLonPointIndexFieldData.LatLonPointIndexFieldData;
...
public class GeoDistanceSortBuilder extends SortBuilder<GeoDistanceSortBuilder> {
    ...
    /**
     * The distance unit to use. Defaults to {@link org.havenask.common.unit.DistanceUnit#METERS}
     */
    ...
    /**
     * Returns the distance unit to use. Defaults to {@link org.havenask.common.unit.DistanceUnit#METERS}
     */
