...
public class CloseIndexRequestBuilder
    ...
    public CloseIndexRequestBuilder(HavenaskClient client, CloseIndexAction action) {
        super(client, action, new CloseIndexRequest());
    }

    public CloseIndexRequestBuilder(HavenaskClient client, CloseIndexAction action, String... indices) {
