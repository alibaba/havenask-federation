...
import org.havenask.action.support.master.info.ClusterInfoRequestBuilder;
...
public class GetMappingsRequestBuilder
    ...
    public GetMappingsRequestBuilder(HavenaskClient client, GetMappingsAction action, String... indices) {
