...
public class CreateIndexRequestBuilder
    ...
    public CreateIndexRequestBuilder(HavenaskClient client, CreateIndexAction action) {
        super(client, action, new CreateIndexRequest());
    }

    public CreateIndexRequestBuilder(HavenaskClient client, CreateIndexAction action, String index) {
