...
public class PutIndexTemplateRequestBuilder
    ...
    public PutIndexTemplateRequestBuilder(HavenaskClient client, PutIndexTemplateAction action) {
        super(client, action, new PutIndexTemplateRequest());
    }

    public PutIndexTemplateRequestBuilder(HavenaskClient client, PutIndexTemplateAction action, String name) {
