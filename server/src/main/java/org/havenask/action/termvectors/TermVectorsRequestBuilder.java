...
public class TermVectorsRequestBuilder extends ActionRequestBuilder<TermVectorsRequest, TermVectorsResponse> {
    ...
    public TermVectorsRequestBuilder(HavenaskClient client, TermVectorsAction action) {
     ...
     */
    public TermVectorsRequestBuilder(HavenaskClient client, TermVectorsAction action, String index, String type, String id) {
