            ...
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                if (FIELDS.match(currentFieldName, parser.getDeprecationHandler())) {
                    if (token == XContentParser.Token.START_ARRAY) {
                        ...
                        throw new HavenaskParseException("failed to parse term vectors request. field [fields] must be an array");
                    }
                    ...
                    if (termVectorsRequest.doc != null) {
                        throw new HavenaskParseException("failed to parse term vectors request. " +
                    ...
                    throw new HavenaskParseException("failed to parse term vectors request. unknown field [{}]", currentFieldName);
                }
            }
        }
        if (fields.size() > 0) {
    ...
    public static Map<String, String> readPerFieldAnalyzer(Map<String, Object> map) {
        ...
        for (Map.Entry<String, Object> e : map.entrySet()) {
            if (e.getValue() instanceof String) {
                ...
                throw new HavenaskParseException("expecting the analyzer at [{}] to be a String, but found [{}] instead",
