...
public class PutPipelineRequestBuilder extends ActionRequestBuilder<PutPipelineRequest, AcknowledgedResponse> {
    ...
    public PutPipelineRequestBuilder(HavenaskClient client, PutPipelineAction action) {
        super(client, action, new PutPipelineRequest());
    }

    public PutPipelineRequestBuilder(HavenaskClient client, PutPipelineAction action, String id, BytesReference source,
