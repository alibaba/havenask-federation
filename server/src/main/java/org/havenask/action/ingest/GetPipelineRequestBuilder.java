...
public class GetPipelineRequestBuilder
    ...
    public GetPipelineRequestBuilder(HavenaskClient client, GetPipelineAction action) {
        super(client, action, new GetPipelineRequest());
    }

    public GetPipelineRequestBuilder(HavenaskClient client, GetPipelineAction action, String[] ids) {
