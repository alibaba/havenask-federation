...
public class SimulatePipelineRequestBuilder extends ActionRequestBuilder<SimulatePipelineRequest, SimulatePipelineResponse> {
     ...
     */
    public SimulatePipelineRequestBuilder(HavenaskClient client, SimulatePipelineAction action) {
     ...
     * Create a new builder for {@link SimulatePipelineRequest}s
     */
    public SimulatePipelineRequestBuilder(HavenaskClient client, SimulatePipelineAction action, BytesReference source,
