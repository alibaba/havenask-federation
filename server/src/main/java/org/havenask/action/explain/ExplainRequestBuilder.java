...
public class ExplainRequestBuilder extends SingleShardOperationRequestBuilder<ExplainRequest, ExplainResponse, ExplainRequestBuilder> {
    ...
    ExplainRequestBuilder(HavenaskClient client, ExplainAction action) {
        super(client, action, new ExplainRequest());
    }

    public ExplainRequestBuilder(HavenaskClient client, ExplainAction action, String index, String type, String id) {
