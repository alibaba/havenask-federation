...
import org.havenask.action.support.single.instance.InstanceShardOperationRequestBuilder;
...
public class UpdateRequestBuilder extends InstanceShardOperationRequestBuilder<UpdateRequest, UpdateResponse, UpdateRequestBuilder>
    ...
    public UpdateRequestBuilder(HavenaskClient client, UpdateAction action) {
        super(client, action, new UpdateRequest());
    }

    public UpdateRequestBuilder(HavenaskClient client, UpdateAction action, String index, String type, String id) {
    ...
    /**
     * Sets the versioning type. Defaults to {@link org.havenask.index.VersionType#INTERNAL}.
     */
     ...
     * {@link org.havenask.index.engine.DocumentMissingException} is thrown.
     */
