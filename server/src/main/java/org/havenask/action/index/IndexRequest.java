 ...
 * created using {@link org.havenask.client.Requests#indexRequest(String)}.
 *
 ...
 * its string form ({@link #source(String, XContentType)}) or using a {@link org.havenask.common.xcontent.XContentBuilder}
 * ({@link #source(org.havenask.common.xcontent.XContentBuilder)}).
 *
 * If the {@link #id(String)} is not set, it will be automatically generated.
 *
 * @see IndexResponse
 * @see org.havenask.client.Requests#indexRequest(String)
...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
     ...
     */
    public IndexRequest source(Map<String, ?> source) throws HavenaskGenerationException {
     ...
     * @param source The map to index
     */
    public IndexRequest source(Map<String, ?> source, XContentType contentType) throws HavenaskGenerationException {
        try {
            XContentBuilder builder = XContentFactory.contentBuilder(contentType);
            builder.map(source);
            return source(builder);
        } catch (IOException e) {
            throw new HavenaskGenerationException("Failed to generate [" + source + "]", e);
        }
    }
     ...
     *
     * Note, its preferable to either set it using {@link #source(org.havenask.common.xcontent.XContentBuilder)}
    ...
    public IndexRequest source(XContentType xContentType, Object... source) {
        ...
        try {
            ...
            throw new HavenaskGenerationException("Failed to generate", e);
        }
    }
