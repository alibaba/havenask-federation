...
public class BulkProcessor implements Closeable {
    ...
    public static class Builder {
         ...
         *
         * @see org.havenask.action.bulk.BackoffPolicy#exponentialBackoff()
         */
     ...
     * @param listener The BulkProcessor listener that gets called on bulk events
     * @return the builder for BulkProcessor
     * @deprecated Use {@link #builder(java.util.function.BiConsumer, org.havenask.action.bulk.BulkProcessor.Listener)}
     * with client::bulk as the first argument, or {@link #builder(org.havenask.client.Client,
     * org.havenask.action.bulk.BulkProcessor.Listener, org.havenask.threadpool.Scheduler,
     * org.havenask.threadpool.Scheduler, java.lang.Runnable)} and manage the flush and retry schedulers explicitly
     */
    @Deprecated
