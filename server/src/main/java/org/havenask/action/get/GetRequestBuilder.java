...
import org.havenask.action.support.single.shard.SingleShardOperationRequestBuilder;
...
public class GetRequestBuilder extends SingleShardOperationRequestBuilder<GetRequest, GetResponse, GetRequestBuilder> {
    ...
    public GetRequestBuilder(HavenaskClient client, GetAction action) {
        super(client, action, new GetRequest());
    }

    public GetRequestBuilder(HavenaskClient client, GetAction action, @Nullable String index) {
