...
public class HttpInfo implements ReportingService.Info {
    ...
    private static final boolean CNAME_IN_PUBLISH_HOST = System.getProperty("havenask.http.cname_in_publish_address") != null;
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (CNAME_IN_PUBLISH_HOST) {
            deprecationLogger.deprecate(
                ...
                "havenask.http.cname_in_publish_address system property is deprecated and no longer affects http.publish_address " +
