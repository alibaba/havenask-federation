...
import org.havenask.index.shard.ShardStateMetadata;
...
public class TransportNodesListGatewayStartedShards extends
    ...
    protected NodeGatewayStartedShards nodeOperation(NodeRequest request) {
        try {
            ...
            if (shardStateMetadata != null) {
                if (indicesService.getShardOrNull(shardId) == null) {
                    ...
                    if (request.getCustomDataPath() != null) {
                        ...
                        // TODO: Fallback for BWC with older Havenask versions.
            ...
            throw new HavenaskException("failed to load started shards", e);
        }
    }
