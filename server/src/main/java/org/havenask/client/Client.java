 ...
 * simply returns an {@link org.havenask.action.ActionFuture}, while the second accepts an
 * {@link ActionListener}.
 * <p>
 * A client can either be retrieved from a {@link org.havenask.node.Node} started, or connected remotely
 * to one or more nodes using {@link org.havenask.client.transport.TransportClient}.
 *
 * @see org.havenask.node.Node#client()
 * @see org.havenask.client.transport.TransportClient
 */
public interface Client extends HavenaskClient, Releasable {
