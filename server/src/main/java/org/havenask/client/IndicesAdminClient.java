 ...
 */
public interface IndicesAdminClient extends HavenaskClient {
     ...
     * @return The result future
     * @see org.havenask.client.Requests#deleteIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.havenask.client.Requests#closeIndexRequest(String)
     */
     ...
     * @param request The close index request
     * @return The result future
     * @see org.havenask.client.Requests#openIndexRequest(String)
     */
     ...
     * @return The result future
     * @see org.havenask.client.Requests#refreshRequest(String...)
     */
     ...
     * @see org.havenask.client.Requests#flushRequest(String...)
     */
     ...
     * @return A result future
     * @see org.havenask.client.Requests#syncedFlushRequest(String...)
     */
     ...
     * @return A result future
     * @see org.havenask.client.Requests#upgradeRequest(String...)
     */
