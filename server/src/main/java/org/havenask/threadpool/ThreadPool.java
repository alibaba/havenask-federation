...
import org.havenask.common.unit.SizeValue;
...
import org.havenask.common.util.concurrent.XRejectedExecutionHandler;
...
public class ThreadPool implements ReportingService<ThreadPoolInfo>, Scheduler {
    ...
    static final ExecutorService DIRECT_EXECUTOR = HavenaskExecutors.newDirectExecutorService();
    ...
    public ThreadPool(final Settings settings, final ExecutorBuilder<?>... customBuilders) {
        ...
        final int allocatedProcessors = HavenaskExecutors.allocatedProcessors(settings);
        ...
        this.cachedTimeThread = new CachedTimeThread(HavenaskExecutors.threadName(settings, "[timer]"), estimatedTimeInterval.millis());
     ...
     * @throws org.havenask.common.util.concurrent.HavenaskRejectedExecutionException if the task cannot be scheduled for execution
     */
    @Override
    ...
    static class ExecutorHolder {
        ...
        ExecutorHolder(ExecutorService executor, Info info) {
            assert executor instanceof HavenaskThreadPoolExecutor || executor == DIRECT_EXECUTOR;
            this.executor = executor;
            this.info = info;
        }
