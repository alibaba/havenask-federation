...
import org.havenask.cluster.AckedClusterStateTaskListener;
import org.havenask.cluster.ClusterChangedEvent;
import org.havenask.cluster.ClusterState;
import org.havenask.cluster.ClusterState.Builder;
...
import org.havenask.cluster.metadata.ProcessClusterEventTimeoutException;
...
public class MasterService extends AbstractLifecycleComponent {
    ...
    private volatile PrioritizedHavenaskThreadPoolExecutor threadPoolExecutor;
    ...
    protected PrioritizedHavenaskThreadPoolExecutor createThreadPoolExecutor() {
        return HavenaskExecutors.newSinglePrioritizing(
    ...
    class Batcher extends TaskBatcher {
        ...
        Batcher(Logger logger, PrioritizedHavenaskThreadPoolExecutor threadExecutor) {
