...
public class MetadataIndexUpgradeService {
    ...
    /**
     * Checks if the index was already opened by this version of Havenask and doesn't require any additional checks.
     */
    ...
    /**
     * The Havenask predecessor, Elasticsearch, v6.0 no longer supports indices created pre v5.0. All indices
     * that were created before Elasticsearch v5.0 should be re-indexed in Elasticsearch 5.x
     * before they can be opened by this version of havenask.
     */
    private void checkSupportedVersion(IndexMetadata indexMetadata, Version minimumIndexCompatibilityVersion) {
        if (indexMetadata.getState() == IndexMetadata.State.OPEN && isSupportedVersion(indexMetadata,
            ...
            throw new IllegalStateException("The index [" + indexMetadata.getIndex() + "] was created with version ["
                ...
                + minimumIndexCompatibilityVersion + "]. It should be re-indexed in Havenask " + minimumIndexCompatibilityVersion.major
                + ".x before upgrading to " + Version.CURRENT + ".");
        }
    }

    /*
     * Returns true if this index can be supported by the current version of havenask
     */
