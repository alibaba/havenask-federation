...
import static org.havenask.common.collect.List.copyOf;
...
public interface IndexAbstraction {
    ...
    class DataStream implements IndexAbstraction {
        ...
        private final org.havenask.cluster.metadata.DataStream dataStream;
        private final List<IndexMetadata> dataStreamIndices;
        private final IndexMetadata writeIndex;

        public DataStream(org.havenask.cluster.metadata.DataStream dataStream, List<IndexMetadata> dataStreamIndices) {
            this.dataStream = dataStream;
        ...
        public org.havenask.cluster.metadata.DataStream getDataStream() {
            return dataStream;
        }
    }
}
