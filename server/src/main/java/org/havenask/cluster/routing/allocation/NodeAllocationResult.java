...
import static org.havenask.cluster.routing.allocation.AbstractAllocationDecision.discoveryNodeToXContent;
        ...
        public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
            builder.startObject("store");
            {
                ...
                if (storeException != null) {
                    ...
                    HavenaskException.generateThrowableXContent(builder, params, storeException);
                    builder.endObject();
                }
            }
            builder.endObject();
