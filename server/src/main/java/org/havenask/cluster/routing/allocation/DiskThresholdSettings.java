...
import org.havenask.common.unit.RatioValue;
...
public class DiskThresholdSettings {
    ...
    public static final String AUTO_RELEASE_INDEX_ENABLED_KEY = "havenask.disk.auto_release_flood_stage_block";
    ...
    private static void doValidate(String low, String high, String flood) {
        ...
        } catch (final HavenaskParseException e) {
     ...
     * true, otherwise throwing an {@link HavenaskParseException}.
     *
     ...
     * parameter is true, otherwise throwing an {@link HavenaskParseException}.
     *
