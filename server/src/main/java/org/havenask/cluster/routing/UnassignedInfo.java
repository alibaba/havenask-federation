...
public final class UnassignedInfo implements ToXContentFragment, Writeable {
    ...
    /**
     * A set of nodeIds that failed to complete allocations for this shard. {@link org.havenask.gateway.ReplicaShardAllocator}
     ...
     *
     * @see org.havenask.gateway.ReplicaShardAllocator#processExistingRecoveries(RoutingAllocation)
     * @see org.havenask.cluster.routing.allocation.AllocationService#applyFailedShards(ClusterState, List, List)
     */
