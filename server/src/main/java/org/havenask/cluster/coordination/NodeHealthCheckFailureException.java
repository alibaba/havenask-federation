...
/**
 * This exception is thrown if the File system is reported unhealthy by @{@link org.havenask.monitor.fs.FsHealthService}
 * and this nodes needs to be removed from the cluster
 */

public class NodeHealthCheckFailureException extends HavenaskException {
