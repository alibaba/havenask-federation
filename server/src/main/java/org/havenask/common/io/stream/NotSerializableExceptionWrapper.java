 ...
 */
public final class NotSerializableExceptionWrapper extends HavenaskException {

    private final String name;
    private final RestStatus status;

    public NotSerializableExceptionWrapper(Throwable other) {
        super(HavenaskException.getExceptionName(other) + ": " + other.getMessage(), other.getCause());
        this.name = HavenaskException.getExceptionName(other);
        ...
        if (other instanceof HavenaskException) {
            HavenaskException ex = (HavenaskException) other;
