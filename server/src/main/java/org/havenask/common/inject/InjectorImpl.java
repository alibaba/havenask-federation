...
import org.havenask.common.Classes;
...
import org.havenask.common.inject.internal.MatcherAndConverter;
...
import static org.havenask.common.inject.internal.Annotations.findScopeAnnotation;
...
class InjectorImpl implements Injector, Lookups {
    ...
    <T> Provider<T> getProviderOrThrow(final Key<T> key, Errors errors) throws ErrorsException {
        ...
        // Havenask: optimize for a common case of read only instance getting from the parent...
