 ...
 */
public class HavenaskThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    HavenaskThreadPoolExecutor(String name, int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit,
    ...
    public void execute(Runnable command) {
        ...
        } catch (HavenaskRejectedExecutionException ex) {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        HavenaskExecutors.rethrowErrors(unwrap(r));
