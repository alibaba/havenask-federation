...
package org.havenask.common.blobstore.fs;
...
/**
 * A file system based implementation of {@link org.havenask.common.blobstore.BlobContainer}.
 * All blobs in the container are stored on a file system, the location of which is specified by the {@link BlobPath}.
 *
 * Note that the methods in this implementation of {@link org.havenask.common.blobstore.BlobContainer} may
...
public class FsBlobContainer extends AbstractBlobContainer {
    ...
    private void writeToPath(InputStream inputStream, Path tempBlobPath, long blobSize) throws IOException {
        try (OutputStream outputStream = Files.newOutputStream(tempBlobPath, StandardOpenOption.CREATE_NEW)) {
            ...
            org.havenask.core.internal.io.Streams.copy(
