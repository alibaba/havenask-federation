 ...
 * reproducible tests. When running the Havenask test suite, the
 ...
 * when running under the Havenask test suite. Alternatively,
 * a reproducible source of randomness can be produced by providing a
 * setting a reproducible seed. When running the Havenask server
...
public final class Randomness {
     ...
     * running under the Havenask test suite, and otherwise
