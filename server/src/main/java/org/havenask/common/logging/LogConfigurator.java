...
public class LogConfigurator {
     ...
     * node name is set in havenask.yml. Otherwise it is called as soon
     ...
     * <ul>
     * <li>
     * {@code havenask.logs.base_path} the base path containing the log files
     * </li>
     * <li>
     * {@code havenask.logs.cluster_name} the cluster name, used as the prefix of log filenames in the default configuration
     * </li>
     * <li>
     * {@code havenask.logs.node_name} the node name, can be used as part of log filenames
     * </li>
     * </ul>
     *
    ...
    private static void setLogConfigurationSystemProperty(final Path logsPath, final Settings settings) {
        System.setProperty("havenask.logs.base_path", logsPath.toString());
        System.setProperty("havenask.logs.cluster_name", ClusterName.CLUSTER_NAME_SETTING.get(settings).value());
        System.setProperty("havenask.logs.node_name", Node.NODE_NAME_SETTING.get(settings));
    }
