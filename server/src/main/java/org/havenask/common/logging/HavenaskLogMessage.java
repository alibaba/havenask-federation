...
public abstract class HavenaskLogMessage extends ParameterizedMessage {
     ...
     */
    public HavenaskLogMessage(Map<String, Object> fields, String messagePattern, Object... args) {
    ...
    public static String asJsonArray(Stream<String> stream) {
        return "[" + stream
            .map(HavenaskLogMessage::inQuotes)
