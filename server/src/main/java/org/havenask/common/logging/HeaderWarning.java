...
public class HeaderWarning {
     ...
     * is always 299. Further, this pattern assumes that the warn agent represents a version of Havenask including the build hash.
     */
    public static final Pattern WARNING_HEADER_PATTERN = Pattern.compile(
        "299 " + // warn code
            "(?:Elasticsearch-|Havenask-)" + // warn agent (note: Elasticsearch needed for bwc mixedCluster testing)
     ...
     * {@code 299 Havenask-6.0.0 "warning value"}, the return value of this method would be {@code warning value}.
     *
