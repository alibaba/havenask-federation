...
public class JodaDateMathParser implements DateMathParser {
    ...
    private long parseMath(String mathString, long time, boolean roundUp, DateTimeZone timeZone) throws HavenaskParseException {
        if (timeZone == null) {
    ...
    private long parseDateTime(String value, DateTimeZone timeZone, boolean roundUpIfNoTime) {
        ...
        try {
            ...
            throw new HavenaskParseException("failed to parse date field [{}] with format [{}]", e, value,
