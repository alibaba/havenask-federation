...
public class ByteSizeValue implements Writeable, Comparable<ByteSizeValue>, ToXContentFragment {
    ...
    public static ByteSizeValue parseBytesSizeValue(String sValue, String settingName) throws HavenaskParseException {
        ...
        try {
            try {
                ...
                try {
                    ...
                    throw new HavenaskParseException("failed to parse [{}]", e, initialInput);
                }
            }
        } catch (IllegalArgumentException e) {
            throw new HavenaskParseException("failed to parse setting [{}] with value [{}] as a size in bytes", e, settingName,
                    initialInput);
        }
    }
