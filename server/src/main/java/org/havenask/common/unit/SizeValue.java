...
public class SizeValue implements Writeable, Comparable<SizeValue> {
    ...
    public static SizeValue parseSizeValue(String sValue) throws HavenaskParseException {
        return parseSizeValue(sValue, null);
    }

    public static SizeValue parseSizeValue(String sValue, SizeValue defaultValue) throws HavenaskParseException {
        if (sValue == null) {
            return defaultValue;
        }
        long singles;
        try {
            ...
            throw new HavenaskParseException("failed to parse [{}]", e, sValue);
        }
