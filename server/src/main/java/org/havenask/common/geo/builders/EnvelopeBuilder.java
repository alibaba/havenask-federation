...
public class EnvelopeBuilder extends ShapeBuilder<Rectangle, org.havenask.geometry.Rectangle, EnvelopeBuilder> {
    ...
    @Override
    public org.havenask.geometry.Rectangle buildGeometry() {
        return new org.havenask.geometry.Rectangle(topLeft.x, bottomRight.x, topLeft.y, bottomRight.y);
    }
