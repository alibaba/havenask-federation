...
import org.havenask.common.unit.DistanceUnit.Distance;
import org.havenask.common.xcontent.XContentBuilder;

import java.io.IOException;
import java.util.Objects;

public class CircleBuilder extends ShapeBuilder<Circle, org.havenask.geometry.Circle, CircleBuilder> {
     ...
     * @param radius radius of the circle (see {@link org.havenask.common.unit.DistanceUnit.Distance})
     * @return this
     */
    ...
    @Override
    public org.havenask.geometry.Circle buildGeometry() {
       return new org.havenask.geometry.Circle(center.x, center.y, unit.toMeters(radius));
    }
