...
import org.havenask.common.xcontent.AbstractObjectParser;
...
public final class Script implements ToXContentObject, Writeable {
    ...
    public static Script parse(Object config) {
        ...
        if (config instanceof String) {
            ...
            for (Map.Entry<String, Object> entry : configMap.entrySet()) {
                ...
                if (Script.LANG_PARSE_FIELD.match(parameterName, LoggingDeprecationHandler.INSTANCE)) {
                    if (parameterValue instanceof String || parameterValue == null) {
                        ...
                        throw new HavenaskParseException("Value must be of type String: [" + parameterName + "]");
                    }
                    ...
                    if (parameterValue instanceof Map || parameterValue == null) {
                        ...
                        throw new HavenaskParseException("Value must be of type Map: [" + parameterName + "]");
                    }
            ...
            if (script == null) {
                throw new HavenaskParseException("Expected one of [{}] or [{}] fields, but found none",
