...
import static org.havenask.action.DocWriteRequest.OpType;
import static org.havenask.client.Requests.clearIndicesCacheRequest;
import static org.havenask.client.Requests.getRequest;
 ...
 */
public class DocumentActionsIT extends HavenaskIntegTestCase {
    protected void createIndex() {
        HavenaskAssertions.assertAcked(prepareCreate(getConcreteIndexName()).addMapping("type1", "name", "type=keyword,store=true"));
    }
