...
public class PrivateSettingsIT extends HavenaskIntegTestCase {
    ...
    public void testUpdatePrivateIndexSettingViaSettingsAPI() {
        ...
        final IllegalArgumentException e = expectThrows(IllegalArgumentException.class,
                () -> client().admin()
                        ...
                        .get());
        final String message = "can not update private setting [index.private]; this setting is managed by Havenask";
