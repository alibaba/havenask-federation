...
import static org.havenask.cluster.coordination.Coordinator.ZEN1_BWC_TERM;
import static org.havenask.cluster.coordination.FollowersChecker.FOLLOWER_CHECK_ACTION_NAME;
import static org.havenask.cluster.coordination.JoinHelper.START_JOIN_ACTION_NAME;
import static org.havenask.cluster.coordination.PublicationTransportHandler.PUBLISH_STATE_ACTION_NAME;
...
import static org.havenask.test.InternalTestCluster.REMOVED_MINIMUM_MASTER_NODES;
import static org.havenask.test.hamcrest.HavenaskAssertions.assertAcked;
import static org.hamcrest.Matchers.equalTo;
import static org.hamcrest.Matchers.is;

@HavenaskIntegTestCase.ClusterScope(scope = HavenaskIntegTestCase.Scope.TEST, numDataNodes = 0)
public class Zen1IT extends HavenaskIntegTestCase {
