...
import org.havenask.common.lucene.search.SpanBooleanQueryRewriteWithMaxClause;
...
import org.havenask.index.query.functionscore.ScoreFunctionBuilders;
import org.havenask.index.search.MatchQuery;
...
import org.havenask.test.junit.annotations.TestIssueLogging;
...
import static org.havenask.index.query.QueryBuilders.matchPhrasePrefixQuery;
...
import static org.havenask.index.query.QueryBuilders.termsLookupQuery;
...
public class SearchQueryIT extends HavenaskIntegTestCase {
    ...
    @TestIssueLogging(value = "org.havenask.search.query.SearchQueryIT:DEBUG",
    ...
    public void testMatchPhrasePrefixQuery() throws ExecutionException, InterruptedException {
        ...
        client().prepareIndex("test1", "type1", "2").setSource("field", "trying out Havenask"));
