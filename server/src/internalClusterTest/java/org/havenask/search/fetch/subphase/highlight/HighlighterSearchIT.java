...
import org.havenask.search.fetch.subphase.highlight.HighlightBuilder.BoundaryScannerType;
import org.havenask.search.fetch.subphase.highlight.HighlightBuilder.Field;
...
import org.havenask.test.MockKeywordPlugin;
...
import static org.havenask.search.builder.SearchSourceBuilder.highlight;
...
import static org.havenask.test.hamcrest.HavenaskAssertions.assertHighlight;
...
import static org.havenask.test.hamcrest.HavenaskAssertions.assertNotHighlighted;
...
public class HighlighterSearchIT extends HavenaskIntegTestCase {
    ...
    public void testSourceLookupHighlightingUsingPlainHighlighter() throws Exception {
        ...
        for (int i = 0; i < indexRequestBuilders.length; i++) {
            indexRequestBuilders[i] = client().prepareIndex("test", "type1", Integer.toString(i))
                    .setSource(XContentFactory.jsonBuilder().startObject()
                            .field("title", "This is a test on the highlighting bug present in havenask")
        ...
        for (int i = 0; i < indexRequestBuilders.length; i++) {
            assertHighlight(search, i, "title", 0, equalTo("This is a test on the highlighting <em>bug</em> present in havenask"));
        }
    ...
    public void testSourceLookupHighlightingUsingPostingsHighlighter() throws Exception {
        ...
        for (int i = 0; i < indexRequestBuilders.length; i++) {
            indexRequestBuilders[i] = client().prepareIndex("test", "type1", Integer.toString(i))
                    .setSource(XContentFactory.jsonBuilder().startObject()
                            .array("title", "This is a test on the highlighting bug present in havenask. Hopefully it works.",
        ...
        for (int i = 0; i < indexRequestBuilders.length; i++) {
            assertHighlight(search, i, "title", 0,
                    equalTo("This is a test on the highlighting <em>bug</em> present in havenask. Hopefully it works."));
    ...
    public void testHighlightIssue1994() throws Exception {
        ...
        String[] titles = new String[] {"This is a test on the highlighting bug present in havenask", "The bug is bugging us"};
        ...
        assertHighlight(search, 0, "title", 0, equalTo("This is a test on the highlighting <em>bug</em> present in havenask"));
        assertHighlight(search, 0, "title", 1, 2, equalTo("The <em>bug</em> is bugging us"));
        assertHighlight(search, 0, "titleTV", 0, equalTo("This is a test on the highlighting <em>bug</em> present in havenask"));
    ...
    public void testSameContent() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            indexRequestBuilders[i] = client().prepareIndex("test", "type1", Integer.toString(i))
                    .setSource("title", "This is a test on the highlighting bug present in havenask");
        }
        indexRandom(true, indexRequestBuilders);
    ...
    public void testFastVectorHighlighterOffsetParameter() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            // LUCENE 3.1 UPGRADE: Caused adding the space at the end...
            assertHighlight(search, i, "title", 0, 1, equalTo("highlighting <em>bug</em> present in havenask"));
        }
    }
    ...
    public void testEscapeHtml() throws Exception {
        ...
        for (int i = 0; i < indexRequestBuilders.length; i++) {
            indexRequestBuilders[i] = client().prepareIndex("test", "type1", Integer.toString(i))
                    .setSource("title", "This is a html escaping highlighting test for *&? havenask");
        }
        indexRandom(true, indexRequestBuilders);
    ...
    public void testEscapeHtmlVector() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            assertHighlight(search, i, "title", 0, 1, equalTo(" highlighting <em>test</em> for *&amp;? havenask"));
        }
    }
    ...
    public void testNumericHighlighting() throws Exception {
        ...
        client().prepareIndex("test", "test", "1").setSource("text", "havenask test",
    ...
    public void testResetTwice() throws Exception {
        ...
        ensureGreen();
        client().prepareIndex("test", "type", "1")
                .setSource("text", "havenask test").get();
        refresh();
    ...
    public void testPostingsHighlighterEscapeHtml() throws Exception {
        ...
        for (int i = 0; i < indexRequestBuilders.length; i++) {
            assertHighlight(searchResponse, i, "title", 0, 1,
                equalTo("This is a html escaping highlighting <em>test</em> for *&amp;? havenask"));
        }
    }
