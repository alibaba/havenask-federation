...
@HavenaskIntegTestCase.ClusterScope(numDataNodes = 0, scope = HavenaskIntegTestCase.Scope.TEST, transportClientRatio = 0)
public class TransportClusterStateActionDisruptionIT extends HavenaskIntegTestCase {
