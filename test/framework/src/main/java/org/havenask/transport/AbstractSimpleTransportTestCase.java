...
public abstract class AbstractSimpleTransportTestCase extends HavenaskTestCase {
        ...
        final TransportRequestHandler<TransportRequest.Empty> requestHandler = (request, channel, task) -> {
            try {
                if (randomBoolean()) {
                    ...
                    channel.sendResponse(new HavenaskException("simulated"));
                }
            } catch (IOException e) {
                logger.error("Unexpected failure", e);
                fail(e.getMessage());
    ...
    @TestLogging(
        value = "org.havenask.transport.TransportService.tracer:trace",
    ...
    public void testTracerLog() throws Exception {
        ...
        try {
            appender.start();
            Loggers.addAppender(LogManager.getLogger("org.havenask.transport.TransportService.tracer"), appender);
            ...
            final MockLogAppender.LoggingExpectation requestSentExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "sent request", "org.havenask.transport.TransportService.tracer", Level.TRACE, requestSent);
            ...
            final MockLogAppender.LoggingExpectation requestReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "received request", "org.havenask.transport.TransportService.tracer", Level.TRACE, requestReceived);
            final String responseSent = ".*\\[internal:test].*sent response.*";
            final MockLogAppender.LoggingExpectation responseSentExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "sent response", "org.havenask.transport.TransportService.tracer", Level.TRACE, responseSent);
            ...
            final MockLogAppender.LoggingExpectation responseReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "received response", "org.havenask.transport.TransportService.tracer", Level.TRACE, responseReceived);
            ...
            final MockLogAppender.LoggingExpectation errorResponseSentExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "sent error response", "org.havenask.transport.TransportService.tracer", Level.TRACE, errorResponseSent);
            ...
            final MockLogAppender.LoggingExpectation errorResponseReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "received error response", "org.havenask.transport.TransportService.tracer", Level.TRACE, errorResponseReceived);
            ...
            final MockLogAppender.LoggingExpectation notSeenSentExpectation =
                new MockLogAppender.UnseenEventExpectation(
                    "not seen request sent", "org.havenask.transport.TransportService.tracer", Level.TRACE, notSeenSent);
            ...
            final MockLogAppender.LoggingExpectation notSeenReceivedExpectation =
                new MockLogAppender.PatternSeenEventExpectation(
                    "not seen request received", "org.havenask.transport.TransportService.tracer", Level.TRACE, notSeenReceived);
            ...
            Loggers.removeAppender(LogManager.getLogger("org.havenask.transport.TransportService.tracer"), appender);
            appender.stop();
        }
    }
    ...
    public void testHandshakeUpdatesVersion() throws IOException {
        ...
        try (MockTransportService service = buildService("TS_C", version,  Settings.EMPTY)) {
            ...
            try (Transport.Connection connection = serviceA.openConnection(node, builder.build())) {
                // Havenask 1.0+ in bwc mode should only "upgrade" to Legacy v7.10.2
    ...
    public void testTcpHandshake() {
        ...
        try (TransportService service = buildService("TS_TPC", Version.CURRENT, Settings.EMPTY)) {
            ...
            try (Transport.Connection connection = future.actionGet()) {
                // Havenask sends a handshake version spoofed as Legacy version 7_10_2
                // todo change for Havenask 2.0.0
