...
package org.havenask.common.bytes;
...
public abstract class AbstractBytesReferenceTestCase extends HavenaskTestCase {
    ...
    public void testIndexOf() throws IOException {
        ...
        final byte missing = randomValueOtherThanMany(map::containsKey, HavenaskTestCase::randomByte);
