...
import static org.havenask.test.HavenaskTestCase.randomValueOtherThanMany;
...
public class GeometryTestUtils {
    ...
    public static double randomAlt() {
        return HavenaskTestCase.randomDouble();
    }

    public static Circle randomCircle(boolean hasAlt) {
        if (hasAlt) {
            return new Circle(randomLon(), randomLat(), HavenaskTestCase.randomDouble(),
                HavenaskTestCase.randomDoubleBetween(0, 100, false));
        } else {
            return new Circle(randomLon(), randomLat(), HavenaskTestCase.randomDoubleBetween(0, 100, false));
        }
    }
    ...
    public static Point randomPoint() {
        return randomPoint(HavenaskTestCase.randomBoolean());
    }
    ...
    public static MultiPoint randomMultiPoint(boolean hasAlt) {
        int size = HavenaskTestCase.randomIntBetween(3, 10);
    ...
    private static GeometryCollection<Geometry> randomGeometryCollection(int level, boolean hasAlt) {
        int size = HavenaskTestCase.randomIntBetween(1, 10);
    ...
    protected static Geometry randomGeometry(int level, boolean hasAlt) {
        @SuppressWarnings("unchecked") Function<Boolean, Geometry> geometry = HavenaskTestCase.randomFrom(
