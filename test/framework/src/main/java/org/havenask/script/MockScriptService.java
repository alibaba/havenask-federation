    ...
    public static <T> MockScriptService singleContext(ScriptContext<T> context, Function<String, T> compile,
        ...
        ScriptEngine engine = new ScriptEngine() {
            ...
            public Set<ScriptContext<?>> getSupportedContexts() {
                return org.havenask.common.collect.Set.of(context);
            }
        };
        return new MockScriptService(Settings.EMPTY, org.havenask.common.collect.Map.of("lang", engine),
            org.havenask.common.collect.Map.of(context.name, context)) {
            @Override
