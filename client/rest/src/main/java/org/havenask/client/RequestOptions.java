...
import org.havenask.client.HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory;
...
/**
 * The portion of an HTTP request to Havenask that can be
 * manipulated without changing Havenask's behavior.
 */
