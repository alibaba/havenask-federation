...
/**
 * Metadata about an {@link HttpHost} running Havenask.
 */
public class Node {
    /**
    ...
    /**
     * Version of Havenask that the node is running or {@code null}
     * if we don't know the version.
     */
    private final String version;
    /**
     * Roles that the Havenask process on the host has or {@code null}
    ...
    /**
     * Role information about an Havenask process.
     */
