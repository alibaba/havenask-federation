...
public class TasksRequestConvertersTests extends HavenaskTestCase {

    public void testCancelTasks() {
        Map<String, String> expectedParams = new HashMap<>();
        org.havenask.client.tasks.TaskId taskId =
            new org.havenask.client.tasks.TaskId(randomAlphaOfLength(5), randomNonNegativeLong());
        org.havenask.client.tasks.TaskId parentTaskId =
            new org.havenask.client.tasks.TaskId(randomAlphaOfLength(5), randomNonNegativeLong());
