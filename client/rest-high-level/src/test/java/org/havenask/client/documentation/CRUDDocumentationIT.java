...
import org.havenask.client.RethrottleRequest;
...
import org.havenask.index.reindex.RemoteInfo;
 ...
 */
public class CRUDDocumentationIT extends HavenaskRestHighLevelClientTestCase {
    ...
    public void testIndex() throws Exception {
...

        {
            ...
            jsonMap.put("message", "trying out Havenask");
        ...
        }
        {
            ...
            builder.startObject();
            {
                ...
                builder.field("message", "trying out Havenask");
            }
            builder.endObject();
            IndexRequest indexRequest = new IndexRequest("posts")
            ...
            try {
                DeleteResponse deleteResponse = client.delete(
                    new DeleteRequest("posts", "1").setIfSeqNo(100).setIfPrimaryTerm(2),
                        RequestOptions.DEFAULT);
            } catch (HavenaskException exception) {
    ...
    public void testGet() throws Exception {
        ...
        }
        {
            ...
            assertEquals(2, sourceAsMap.size());
            assertEquals("trying out Havenask", sourceAsMap.get("message"));
        ...
        }
        {
            ...
            assertEquals("trying out Havenask", message);
    ...
    public void testGetSource() throws Exception {
...

        {
            ...
            expectSource.put("message", "trying out Havenask");
        ...
        RestHighLevelClient client = highLevelClient();
        {
            ...
            IndexRequest one = new IndexRequest("posts").id("1")
                    .source(XContentType.JSON, "title",
                            "In which order are my Havenask queries executed?");
            IndexRequest two = new IndexRequest("posts").id("2")
                    .source(XContentType.JSON, "title",
                            "Current status and upcoming changes in Havenask");
            IndexRequest three = new IndexRequest("posts").id("3")
                    .source(XContentType.JSON, "title",
                            "The Future of Federated Search in Havenask");
    ...
    public void testMultiGet() throws Exception {
...

        {
            ...
            HavenaskException ee = (HavenaskException) e;    // <3>
