...
public class ResizeResponseTests extends
    AbstractResponseTestCase<org.havenask.action.admin.indices.shrink.ResizeResponse, ResizeResponse> {

    @Override
    protected org.havenask.action.admin.indices.shrink.ResizeResponse createServerTestInstance(XContentType xContentType) {
        boolean acked = randomBoolean();
        return new org.havenask.action.admin.indices.shrink.ResizeResponse(acked, acked, randomAlphaOfLength(5));
    }
    ...
    @Override
    protected void assertInstances(org.havenask.action.admin.indices.shrink.ResizeResponse serverTestInstance,
