...
public class CountResponseTests extends HavenaskTestCase {
    ...
    // HavenaskException. Best effort: try to check that the original message appears somewhere in the rendered xContent
