...
import org.havenask.client.GetAliasesResponseTests;
...
public class GetIndexResponseTests extends HavenaskTestCase {
    ...
    private static void toXContent(GetIndexResponse response, XContentBuilder builder) throws IOException {
        // first we need to repackage from GetIndexResponse to org.havenask.action.admin.indices.get.GetIndexResponse
        ...
        org.havenask.action.admin.indices.get.GetIndexResponse serverResponse
            = new org.havenask.action.admin.indices.get.GetIndexResponse(
                response.getIndices(),
                allMappings.build(),
                aliases.build(),
                settings.build(),
