...
public class IngestRequestConvertersTests extends HavenaskTestCase {
    ...
    public void testSimulatePipeline() throws IOException {
        String pipelineId = HavenaskTestCase.randomBoolean() ? "some_pipeline_id" : null;
        boolean verbose = HavenaskTestCase.randomBoolean();
        String json = "{"
            + "  \"pipeline\": {"
