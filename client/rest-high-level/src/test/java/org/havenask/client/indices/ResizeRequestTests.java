...
import org.havenask.client.AbstractRequestTestCase;
...
public class ResizeRequestTests extends AbstractRequestTestCase<ResizeRequest,
        org.havenask.action.admin.indices.shrink.ResizeRequest> {
    ...
    @Override
    protected org.havenask.action.admin.indices.shrink.ResizeRequest doParseToServerInstance(XContentParser parser)
        throws IOException {
        org.havenask.action.admin.indices.shrink.ResizeRequest req
            = new org.havenask.action.admin.indices.shrink.ResizeRequest("target", "source");
        req.fromXContent(parser);
        return req;
    }

    @Override
    protected void assertInstances(org.havenask.action.admin.indices.shrink.ResizeRequest serverInstance,
