...
import org.havenask.join.aggregations.Children;
...
import org.havenask.search.aggregations.bucket.composite.CompositeAggregation;
import org.havenask.search.aggregations.bucket.composite.CompositeValuesSourceBuilder;
import org.havenask.search.aggregations.bucket.composite.TermsValuesSourceBuilder;
...
import org.havenask.search.aggregations.bucket.terms.RareTerms;
...
import org.havenask.search.aggregations.matrix.stats.MatrixStats;
import org.havenask.search.aggregations.matrix.stats.MatrixStatsAggregationBuilder;
import org.havenask.search.aggregations.metrics.WeightedAvg;
...
public class SearchIT extends HavenaskRestHighLevelClientTestCase {
    ...
    public void testSearchScroll() throws Exception {
        ...
        try {
            ...
            HavenaskStatusException exception = expectThrows(HavenaskStatusException.class, () -> execute(scrollRequest,
                    highLevelClient()::scroll, highLevelClient()::scrollAsync));
            assertEquals(RestStatus.NOT_FOUND, exception.status());
            assertThat(exception.getRootCause(), instanceOf(HavenaskException.class));
    ...
    public void testExplainNonExistent() throws IOException {
        {
            ...
            assertThat(exception.getDetailedMessage(),
                containsString("Havenask exception [type=index_not_found_exception, reason=no such index [non_existent_index]]"));
        }
        {
