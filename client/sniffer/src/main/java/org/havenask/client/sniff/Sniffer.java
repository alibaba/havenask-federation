...
/**
 * Class responsible for sniffing nodes from some source (default is havenask itself) and setting them to a provided instance of
...
public class Sniffer implements Closeable {
    ...
    private static final String SNIFFER_THREAD_NAME = "havenask_rest_client_sniffer";
