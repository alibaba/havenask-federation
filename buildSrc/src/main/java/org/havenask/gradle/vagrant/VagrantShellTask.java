...
import static org.havenask.gradle.vagrant.VagrantMachine.convertLinuxPath;
import static org.havenask.gradle.vagrant.VagrantMachine.convertWindowsPath;
...
public abstract class VagrantShellTask extends DefaultTask {
    ...
    public VagrantShellTask() {
        ...
        if (extension == null) {
            throw new IllegalStateException("havenask.vagrant-base must be applied to create " + getClass().getName());
        }
