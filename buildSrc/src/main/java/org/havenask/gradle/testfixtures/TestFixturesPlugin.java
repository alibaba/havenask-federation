...
package org.havenask.gradle.testfixtures;
...
import org.havenask.gradle.precommit.TestingConventionsTasks;
...
public class TestFixturesPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        maybeSkipTasks(tasks, dockerSupport, getTaskClass("org.havenask.gradle.test.RestIntegTestTask"));
        maybeSkipTasks(tasks, dockerSupport, TestingConventionsTasks.class);
        maybeSkipTasks(tasks, dockerSupport, getTaskClass("org.havenask.gradle.test.AntFixture"));
