...
class InternalDistributionArchiveSetupPluginFuncTest extends AbstractGradleFuncTest {
    ...
    def setup() {
        ...
        plugins {
            id 'havenask.internal-distribution-archive-setup'
        }
        """
    ...
    def "applies defaults to tar tasks"() {
        ...
        "buildDarwinTar" | "darwin-tar/build/distributions/havenask.tar.gz"
    }
    ...
    def "applies defaults to zip tasks"() {
        ...
        where:
        buildTaskName       | expectedOutputArchivePath
        "buildDarwinZip" | "darwin-zip/build/distributions/havenask.zip"
    }
    ...
    def "registered distribution provides archives and directory variant"() {
        ...
        file("producer-tar/build/distributions/havenask.tar.gz").exists()
        file("consumer/build/archives/havenask.tar.gz").exists()
